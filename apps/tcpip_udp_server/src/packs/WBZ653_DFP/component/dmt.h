...
#ifndef _WBZ65_DMT_COMPONENT_H_
#define _WBZ65_DMT_COMPONENT_H_
...
#define DMT_DMTSTAT_BAD_Msk                   (_UINT32_(0x3) << DMT_DMTSTAT_BAD_Pos)               /* (DMT_DMTSTAT Mask) BAD */
#define DMT_DMTSTAT_BAD(value)                (DMT_DMTSTAT_BAD_Msk & (_UINT32_(value) << DMT_DMTSTAT_BAD_Pos)) 
...
/* -------- DMT_DMTCNT : (DMT Offset: 0x40) ( R/ 32)  -------- */
...
/* -------- DMT_DMTHOLDREG : (DMT Offset: 0x50) ( R/ 32)  -------- */
...
/* -------- DMT_DMTPSCNT : (DMT Offset: 0x60) ( R/ 32)  -------- */
...
/* -------- DMT_DMTPSINTV : (DMT Offset: 0x70) ( R/ 32)  -------- */
