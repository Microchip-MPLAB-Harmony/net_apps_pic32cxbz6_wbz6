...
#ifndef _WBZ65_PAC_COMPONENT_H_
#define _WBZ65_PAC_COMPONENT_H_
...
#define PAC_INTFLAGAHB_ROT(value)             (PAC_INTFLAGAHB_ROT_Msk & (_UINT32_(value) << PAC_INTFLAGAHB_ROT_Pos)) /* Assigment of value for ROT in the PAC_INTFLAGAHB register */
...
#define PAC_INTFLAGAHB_CRYPTO(value)          (PAC_INTFLAGAHB_CRYPTO_Msk & (_UINT32_(value) << PAC_INTFLAGAHB_CRYPTO_Pos)) /* Assigment of value for CRYPTO in the PAC_INTFLAGAHB register */
...
#define PAC_INTFLAGAHB_PBDB(value)            (PAC_INTFLAGAHB_PBDB_Msk & (_UINT32_(value) << PAC_INTFLAGAHB_PBDB_Pos)) /* Assigment of value for PBDB in the PAC_INTFLAGAHB register */
...
#define PAC_INTFLAGA_TC4(value)               (PAC_INTFLAGA_TC4_Msk & (_UINT32_(value) << PAC_INTFLAGA_TC4_Pos)) /* Assigment of value for TC4 in the PAC_INTFLAGA register */
...
#define PAC_INTFLAGA_TC5(value)               (PAC_INTFLAGA_TC5_Msk & (_UINT32_(value) << PAC_INTFLAGA_TC5_Pos)) /* Assigment of value for TC5 in the PAC_INTFLAGA register */
...
#define PAC_INTFLAGA_TC6(value)               (PAC_INTFLAGA_TC6_Msk & (_UINT32_(value) << PAC_INTFLAGA_TC6_Pos)) /* Assigment of value for TC6 in the PAC_INTFLAGA register */
...
#define PAC_INTFLAGA_TC7(value)               (PAC_INTFLAGA_TC7_Msk & (_UINT32_(value) << PAC_INTFLAGA_TC7_Pos)) /* Assigment of value for TC7 in the PAC_INTFLAGA register */
#define PAC_INTFLAGA_TCC0_Pos                 _UINT32_(15)                                         /* (PAC_INTFLAGA) TCC0 Position */
...
#define PAC_INTFLAGA_TCC1_Pos                 _UINT32_(16)                                         /* (PAC_INTFLAGA) TCC1 Position */
...
#define PAC_INTFLAGA_TCC2_Pos                 _UINT32_(17)                                         /* (PAC_INTFLAGA) TCC2 Position */
...
#define PAC_INTFLAGA_Msk                      _UINT32_(0x00039FFF)                                 /* (PAC_INTFLAGA) Register Mask  */
...
#define PAC_INTFLAGA_TCC_Pos                  _UINT32_(15)                                         /* (PAC_INTFLAGA Position) TCC2 */
...
#define PAC_INTFLAGC_SERCOM6(value)           (PAC_INTFLAGC_SERCOM6_Msk & (_UINT32_(value) << PAC_INTFLAGC_SERCOM6_Pos)) /* Assigment of value for SERCOM6 in the PAC_INTFLAGC register */
...
#define PAC_INTFLAGC_HMTX(value)              (PAC_INTFLAGC_HMTX_Msk & (_UINT32_(value) << PAC_INTFLAGC_HMTX_Pos)) /* Assigment of value for HMTX in the PAC_INTFLAGC register */
...
#define PAC_INTFLAGD_SERCOM2(value)           (PAC_INTFLAGD_SERCOM2_Msk & (_UINT32_(value) << PAC_INTFLAGD_SERCOM2_Pos)) /* Assigment of value for SERCOM2 in the PAC_INTFLAGD register */
...
#define PAC_INTFLAGD_SERCOM3(value)           (PAC_INTFLAGD_SERCOM3_Msk & (_UINT32_(value) << PAC_INTFLAGD_SERCOM3_Pos)) /* Assigment of value for SERCOM3 in the PAC_INTFLAGD register */
...
#define PAC_INTFLAGD_TC8(value)               (PAC_INTFLAGD_TC8_Msk & (_UINT32_(value) << PAC_INTFLAGD_TC8_Pos)) /* Assigment of value for TC8 in the PAC_INTFLAGD register */
...
#define PAC_INTFLAGD_TC9(value)               (PAC_INTFLAGD_TC9_Msk & (_UINT32_(value) << PAC_INTFLAGD_TC9_Pos)) /* Assigment of value for TC9 in the PAC_INTFLAGD register */
...
#define PAC_INTFLAGD_CAN0(value)              (PAC_INTFLAGD_CAN0_Msk & (_UINT32_(value) << PAC_INTFLAGD_CAN0_Pos)) /* Assigment of value for CAN0 in the PAC_INTFLAGD register */
...
#define PAC_INTFLAGD_CAN1(value)              (PAC_INTFLAGD_CAN1_Msk & (_UINT32_(value) << PAC_INTFLAGD_CAN1_Pos)) /* Assigment of value for CAN1 in the PAC_INTFLAGD register */
...
#define PAC_STATUSA_TC4(value)                (PAC_STATUSA_TC4_Msk & (_UINT32_(value) << PAC_STATUSA_TC4_Pos)) /* Assigment of value for TC4 in the PAC_STATUSA register */
...
#define PAC_STATUSA_TC5(value)                (PAC_STATUSA_TC5_Msk & (_UINT32_(value) << PAC_STATUSA_TC5_Pos)) /* Assigment of value for TC5 in the PAC_STATUSA register */
...
#define PAC_STATUSA_TC6(value)                (PAC_STATUSA_TC6_Msk & (_UINT32_(value) << PAC_STATUSA_TC6_Pos)) /* Assigment of value for TC6 in the PAC_STATUSA register */
...
#define PAC_STATUSA_TC7(value)                (PAC_STATUSA_TC7_Msk & (_UINT32_(value) << PAC_STATUSA_TC7_Pos)) /* Assigment of value for TC7 in the PAC_STATUSA register */
#define PAC_STATUSA_TCC0_Pos                  _UINT32_(15)                                         /* (PAC_STATUSA) TCC0 APB Protect Enable Position */
...
#define PAC_STATUSA_TCC1_Pos                  _UINT32_(16)                                         /* (PAC_STATUSA) TCC1 APB Protect Enable Position */
...
#define PAC_STATUSA_TCC2_Pos                  _UINT32_(17)                                         /* (PAC_STATUSA) TCC2 APB Protect Enable Position */
...
#define PAC_STATUSA_Msk                       _UINT32_(0x00039FFF)                                 /* (PAC_STATUSA) Register Mask  */
...
#define PAC_STATUSA_TCC_Pos                   _UINT32_(15)                                         /* (PAC_STATUSA Position) TCC2 APB Protect Enable */
...
#define PAC_STATUSC_SERCOM6(value)            (PAC_STATUSC_SERCOM6_Msk & (_UINT32_(value) << PAC_STATUSC_SERCOM6_Pos)) /* Assigment of value for SERCOM6 in the PAC_STATUSC register */
...
#define PAC_STATUSC_HMTX(value)               (PAC_STATUSC_HMTX_Msk & (_UINT32_(value) << PAC_STATUSC_HMTX_Pos)) /* Assigment of value for HMTX in the PAC_STATUSC register */
...
#define PAC_STATUSD_SERCOM2(value)            (PAC_STATUSD_SERCOM2_Msk & (_UINT32_(value) << PAC_STATUSD_SERCOM2_Pos)) /* Assigment of value for SERCOM2 in the PAC_STATUSD register */
...
#define PAC_STATUSD_SERCOM3(value)            (PAC_STATUSD_SERCOM3_Msk & (_UINT32_(value) << PAC_STATUSD_SERCOM3_Pos)) /* Assigment of value for SERCOM3 in the PAC_STATUSD register */
...
#define PAC_STATUSD_TC8(value)                (PAC_STATUSD_TC8_Msk & (_UINT32_(value) << PAC_STATUSD_TC8_Pos)) /* Assigment of value for TC8 in the PAC_STATUSD register */
...
#define PAC_STATUSD_TC9(value)                (PAC_STATUSD_TC9_Msk & (_UINT32_(value) << PAC_STATUSD_TC9_Pos)) /* Assigment of value for TC9 in the PAC_STATUSD register */
...
#define PAC_STATUSD_CAN0(value)               (PAC_STATUSD_CAN0_Msk & (_UINT32_(value) << PAC_STATUSD_CAN0_Pos)) /* Assigment of value for CAN0 in the PAC_STATUSD register */
...
#define PAC_STATUSD_CAN1(value)               (PAC_STATUSD_CAN1_Msk & (_UINT32_(value) << PAC_STATUSD_CAN1_Pos)) /* Assigment of value for CAN1 in the PAC_STATUSD register */
