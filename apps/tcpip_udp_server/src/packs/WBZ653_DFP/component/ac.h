...
#ifndef _WBZ65_AC_COMPONENT_H_
#define _WBZ65_AC_COMPONENT_H_
...
#define AC_COMPCTRL_Msk                       _UINT32_(0x3700F75E)                                 /* (AC_COMPCTRL) Register Mask  */
