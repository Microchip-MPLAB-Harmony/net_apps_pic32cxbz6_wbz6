...
#ifndef _WBZ65_DAC_CTRL_COMPONENT_H_
#define _WBZ65_DAC_CTRL_COMPONENT_H_
...
#define DAC_CTRL_DACCON_LPRCEN(value)         (DAC_CTRL_DACCON_LPRCEN_Msk & (_UINT32_(value) << DAC_CTRL_DACCON_LPRCEN_Pos)) /* Assigment of value for LPRCEN in the DAC_CTRL_DACCON register */
...
/* -------- DAC_CTRL_DAC_CODE : (DAC_CTRL Offset: 0x04) (R/W 32) DAC CODE Register -------- */
#define DAC_CTRL_DAC_CODE_RESETVALUE          _UINT32_(0x00)                                       /*  (DAC_CTRL_DAC_CODE) DAC CODE Register  Reset Value */

#define DAC_CTRL_DAC_CODE_DATA_Pos            _UINT32_(0)                                          /* (DAC_CTRL_DAC_CODE) DAC data Position */
#define DAC_CTRL_DAC_CODE_DATA_Msk            (_UINT32_(0x7F) << DAC_CTRL_DAC_CODE_DATA_Pos)       /* (DAC_CTRL_DAC_CODE) DAC data Mask */
#define DAC_CTRL_DAC_CODE_DATA(value)         (DAC_CTRL_DAC_CODE_DATA_Msk & (_UINT32_(value) << DAC_CTRL_DAC_CODE_DATA_Pos)) /* Assigment of value for DATA in the DAC_CTRL_DAC_CODE register */
#define DAC_CTRL_DAC_CODE_Msk                 _UINT32_(0x0000007F)                                 /* (DAC_CTRL_DAC_CODE) Register Mask  */
...
#define DAC_CTRL_DAC_CODE_REG_OFST     _UINT32_(0x04)      /* (DAC_CTRL_DAC_CODE) DAC CODE Register Offset */
...
{  /* Descriptive Title of Macro */
  ...
  __IO  uint32_t                       DAC_CTRL_DAC_CODE;  /**< Offset: 0x04 (R/W  32) DAC CODE Register */
  __IO  uint32_t                       DAC_CTRL_DACCON2;   /**< Offset: 0x08 (R/W  32) DAC Config register1 */
} dac_ctrl_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _WBZ65_DAC_CTRL_COMPONENT_H_ */
