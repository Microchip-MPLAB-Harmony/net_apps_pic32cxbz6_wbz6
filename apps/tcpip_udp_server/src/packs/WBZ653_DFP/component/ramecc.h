...
#ifndef _WBZ65_RAMECC_COMPONENT_H_
#define _WBZ65_RAMECC_COMPONENT_H_
...
#define RAMECC_ERRADDR_ERRADDR_Msk            (_UINT32_(0x3FFFF) << RAMECC_ERRADDR_ERRADDR_Pos)    /* (RAMECC_ERRADDR) Error Address Mask */
...
#define RAMECC_ERRADDR_Msk                    _UINT32_(0x0003FFFF)                                 /* (RAMECC_ERRADDR) Register Mask  */
...
#endif /* _WBZ65_RAMECC_COMPONENT_H_ */
