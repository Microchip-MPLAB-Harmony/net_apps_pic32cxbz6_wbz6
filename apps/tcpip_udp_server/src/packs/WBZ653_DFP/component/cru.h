...
#ifndef _WBZ65_CRU_COMPONENT_H_
#define _WBZ65_CRU_COMPONENT_H_
...
#define CRU_OSCCON_RESETVALUE                 _UINT32_(0x200001)                                   /*  (CRU_OSCCON) CRU OSCILLATOR CONTROL REGISTER  Reset Value */
...
#define   CRU_OSCCON_NOSC_EPLL_Val            _UINT32_(0x5)                                        /* (CRU_OSCCON) Ethernet PLL Clock-2 (EPLL Module) (input clock and divider set by APLLCON)  */
#define   CRU_OSCCON_NOSC_UPLL_Val            _UINT32_(0x6)                                        /* (CRU_OSCCON) USB PLL Clock (UPLL Module) (input clock and divider set by UPLLCON)  */
...
#define CRU_OSCCON_NOSC_EPLL                  (CRU_OSCCON_NOSC_EPLL_Val << CRU_OSCCON_NOSC_Pos)    /* (CRU_OSCCON) Ethernet PLL Clock-2 (EPLL Module) (input clock and divider set by APLLCON) Position  */
#define CRU_OSCCON_NOSC_UPLL                  (CRU_OSCCON_NOSC_UPLL_Val << CRU_OSCCON_NOSC_Pos)    /* (CRU_OSCCON) USB PLL Clock (UPLL Module) (input clock and divider set by UPLLCON) Position  */
...
#define   CRU_OSCCON_COSC_EPLL_Val            _UINT32_(0x5)                                        /* (CRU_OSCCON) Ethernet PLL Clock-2 (EPLL Module) (input clock and divider set by APLLCON)  */
#define   CRU_OSCCON_COSC_UPLL_Val            _UINT32_(0x6)                                        /* (CRU_OSCCON) USB PLL Clock (UPLL Module) (input clock and divider set by UPLLCON)  */
...
#define CRU_OSCCON_COSC_EPLL                  (CRU_OSCCON_COSC_EPLL_Val << CRU_OSCCON_COSC_Pos)    /* (CRU_OSCCON) Ethernet PLL Clock-2 (EPLL Module) (input clock and divider set by APLLCON) Position  */
#define CRU_OSCCON_COSC_UPLL                  (CRU_OSCCON_COSC_UPLL_Val << CRU_OSCCON_COSC_Pos)    /* (CRU_OSCCON) USB PLL Clock (UPLL Module) (input clock and divider set by UPLLCON) Position  */
...
#define CRU_SPLLCON_RESETVALUE                _UINT32_(0xC0010008)                                 /*  (CRU_SPLLCON) SPLL CONTROL REGISTER  Reset Value */
...
/* -------- CRU_UPLLCON : (CRU Offset: 0x30) (R/W 32) UPLL CONTROL REGISTER -------- */
#define CRU_UPLLCON_RESETVALUE                _UINT32_(0x80000808)                                 /*  (CRU_UPLLCON) UPLL CONTROL REGISTER  Reset Value */

#define CRU_UPLLCON_UPLLBSWSEL_Pos            _UINT32_(0)                                          /* (CRU_UPLLCON) UPLL Bandwidth Select Position */
#define CRU_UPLLCON_UPLLBSWSEL_Msk            (_UINT32_(0x7) << CRU_UPLLCON_UPLLBSWSEL_Pos)        /* (CRU_UPLLCON) UPLL Bandwidth Select Mask */
#define CRU_UPLLCON_UPLLBSWSEL(value)         (CRU_UPLLCON_UPLLBSWSEL_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLBSWSEL_Pos)) /* Assigment of value for UPLLBSWSEL in the CRU_UPLLCON register */
#define   CRU_UPLLCON_UPLLBSWSEL_400KHz_Val   _UINT32_(0x1)                                        /* (CRU_UPLLCON) UPLL closed loop bandwith 400KHz  */
#define   CRU_UPLLCON_UPLLBSWSEL_1MHz_Val     _UINT32_(0x2)                                        /* (CRU_UPLLCON) UPLL closed loop bandwith 1MHz  */
#define   CRU_UPLLCON_UPLLBSWSEL_2MHz_Val     _UINT32_(0x3)                                        /* (CRU_UPLLCON) UPLL closed loop bandwith 2MHz  */
#define   CRU_UPLLCON_UPLLBSWSEL_3MHz_Val     _UINT32_(0x4)                                        /* (CRU_UPLLCON) UPLL closed loop bandwith 3MHz  */
#define CRU_UPLLCON_UPLLBSWSEL_400KHz         (CRU_UPLLCON_UPLLBSWSEL_400KHz_Val << CRU_UPLLCON_UPLLBSWSEL_Pos) /* (CRU_UPLLCON) UPLL closed loop bandwith 400KHz Position  */
#define CRU_UPLLCON_UPLLBSWSEL_1MHz           (CRU_UPLLCON_UPLLBSWSEL_1MHz_Val << CRU_UPLLCON_UPLLBSWSEL_Pos) /* (CRU_UPLLCON) UPLL closed loop bandwith 1MHz Position  */
#define CRU_UPLLCON_UPLLBSWSEL_2MHz           (CRU_UPLLCON_UPLLBSWSEL_2MHz_Val << CRU_UPLLCON_UPLLBSWSEL_Pos) /* (CRU_UPLLCON) UPLL closed loop bandwith 2MHz Position  */
#define CRU_UPLLCON_UPLLBSWSEL_3MHz           (CRU_UPLLCON_UPLLBSWSEL_3MHz_Val << CRU_UPLLCON_UPLLBSWSEL_Pos) /* (CRU_UPLLCON) UPLL closed loop bandwith 3MHz Position  */
#define CRU_UPLLCON_UPLLPWDN_Pos              _UINT32_(3)                                          /* (CRU_UPLLCON) UPLL Power Down Register bit Position */
#define CRU_UPLLCON_UPLLPWDN_Msk              (_UINT32_(0x1) << CRU_UPLLCON_UPLLPWDN_Pos)          /* (CRU_UPLLCON) UPLL Power Down Register bit Mask */
#define CRU_UPLLCON_UPLLPWDN(value)           (CRU_UPLLCON_UPLLPWDN_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLPWDN_Pos)) /* Assigment of value for UPLLPWDN in the CRU_UPLLCON register */
#define   CRU_UPLLCON_UPLLPWDN_PLL_OFF_Val    _UINT32_(0x1)                                        /* (CRU_UPLLCON) UPLL is powered down  */
#define   CRU_UPLLCON_UPLLPWDN_PLL_ON_Val     _UINT32_(0x0)                                        /* (CRU_UPLLCON) UPLL is active  */
#define CRU_UPLLCON_UPLLPWDN_PLL_OFF          (CRU_UPLLCON_UPLLPWDN_PLL_OFF_Val << CRU_UPLLCON_UPLLPWDN_Pos) /* (CRU_UPLLCON) UPLL is powered down Position  */
#define CRU_UPLLCON_UPLLPWDN_PLL_ON           (CRU_UPLLCON_UPLLPWDN_PLL_ON_Val << CRU_UPLLCON_UPLLPWDN_Pos) /* (CRU_UPLLCON) UPLL is active Position  */
#define CRU_UPLLCON_UPLLPOSTDIV1_Pos          _UINT32_(4)                                          /* (CRU_UPLLCON) First Post Divide Value in between 1 and 63, value of 0 is unused. Position */
#define CRU_UPLLCON_UPLLPOSTDIV1_Msk          (_UINT32_(0x3F) << CRU_UPLLCON_UPLLPOSTDIV1_Pos)     /* (CRU_UPLLCON) First Post Divide Value in between 1 and 63, value of 0 is unused. Mask */
#define CRU_UPLLCON_UPLLPOSTDIV1(value)       (CRU_UPLLCON_UPLLPOSTDIV1_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLPOSTDIV1_Pos)) /* Assigment of value for UPLLPOSTDIV1 in the CRU_UPLLCON register */
#define CRU_UPLLCON_UPLLFLOCK_Pos             _UINT32_(10)                                         /* (CRU_UPLLCON) USB PLL Force Lock Position */
#define CRU_UPLLCON_UPLLFLOCK_Msk             (_UINT32_(0x1) << CRU_UPLLCON_UPLLFLOCK_Pos)         /* (CRU_UPLLCON) USB PLL Force Lock Mask */
#define CRU_UPLLCON_UPLLFLOCK(value)          (CRU_UPLLCON_UPLLFLOCK_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLFLOCK_Pos)) /* Assigment of value for UPLLFLOCK in the CRU_UPLLCON register */
#define   CRU_UPLLCON_UPLLFLOCK_ASSERT_Val    _UINT32_(0x1)                                        /* (CRU_UPLLCON) Force the UPLL lock signal to be asserted  */
#define   CRU_UPLLCON_UPLLFLOCK_NO_ASSERT_Val _UINT32_(0x0)                                        /* (CRU_UPLLCON) Do not force the SPLL lock signal to be asserted  */
#define CRU_UPLLCON_UPLLFLOCK_ASSERT          (CRU_UPLLCON_UPLLFLOCK_ASSERT_Val << CRU_UPLLCON_UPLLFLOCK_Pos) /* (CRU_UPLLCON) Force the UPLL lock signal to be asserted Position  */
#define CRU_UPLLCON_UPLLFLOCK_NO_ASSERT       (CRU_UPLLCON_UPLLFLOCK_NO_ASSERT_Val << CRU_UPLLCON_UPLLFLOCK_Pos) /* (CRU_UPLLCON) Do not force the SPLL lock signal to be asserted Position  */
#define CRU_UPLLCON_UPLLRST_Pos               _UINT32_(11)                                         /* (CRU_UPLLCON) USB PLL Reset Position */
#define CRU_UPLLCON_UPLLRST_Msk               (_UINT32_(0x1) << CRU_UPLLCON_UPLLRST_Pos)           /* (CRU_UPLLCON) USB PLL Reset Mask */
#define CRU_UPLLCON_UPLLRST(value)            (CRU_UPLLCON_UPLLRST_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLRST_Pos)) /* Assigment of value for UPLLRST in the CRU_UPLLCON register */
#define   CRU_UPLLCON_UPLLRST_ASSERT_Val      _UINT32_(0x1)                                        /* (CRU_UPLLCON) Assert the reset to the UPLL  */
#define   CRU_UPLLCON_UPLLRST_NO_ASSERT_Val   _UINT32_(0x0)                                        /* (CRU_UPLLCON) De-assert the reset to the UPLL  */
#define CRU_UPLLCON_UPLLRST_ASSERT            (CRU_UPLLCON_UPLLRST_ASSERT_Val << CRU_UPLLCON_UPLLRST_Pos) /* (CRU_UPLLCON) Assert the reset to the UPLL Position  */
#define CRU_UPLLCON_UPLLRST_NO_ASSERT         (CRU_UPLLCON_UPLLRST_NO_ASSERT_Val << CRU_UPLLCON_UPLLRST_Pos) /* (CRU_UPLLCON) De-assert the reset to the UPLL Position  */
#define CRU_UPLLCON_UPLLFBDIV_Pos             _UINT32_(12)                                         /* (CRU_UPLLCON) PLL feedback divider in between 16 and 1023, values of 0 to 15 are unused Position */
#define CRU_UPLLCON_UPLLFBDIV_Msk             (_UINT32_(0x3FF) << CRU_UPLLCON_UPLLFBDIV_Pos)       /* (CRU_UPLLCON) PLL feedback divider in between 16 and 1023, values of 0 to 15 are unused Mask */
#define CRU_UPLLCON_UPLLFBDIV(value)          (CRU_UPLLCON_UPLLFBDIV_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLFBDIV_Pos)) /* Assigment of value for UPLLFBDIV in the CRU_UPLLCON register */
#define CRU_UPLLCON_UPLLREFDIV_Pos            _UINT32_(22)                                         /* (CRU_UPLLCON) Reference Frequency Divide in between 1 and 63, value of 0 is unused. Position */
#define CRU_UPLLCON_UPLLREFDIV_Msk            (_UINT32_(0x3F) << CRU_UPLLCON_UPLLREFDIV_Pos)       /* (CRU_UPLLCON) Reference Frequency Divide in between 1 and 63, value of 0 is unused. Mask */
#define CRU_UPLLCON_UPLLREFDIV(value)         (CRU_UPLLCON_UPLLREFDIV_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLLREFDIV_Pos)) /* Assigment of value for UPLLREFDIV in the CRU_UPLLCON register */
#define CRU_UPLLCON_UPLL_BYP_Pos              _UINT32_(31)                                         /* (CRU_UPLLCON) The input clock REF bypasses PLL to PLLOUTx Position */
#define CRU_UPLLCON_UPLL_BYP_Msk              (_UINT32_(0x1) << CRU_UPLLCON_UPLL_BYP_Pos)          /* (CRU_UPLLCON) The input clock REF bypasses PLL to PLLOUTx Mask */
#define CRU_UPLLCON_UPLL_BYP(value)           (CRU_UPLLCON_UPLL_BYP_Msk & (_UINT32_(value) << CRU_UPLLCON_UPLL_BYP_Pos)) /* Assigment of value for UPLL_BYP in the CRU_UPLLCON register */
#define   CRU_UPLLCON_UPLL_BYP_BYPASS_Val     _UINT32_(0x1)                                        /* (CRU_UPLLCON) UPLL Bypass; when this bit is set, the input clock REF bypasses PLL to PLLOUTx  */
#define   CRU_UPLLCON_UPLL_BYP_NOT_BYPASS_Val _UINT32_(0x0)                                        /* (CRU_UPLLCON) The input clock dont bypass  */
#define CRU_UPLLCON_UPLL_BYP_BYPASS           (CRU_UPLLCON_UPLL_BYP_BYPASS_Val << CRU_UPLLCON_UPLL_BYP_Pos) /* (CRU_UPLLCON) UPLL Bypass; when this bit is set, the input clock REF bypasses PLL to PLLOUTx Position  */
#define CRU_UPLLCON_UPLL_BYP_NOT_BYPASS       (CRU_UPLLCON_UPLL_BYP_NOT_BYPASS_Val << CRU_UPLLCON_UPLL_BYP_Pos) /* (CRU_UPLLCON) The input clock dont bypass Position  */
#define CRU_UPLLCON_Msk                       _UINT32_(0x8FFFFFFF)                                 /* (CRU_UPLLCON) Register Mask  */


/* -------- CRU_UPLLCONCLR : (CRU Offset: 0x34) (R/W 32)  -------- */
#define CRU_UPLLCONCLR_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_UPLLCONCLR)   Reset Value */

#define CRU_UPLLCONCLR_Msk                    _UINT32_(0x00000000)                                 /* (CRU_UPLLCONCLR) Register Mask  */


/* -------- CRU_UPLLCONSET : (CRU Offset: 0x38) (R/W 32)  -------- */
#define CRU_UPLLCONSET_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_UPLLCONSET)   Reset Value */

#define CRU_UPLLCONSET_Msk                    _UINT32_(0x00000000)                                 /* (CRU_UPLLCONSET) Register Mask  */


/* -------- CRU_UPLLCONINV : (CRU Offset: 0x3C) (R/W 32)  -------- */
#define CRU_UPLLCONINV_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_UPLLCONINV)   Reset Value */

#define CRU_UPLLCONINV_Msk                    _UINT32_(0x00000000)                                 /* (CRU_UPLLCONINV) Register Mask  */


/* -------- CRU_EPLLCON : (CRU Offset: 0x40) (R/W 32) EPLL CONTROL REGISTER -------- */
#define CRU_EPLLCON_RESETVALUE                _UINT32_(0x80000808)                                 /*  (CRU_EPLLCON) EPLL CONTROL REGISTER  Reset Value */

#define CRU_EPLLCON_EPLLBSWSEL_Pos            _UINT32_(0)                                          /* (CRU_EPLLCON) EPLL Bandwidth Select Position */
#define CRU_EPLLCON_EPLLBSWSEL_Msk            (_UINT32_(0x7) << CRU_EPLLCON_EPLLBSWSEL_Pos)        /* (CRU_EPLLCON) EPLL Bandwidth Select Mask */
#define CRU_EPLLCON_EPLLBSWSEL(value)         (CRU_EPLLCON_EPLLBSWSEL_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLBSWSEL_Pos)) /* Assigment of value for EPLLBSWSEL in the CRU_EPLLCON register */
#define   CRU_EPLLCON_EPLLBSWSEL_400KHz_Val   _UINT32_(0x1)                                        /* (CRU_EPLLCON) EPLL closed loop bandwith 400KHz  */
#define   CRU_EPLLCON_EPLLBSWSEL_1MHz_Val     _UINT32_(0x2)                                        /* (CRU_EPLLCON) EPLL closed loop bandwith 1MHz  */
#define   CRU_EPLLCON_EPLLBSWSEL_2MHz_Val     _UINT32_(0x3)                                        /* (CRU_EPLLCON) EPLL closed loop bandwith 2MHz  */
#define   CRU_EPLLCON_EPLLBSWSEL_3MHz_Val     _UINT32_(0x4)                                        /* (CRU_EPLLCON) EPLL closed loop bandwith 3MHz  */
#define CRU_EPLLCON_EPLLBSWSEL_400KHz         (CRU_EPLLCON_EPLLBSWSEL_400KHz_Val << CRU_EPLLCON_EPLLBSWSEL_Pos) /* (CRU_EPLLCON) EPLL closed loop bandwith 400KHz Position  */
#define CRU_EPLLCON_EPLLBSWSEL_1MHz           (CRU_EPLLCON_EPLLBSWSEL_1MHz_Val << CRU_EPLLCON_EPLLBSWSEL_Pos) /* (CRU_EPLLCON) EPLL closed loop bandwith 1MHz Position  */
#define CRU_EPLLCON_EPLLBSWSEL_2MHz           (CRU_EPLLCON_EPLLBSWSEL_2MHz_Val << CRU_EPLLCON_EPLLBSWSEL_Pos) /* (CRU_EPLLCON) EPLL closed loop bandwith 2MHz Position  */
#define CRU_EPLLCON_EPLLBSWSEL_3MHz           (CRU_EPLLCON_EPLLBSWSEL_3MHz_Val << CRU_EPLLCON_EPLLBSWSEL_Pos) /* (CRU_EPLLCON) EPLL closed loop bandwith 3MHz Position  */
#define CRU_EPLLCON_EPLLPWDN_Pos              _UINT32_(3)                                          /* (CRU_EPLLCON) EPLL Power Down Register bit Position */
#define CRU_EPLLCON_EPLLPWDN_Msk              (_UINT32_(0x1) << CRU_EPLLCON_EPLLPWDN_Pos)          /* (CRU_EPLLCON) EPLL Power Down Register bit Mask */
#define CRU_EPLLCON_EPLLPWDN(value)           (CRU_EPLLCON_EPLLPWDN_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLPWDN_Pos)) /* Assigment of value for EPLLPWDN in the CRU_EPLLCON register */
#define   CRU_EPLLCON_EPLLPWDN_PLL_OFF_Val    _UINT32_(0x1)                                        /* (CRU_EPLLCON) EPLL is powered down  */
#define   CRU_EPLLCON_EPLLPWDN_PLL_ON_Val     _UINT32_(0x0)                                        /* (CRU_EPLLCON) EPLL is active  */
#define CRU_EPLLCON_EPLLPWDN_PLL_OFF          (CRU_EPLLCON_EPLLPWDN_PLL_OFF_Val << CRU_EPLLCON_EPLLPWDN_Pos) /* (CRU_EPLLCON) EPLL is powered down Position  */
#define CRU_EPLLCON_EPLLPWDN_PLL_ON           (CRU_EPLLCON_EPLLPWDN_PLL_ON_Val << CRU_EPLLCON_EPLLPWDN_Pos) /* (CRU_EPLLCON) EPLL is active Position  */
#define CRU_EPLLCON_EPLLPOSTDIV1_Pos          _UINT32_(4)                                          /* (CRU_EPLLCON) First Post Divide Value in between 1 and 63, value of 0 is unused. Position */
#define CRU_EPLLCON_EPLLPOSTDIV1_Msk          (_UINT32_(0x3F) << CRU_EPLLCON_EPLLPOSTDIV1_Pos)     /* (CRU_EPLLCON) First Post Divide Value in between 1 and 63, value of 0 is unused. Mask */
#define CRU_EPLLCON_EPLLPOSTDIV1(value)       (CRU_EPLLCON_EPLLPOSTDIV1_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLPOSTDIV1_Pos)) /* Assigment of value for EPLLPOSTDIV1 in the CRU_EPLLCON register */
#define CRU_EPLLCON_EPLLFLOCK_Pos             _UINT32_(10)                                         /* (CRU_EPLLCON) Ethernet PLL Force Lock Position */
#define CRU_EPLLCON_EPLLFLOCK_Msk             (_UINT32_(0x1) << CRU_EPLLCON_EPLLFLOCK_Pos)         /* (CRU_EPLLCON) Ethernet PLL Force Lock Mask */
#define CRU_EPLLCON_EPLLFLOCK(value)          (CRU_EPLLCON_EPLLFLOCK_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLFLOCK_Pos)) /* Assigment of value for EPLLFLOCK in the CRU_EPLLCON register */
#define   CRU_EPLLCON_EPLLFLOCK_ASSERT_Val    _UINT32_(0x1)                                        /* (CRU_EPLLCON) Force the EPLL lock signal to be asserted  */
#define   CRU_EPLLCON_EPLLFLOCK_NO_ASSERT_Val _UINT32_(0x0)                                        /* (CRU_EPLLCON) Do not force the SPLL lock signal to be asserted  */
#define CRU_EPLLCON_EPLLFLOCK_ASSERT          (CRU_EPLLCON_EPLLFLOCK_ASSERT_Val << CRU_EPLLCON_EPLLFLOCK_Pos) /* (CRU_EPLLCON) Force the EPLL lock signal to be asserted Position  */
#define CRU_EPLLCON_EPLLFLOCK_NO_ASSERT       (CRU_EPLLCON_EPLLFLOCK_NO_ASSERT_Val << CRU_EPLLCON_EPLLFLOCK_Pos) /* (CRU_EPLLCON) Do not force the SPLL lock signal to be asserted Position  */
#define CRU_EPLLCON_EPLLRST_Pos               _UINT32_(11)                                         /* (CRU_EPLLCON) Ethernet PLL Reset Position */
#define CRU_EPLLCON_EPLLRST_Msk               (_UINT32_(0x1) << CRU_EPLLCON_EPLLRST_Pos)           /* (CRU_EPLLCON) Ethernet PLL Reset Mask */
#define CRU_EPLLCON_EPLLRST(value)            (CRU_EPLLCON_EPLLRST_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLRST_Pos)) /* Assigment of value for EPLLRST in the CRU_EPLLCON register */
#define   CRU_EPLLCON_EPLLRST_ASSERT_Val      _UINT32_(0x1)                                        /* (CRU_EPLLCON) Assert the reset to the EPLL  */
#define   CRU_EPLLCON_EPLLRST_NO_ASSERT_Val   _UINT32_(0x0)                                        /* (CRU_EPLLCON) De-assert the reset to the EPLL  */
#define CRU_EPLLCON_EPLLRST_ASSERT            (CRU_EPLLCON_EPLLRST_ASSERT_Val << CRU_EPLLCON_EPLLRST_Pos) /* (CRU_EPLLCON) Assert the reset to the EPLL Position  */
#define CRU_EPLLCON_EPLLRST_NO_ASSERT         (CRU_EPLLCON_EPLLRST_NO_ASSERT_Val << CRU_EPLLCON_EPLLRST_Pos) /* (CRU_EPLLCON) De-assert the reset to the EPLL Position  */
#define CRU_EPLLCON_EPLLFBDIV_Pos             _UINT32_(12)                                         /* (CRU_EPLLCON) PLL feedback divider in between 16 and 1023, values of 0 to 15 are unused Position */
#define CRU_EPLLCON_EPLLFBDIV_Msk             (_UINT32_(0x3FF) << CRU_EPLLCON_EPLLFBDIV_Pos)       /* (CRU_EPLLCON) PLL feedback divider in between 16 and 1023, values of 0 to 15 are unused Mask */
#define CRU_EPLLCON_EPLLFBDIV(value)          (CRU_EPLLCON_EPLLFBDIV_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLFBDIV_Pos)) /* Assigment of value for EPLLFBDIV in the CRU_EPLLCON register */
#define CRU_EPLLCON_EPLLREFDIV_Pos            _UINT32_(22)                                         /* (CRU_EPLLCON) Reference Frequency Divide in between 1 and 63, value of 0 is unused. Position */
#define CRU_EPLLCON_EPLLREFDIV_Msk            (_UINT32_(0x3F) << CRU_EPLLCON_EPLLREFDIV_Pos)       /* (CRU_EPLLCON) Reference Frequency Divide in between 1 and 63, value of 0 is unused. Mask */
#define CRU_EPLLCON_EPLLREFDIV(value)         (CRU_EPLLCON_EPLLREFDIV_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLLREFDIV_Pos)) /* Assigment of value for EPLLREFDIV in the CRU_EPLLCON register */
#define CRU_EPLLCON_ECLKOUTEN_Pos             _UINT32_(28)                                         /* (CRU_EPLLCON) Ethernet Clock Out pin Enable Position */
#define CRU_EPLLCON_ECLKOUTEN_Msk             (_UINT32_(0x1) << CRU_EPLLCON_ECLKOUTEN_Pos)         /* (CRU_EPLLCON) Ethernet Clock Out pin Enable Mask */
#define CRU_EPLLCON_ECLKOUTEN(value)          (CRU_EPLLCON_ECLKOUTEN_Msk & (_UINT32_(value) << CRU_EPLLCON_ECLKOUTEN_Pos)) /* Assigment of value for ECLKOUTEN in the CRU_EPLLCON register */
#define   CRU_EPLLCON_ECLKOUTEN_Enable_Val    _UINT32_(0x1)                                        /* (CRU_EPLLCON) ETH_CLK_OUT Pin is enabled  */
#define   CRU_EPLLCON_ECLKOUTEN_Disable_Val   _UINT32_(0x0)                                        /* (CRU_EPLLCON) ETH_CLK_OUT Pin is disabled  */
#define CRU_EPLLCON_ECLKOUTEN_Enable          (CRU_EPLLCON_ECLKOUTEN_Enable_Val << CRU_EPLLCON_ECLKOUTEN_Pos) /* (CRU_EPLLCON) ETH_CLK_OUT Pin is enabled Position  */
#define CRU_EPLLCON_ECLKOUTEN_Disable         (CRU_EPLLCON_ECLKOUTEN_Disable_Val << CRU_EPLLCON_ECLKOUTEN_Pos) /* (CRU_EPLLCON) ETH_CLK_OUT Pin is disabled Position  */
#define CRU_EPLLCON_EPLL_BYP_Pos              _UINT32_(31)                                         /* (CRU_EPLLCON) The input clock REF bypasses PLL to PLLOUTx Position */
#define CRU_EPLLCON_EPLL_BYP_Msk              (_UINT32_(0x1) << CRU_EPLLCON_EPLL_BYP_Pos)          /* (CRU_EPLLCON) The input clock REF bypasses PLL to PLLOUTx Mask */
#define CRU_EPLLCON_EPLL_BYP(value)           (CRU_EPLLCON_EPLL_BYP_Msk & (_UINT32_(value) << CRU_EPLLCON_EPLL_BYP_Pos)) /* Assigment of value for EPLL_BYP in the CRU_EPLLCON register */
#define   CRU_EPLLCON_EPLL_BYP_BYPASS_Val     _UINT32_(0x1)                                        /* (CRU_EPLLCON) EPLL Bypass; when this bit is set, the input clock REF bypasses PLL to PLLOUTx  */
#define   CRU_EPLLCON_EPLL_BYP_NOT_BYPASS_Val _UINT32_(0x0)                                        /* (CRU_EPLLCON) The input clock dont bypass  */
#define CRU_EPLLCON_EPLL_BYP_BYPASS           (CRU_EPLLCON_EPLL_BYP_BYPASS_Val << CRU_EPLLCON_EPLL_BYP_Pos) /* (CRU_EPLLCON) EPLL Bypass; when this bit is set, the input clock REF bypasses PLL to PLLOUTx Position  */
#define CRU_EPLLCON_EPLL_BYP_NOT_BYPASS       (CRU_EPLLCON_EPLL_BYP_NOT_BYPASS_Val << CRU_EPLLCON_EPLL_BYP_Pos) /* (CRU_EPLLCON) The input clock dont bypass Position  */
#define CRU_EPLLCON_Msk                       _UINT32_(0x9FFFFFFF)                                 /* (CRU_EPLLCON) Register Mask  */


/* -------- CRU_EPLLCONCLR : (CRU Offset: 0x44) (R/W 32)  -------- */
#define CRU_EPLLCONCLR_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_EPLLCONCLR)   Reset Value */

#define CRU_EPLLCONCLR_Msk                    _UINT32_(0x00000000)                                 /* (CRU_EPLLCONCLR) Register Mask  */


/* -------- CRU_EPLLCONSET : (CRU Offset: 0x48) (R/W 32)  -------- */
#define CRU_EPLLCONSET_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_EPLLCONSET)   Reset Value */

#define CRU_EPLLCONSET_Msk                    _UINT32_(0x00000000)                                 /* (CRU_EPLLCONSET) Register Mask  */


/* -------- CRU_EPLLCONINV : (CRU Offset: 0x4C) (R/W 32)  -------- */
#define CRU_EPLLCONINV_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_EPLLCONINV)   Reset Value */

#define CRU_EPLLCONINV_Msk                    _UINT32_(0x00000000)                                 /* (CRU_EPLLCONINV) Register Mask  */


/* -------- CRU_APLLCON : (CRU Offset: 0x50) (R/W 32) APLL CONTROL REGISTER -------- */
#define CRU_APLLCON_RESETVALUE                _UINT32_(0x00)                                       /*  (CRU_APLLCON) APLL CONTROL REGISTER  Reset Value */

#define CRU_APLLCON_EPLLPOSTIDIV2_Pos         _UINT32_(0)                                          /* (CRU_APLLCON) EPLL Post Divider bits for controlling second PLL clock output, value of 0 is unused. Position */
#define CRU_APLLCON_EPLLPOSTIDIV2_Msk         (_UINT32_(0x3F) << CRU_APLLCON_EPLLPOSTIDIV2_Pos)    /* (CRU_APLLCON) EPLL Post Divider bits for controlling second PLL clock output, value of 0 is unused. Mask */
#define CRU_APLLCON_EPLLPOSTIDIV2(value)      (CRU_APLLCON_EPLLPOSTIDIV2_Msk & (_UINT32_(value) << CRU_APLLCON_EPLLPOSTIDIV2_Pos)) /* Assigment of value for EPLLPOSTIDIV2 in the CRU_APLLCON register */
#define CRU_APLLCON_Msk                       _UINT32_(0x0000003F)                                 /* (CRU_APLLCON) Register Mask  */


/* -------- CRU_APLLCONCLR : (CRU Offset: 0x54) (R/W 32)  -------- */
#define CRU_APLLCONCLR_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_APLLCONCLR)   Reset Value */

#define CRU_APLLCONCLR_Msk                    _UINT32_(0x00000000)                                 /* (CRU_APLLCONCLR) Register Mask  */


/* -------- CRU_APLLCONSET : (CRU Offset: 0x58) (R/W 32)  -------- */
#define CRU_APLLCONSET_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_APLLCONSET)   Reset Value */

#define CRU_APLLCONSET_Msk                    _UINT32_(0x00000000)                                 /* (CRU_APLLCONSET) Register Mask  */


/* -------- CRU_APLLCONINV : (CRU Offset: 0x5C) (R/W 32)  -------- */
#define CRU_APLLCONINV_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_APLLCONINV)   Reset Value */

#define CRU_APLLCONINV_Msk                    _UINT32_(0x00000000)                                 /* (CRU_APLLCONINV) Register Mask  */


/* -------- CRU_REFO1CON : (CRU Offset: 0xA0) (R/W 32) REFERENCE OSCILLATOR 1 CONTROL REGISTER -------- */
...
#define   CRU_REFO1CON_ROSEL_REFCLKI_Val      _UINT32_(0xB)                                        /* (CRU_REFO1CON) REFI Pin  */
#define   CRU_REFO1CON_ROSEL_SYSCLK_Val       _UINT32_(0xA)                                        /* (CRU_REFO1CON) System clock (reference clock reflects any device clock switching)  */
#define   CRU_REFO1CON_ROSEL_PBCLK1_Val       _UINT32_(0x9)                                        /* (CRU_REFO1CON) Peripheral clock 1 (reference clock reflects any peripheral clock switching)  */
#define   CRU_REFO1CON_ROSEL_EPLL1_Val        _UINT32_(0x8)                                        /* (CRU_REFO1CON) Ethernet PLL1 (Clock-1)  */
#define   CRU_REFO1CON_ROSEL_SPLL3_Val        _UINT32_(0x7)                                        /* (CRU_REFO1CON) System PLL3 (Clock-3)  */
#define   CRU_REFO1CON_ROSEL_USBPLL_Val       _UINT32_(0x6)                                        /* (CRU_REFO1CON) USB PLL  */
#define   CRU_REFO1CON_ROSEL_EPLL2_Val        _UINT32_(0x5)                                        /* (CRU_REFO1CON) Ethernet PLL2 (Clock-2)  */
...
#define CRU_REFO1CON_ROSEL_EPLL1              (CRU_REFO1CON_ROSEL_EPLL1_Val << CRU_REFO1CON_ROSEL_Pos) /* (CRU_REFO1CON) Ethernet PLL1 (Clock-1) Position  */
...
#define CRU_REFO1CON_ROSEL_USBPLL             (CRU_REFO1CON_ROSEL_USBPLL_Val << CRU_REFO1CON_ROSEL_Pos) /* (CRU_REFO1CON) USB PLL Position  */
#define CRU_REFO1CON_ROSEL_EPLL2              (CRU_REFO1CON_ROSEL_EPLL2_Val << CRU_REFO1CON_ROSEL_Pos) /* (CRU_REFO1CON) Ethernet PLL2 (Clock-2) Position  */
...
/* -------- CRU_REFO1CONCLR : (CRU Offset: 0xA4) (R/W 32)  -------- */
...
/* -------- CRU_REFO1CONSET : (CRU Offset: 0xA8) (R/W 32)  -------- */
...
/* -------- CRU_REFO1CONINV : (CRU Offset: 0xAC) (R/W 32)  -------- */
...
/* -------- CRU_REFO1TRIM : (CRU Offset: 0xB0) (R/W 32) REFERENCE OSCILLATOR 1 TRIM REGISTER -------- */
...
/* -------- CRU_REFO1TRIMCLR : (CRU Offset: 0xB4) (R/W 32)  -------- */
...
/* -------- CRU_REFO1TRIMSET : (CRU Offset: 0xB8) (R/W 32)  -------- */
...
/* -------- CRU_REFO1TRIMINV : (CRU Offset: 0xBC) (R/W 32)  -------- */
...
/* -------- CRU_REFO2CON : (CRU Offset: 0xC0) (R/W 32) REFERENCE OSCILLATOR 2 CONTROL REGISTER -------- */
...
/* -------- CRU_REFO2CONCLR : (CRU Offset: 0xC4) (R/W 32)  -------- */
...
/* -------- CRU_REFO2CONSET : (CRU Offset: 0xC8) (R/W 32)  -------- */
...
/* -------- CRU_REFO2CONINV : (CRU Offset: 0xCC) (R/W 32)  -------- */
...
/* -------- CRU_REFO2TRIM : (CRU Offset: 0xD0) (R/W 32) REFERENCE OSCILLATOR 2 TRIM REGISTER -------- */
...
/* -------- CRU_REFO2TRIMCLR : (CRU Offset: 0xD4) (R/W 32)  -------- */
...
/* -------- CRU_REFO2TRIMSET : (CRU Offset: 0xD8) (R/W 32)  -------- */
...
/* -------- CRU_REFO2TRIMINV : (CRU Offset: 0xDC) (R/W 32)  -------- */
...
/* -------- CRU_REFO3CON : (CRU Offset: 0xE0) (R/W 32) REFERENCE OSCILLATOR 3 CONTROL REGISTER -------- */
...
/* -------- CRU_REFO3CONCLR : (CRU Offset: 0xE4) (R/W 32)  -------- */
...
/* -------- CRU_REFO3CONSET : (CRU Offset: 0xE8) (R/W 32)  -------- */
...
/* -------- CRU_REFO3CONINV : (CRU Offset: 0xEC) (R/W 32)  -------- */
...
/* -------- CRU_REFO3TRIM : (CRU Offset: 0xF0) (R/W 32) REFERENCE OSCILLATOR 3 TRIM REGISTER -------- */
...
/* -------- CRU_REFO3TRIMCLR : (CRU Offset: 0xF4) (R/W 32)  -------- */
...
/* -------- CRU_REFO3TRIMSET : (CRU Offset: 0xF8) (R/W 32)  -------- */
...
/* -------- CRU_REFO3TRIMINV : (CRU Offset: 0xFC) (R/W 32)  -------- */
...
/* -------- CRU_REFO4CON : (CRU Offset: 0x100) (R/W 32) REFERENCE OSCILLATOR 4 CONTROL REGISTER -------- */
...
/* -------- CRU_REFO4CONCLR : (CRU Offset: 0x104) (R/W 32)  -------- */
...
/* -------- CRU_REFO4CONSET : (CRU Offset: 0x108) (R/W 32)  -------- */
...
/* -------- CRU_REFO4CONINV : (CRU Offset: 0x10C) (R/W 32)  -------- */
...
/* -------- CRU_REFO4TRIM : (CRU Offset: 0x110) (R/W 32) REFERENCE OSCILLATOR 4 TRIM REGISTER -------- */
...
/* -------- CRU_REFO4TRIMCLR : (CRU Offset: 0x114) (R/W 32)  -------- */
...
/* -------- CRU_REFO4TRIMSET : (CRU Offset: 0x118) (R/W 32)  -------- */
...
/* -------- CRU_REFO4TRIMINV : (CRU Offset: 0x11C) (R/W 32)  -------- */
...
/* -------- CRU_REFO5CON : (CRU Offset: 0x120) (R/W 32) REFERENCE OSCILLATOR 5 CONTROL REGISTER -------- */
...
/* -------- CRU_REFO5CONCLR : (CRU Offset: 0x124) (R/W 32)  -------- */
...
/* -------- CRU_REFO5CONSET : (CRU Offset: 0x128) (R/W 32)  -------- */
...
/* -------- CRU_REFO5CONINV : (CRU Offset: 0x12C) (R/W 32)  -------- */
...
/* -------- CRU_REFO5TRIM : (CRU Offset: 0x130) (R/W 32) REFERENCE OSCILLATOR 5 TRIM REGISTER -------- */
...
/* -------- CRU_REFO5TRIMCLR : (CRU Offset: 0x134) (R/W 32)  -------- */
...
/* -------- CRU_REFO5TRIMSET : (CRU Offset: 0x138) (R/W 32)  -------- */
...
/* -------- CRU_REFO5TRIMINV : (CRU Offset: 0x13C) (R/W 32)  -------- */
...
/* -------- CRU_REFO6CON : (CRU Offset: 0x140) (R/W 32) REFERENCE OSCILLATOR 6 CONTROL REGISTER -------- */
...
/* -------- CRU_REFO6CONCLR : (CRU Offset: 0x144) (R/W 32)  -------- */
...
/* -------- CRU_REFO6CONSET : (CRU Offset: 0x148) (R/W 32)  -------- */
...
/* -------- CRU_REFO6CONINV : (CRU Offset: 0x14C) (R/W 32)  -------- */
...
/* -------- CRU_REFO6TRIM : (CRU Offset: 0x150) (R/W 32) REFERENCE OSCILLATOR 6 TRIM REGISTER -------- */
...
/* -------- CRU_REFO6TRIMCLR : (CRU Offset: 0x154) (R/W 32)  -------- */
...
/* -------- CRU_REFO6TRIMSET : (CRU Offset: 0x158) (R/W 32)  -------- */
...
/* -------- CRU_REFO6TRIMINV : (CRU Offset: 0x15C) (R/W 32)  -------- */
...
/* -------- CRU_PB1DIV : (CRU Offset: 0x160) (R/W 32) PB1 CLOCK DIVISOR CONTROL REGISTER -------- */
...
/* -------- CRU_PB1DIVCLR : (CRU Offset: 0x164) (R/W 32)  -------- */
...
/* -------- CRU_PB1DIVSET : (CRU Offset: 0x168) (R/W 32)  -------- */
...
/* -------- CRU_PB1DIVINV : (CRU Offset: 0x16C) (R/W 32)  -------- */
...
/* -------- CRU_PB2DIV : (CRU Offset: 0x170) (R/W 32) PB2 CLOCK DIVISOR CONTROL REGISTER -------- */
...
/* -------- CRU_PB2DIVCLR : (CRU Offset: 0x174) (R/W 32)  -------- */
...
/* -------- CRU_PB2DIVSET : (CRU Offset: 0x178) (R/W 32)  -------- */
...
/* -------- CRU_PB2DIVINV : (CRU Offset: 0x17C) (R/W 32)  -------- */
...
/* -------- CRU_PB3DIV : (CRU Offset: 0x180) (R/W 32) PB3 CLOCK DIVISOR CONTROL REGISTER -------- */
#define CRU_PB3DIV_RESETVALUE                 _UINT32_(0x8813)                                     /*  (CRU_PB3DIV) PB3 CLOCK DIVISOR CONTROL REGISTER  Reset Value */
...
/* -------- CRU_PB3DIVCLR : (CRU Offset: 0x184) (R/W 32)  -------- */
...
/* -------- CRU_PB3DIVSET : (CRU Offset: 0x188) (R/W 32)  -------- */
...
/* -------- CRU_PB3DIVINV : (CRU Offset: 0x18C) (R/W 32)  -------- */
...
/* -------- CRU_PB4DIV : (CRU Offset: 0x190) (R/W 32) PB4 CLOCK DIVISOR CONTROL REGISTER -------- */
#define CRU_PB4DIV_RESETVALUE                 _UINT32_(0x8801)                                     /*  (CRU_PB4DIV) PB4 CLOCK DIVISOR CONTROL REGISTER  Reset Value */

#define CRU_PB4DIV_PBDIV_Pos                  _UINT32_(0)                                          /* (CRU_PB4DIV) PB4 Peripheral Clock Divisor Control value Position */
#define CRU_PB4DIV_PBDIV_Msk                  (_UINT32_(0x7F) << CRU_PB4DIV_PBDIV_Pos)             /* (CRU_PB4DIV) PB4 Peripheral Clock Divisor Control value Mask */
#define CRU_PB4DIV_PBDIV(value)               (CRU_PB4DIV_PBDIV_Msk & (_UINT32_(value) << CRU_PB4DIV_PBDIV_Pos)) /* Assigment of value for PBDIV in the CRU_PB4DIV register */
#define   CRU_PB4DIV_PBDIV_DIV1_Val           _UINT32_(0x0)                                        /* (CRU_PB4DIV) Divide by 1 PB4 Clock same frequency as sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV2_Val           _UINT32_(0x1)                                        /* (CRU_PB4DIV) Divide by 2 PB4 Clock is 1/2 of sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV3_Val           _UINT32_(0x2)                                        /* (CRU_PB4DIV) Divide by 3 PB4 Clock is 1/3 of sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV16_Val          _UINT32_(0xF)                                        /* (CRU_PB4DIV) Divide by 16 PB4 Clock is 1/16 of sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV17_Val          _UINT32_(0x10)                                       /* (CRU_PB4DIV) Divide by 17 PB4 Clock is 1/17 of sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV127_Val         _UINT32_(0x7E)                                       /* (CRU_PB4DIV) Divide by 127 PB4 Clock is 1/127 of sys_clk  */
#define   CRU_PB4DIV_PBDIV_DIV128_Val         _UINT32_(0x7F)                                       /* (CRU_PB4DIV) Divide by 128 PB4 Clock is 1/128 of sys_clk  */
#define CRU_PB4DIV_PBDIV_DIV1                 (CRU_PB4DIV_PBDIV_DIV1_Val << CRU_PB4DIV_PBDIV_Pos)  /* (CRU_PB4DIV) Divide by 1 PB4 Clock same frequency as sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV2                 (CRU_PB4DIV_PBDIV_DIV2_Val << CRU_PB4DIV_PBDIV_Pos)  /* (CRU_PB4DIV) Divide by 2 PB4 Clock is 1/2 of sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV3                 (CRU_PB4DIV_PBDIV_DIV3_Val << CRU_PB4DIV_PBDIV_Pos)  /* (CRU_PB4DIV) Divide by 3 PB4 Clock is 1/3 of sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV16                (CRU_PB4DIV_PBDIV_DIV16_Val << CRU_PB4DIV_PBDIV_Pos) /* (CRU_PB4DIV) Divide by 16 PB4 Clock is 1/16 of sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV17                (CRU_PB4DIV_PBDIV_DIV17_Val << CRU_PB4DIV_PBDIV_Pos) /* (CRU_PB4DIV) Divide by 17 PB4 Clock is 1/17 of sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV127               (CRU_PB4DIV_PBDIV_DIV127_Val << CRU_PB4DIV_PBDIV_Pos) /* (CRU_PB4DIV) Divide by 127 PB4 Clock is 1/127 of sys_clk Position  */
#define CRU_PB4DIV_PBDIV_DIV128               (CRU_PB4DIV_PBDIV_DIV128_Val << CRU_PB4DIV_PBDIV_Pos) /* (CRU_PB4DIV) Divide by 128 PB4 Clock is 1/128 of sys_clk Position  */
#define CRU_PB4DIV_PBDIVRDY_Pos               _UINT32_(11)                                         /* (CRU_PB4DIV) PB4 Peripheral Clock Divisor Ready Position */
#define CRU_PB4DIV_PBDIVRDY_Msk               (_UINT32_(0x1) << CRU_PB4DIV_PBDIVRDY_Pos)           /* (CRU_PB4DIV) PB4 Peripheral Clock Divisor Ready Mask */
#define CRU_PB4DIV_PBDIVRDY(value)            (CRU_PB4DIV_PBDIVRDY_Msk & (_UINT32_(value) << CRU_PB4DIV_PBDIVRDY_Pos)) /* Assigment of value for PBDIVRDY in the CRU_PB4DIV register */
#define   CRU_PB4DIV_PBDIVRDY_PB4RDY_Val      _UINT32_(0x1)                                        /* (CRU_PB4DIV) Indicates the PB clock divisor logic is not switching divisors and the PB4DIV may be written.  */
#define   CRU_PB4DIV_PBDIVRDY_NOT_PB4RDY_Val  _UINT32_(0x0)                                        /* (CRU_PB4DIV) Indicates the PB clock divisor logic is currently switching values and the PB4DIV cannot be written.  */
#define CRU_PB4DIV_PBDIVRDY_PB4RDY            (CRU_PB4DIV_PBDIVRDY_PB4RDY_Val << CRU_PB4DIV_PBDIVRDY_Pos) /* (CRU_PB4DIV) Indicates the PB clock divisor logic is not switching divisors and the PB4DIV may be written. Position  */
#define CRU_PB4DIV_PBDIVRDY_NOT_PB4RDY        (CRU_PB4DIV_PBDIVRDY_NOT_PB4RDY_Val << CRU_PB4DIV_PBDIVRDY_Pos) /* (CRU_PB4DIV) Indicates the PB clock divisor logic is currently switching values and the PB4DIV cannot be written. Position  */
#define CRU_PB4DIV_PBDIVON_Pos                _UINT32_(15)                                         /* (CRU_PB4DIV) Output Enable bit Position */
#define CRU_PB4DIV_PBDIVON_Msk                (_UINT32_(0x1) << CRU_PB4DIV_PBDIVON_Pos)            /* (CRU_PB4DIV) Output Enable bit Mask */
#define CRU_PB4DIV_PBDIVON(value)             (CRU_PB4DIV_PBDIVON_Msk & (_UINT32_(value) << CRU_PB4DIV_PBDIVON_Pos)) /* Assigment of value for PBDIVON in the CRU_PB4DIV register */
#define   CRU_PB4DIV_PBDIVON_PB4ON_Val        _UINT32_(0x1)                                        /* (CRU_PB4DIV) PB4 Output clock is enabled  */
#define   CRU_PB4DIV_PBDIVON_PB4OFF_Val       _UINT32_(0x0)                                        /* (CRU_PB4DIV) PB4 Output clock is disabled  */
#define CRU_PB4DIV_PBDIVON_PB4ON              (CRU_PB4DIV_PBDIVON_PB4ON_Val << CRU_PB4DIV_PBDIVON_Pos) /* (CRU_PB4DIV) PB4 Output clock is enabled Position  */
#define CRU_PB4DIV_PBDIVON_PB4OFF             (CRU_PB4DIV_PBDIVON_PB4OFF_Val << CRU_PB4DIV_PBDIVON_Pos) /* (CRU_PB4DIV) PB4 Output clock is disabled Position  */
#define CRU_PB4DIV_Msk                        _UINT32_(0x0000887F)                                 /* (CRU_PB4DIV) Register Mask  */


/* -------- CRU_PB4DIVCLR : (CRU Offset: 0x194) (R/W 32)  -------- */
#define CRU_PB4DIVCLR_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB4DIVCLR)   Reset Value */

#define CRU_PB4DIVCLR_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB4DIVCLR) Register Mask  */


/* -------- CRU_PB4DIVSET : (CRU Offset: 0x198) (R/W 32)  -------- */
#define CRU_PB4DIVSET_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB4DIVSET)   Reset Value */

#define CRU_PB4DIVSET_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB4DIVSET) Register Mask  */


/* -------- CRU_PB4DIVINV : (CRU Offset: 0x19C) (R/W 32)  -------- */
#define CRU_PB4DIVINV_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB4DIVINV)   Reset Value */

#define CRU_PB4DIVINV_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB4DIVINV) Register Mask  */


/* -------- CRU_PB5DIV : (CRU Offset: 0x1A0) (R/W 32) PB5 CLOCK DIVISOR CONTROL REGISTER -------- */
#define CRU_PB5DIV_RESETVALUE                 _UINT32_(0x8801)                                     /*  (CRU_PB5DIV) PB5 CLOCK DIVISOR CONTROL REGISTER  Reset Value */

#define CRU_PB5DIV_PBDIV_Pos                  _UINT32_(0)                                          /* (CRU_PB5DIV) PB5 Peripheral Clock Divisor Control value Position */
#define CRU_PB5DIV_PBDIV_Msk                  (_UINT32_(0x7F) << CRU_PB5DIV_PBDIV_Pos)             /* (CRU_PB5DIV) PB5 Peripheral Clock Divisor Control value Mask */
#define CRU_PB5DIV_PBDIV(value)               (CRU_PB5DIV_PBDIV_Msk & (_UINT32_(value) << CRU_PB5DIV_PBDIV_Pos)) /* Assigment of value for PBDIV in the CRU_PB5DIV register */
#define   CRU_PB5DIV_PBDIV_DIV1_Val           _UINT32_(0x0)                                        /* (CRU_PB5DIV) Divide by 1 PB5 Clock same frequency as sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV2_Val           _UINT32_(0x1)                                        /* (CRU_PB5DIV) Divide by 2 PB5 Clock is 1/2 of sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV3_Val           _UINT32_(0x2)                                        /* (CRU_PB5DIV) Divide by 3 PB5 Clock is 1/3 of sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV16_Val          _UINT32_(0xF)                                        /* (CRU_PB5DIV) Divide by 16 PB5 Clock is 1/16 of sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV17_Val          _UINT32_(0x10)                                       /* (CRU_PB5DIV) Divide by 17 PB5 Clock is 1/17 of sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV127_Val         _UINT32_(0x7E)                                       /* (CRU_PB5DIV) Divide by 127 PB5 Clock is 1/127 of sys_clk  */
#define   CRU_PB5DIV_PBDIV_DIV128_Val         _UINT32_(0x7F)                                       /* (CRU_PB5DIV) Divide by 128 PB5 Clock is 1/128 of sys_clk  */
#define CRU_PB5DIV_PBDIV_DIV1                 (CRU_PB5DIV_PBDIV_DIV1_Val << CRU_PB5DIV_PBDIV_Pos)  /* (CRU_PB5DIV) Divide by 1 PB5 Clock same frequency as sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV2                 (CRU_PB5DIV_PBDIV_DIV2_Val << CRU_PB5DIV_PBDIV_Pos)  /* (CRU_PB5DIV) Divide by 2 PB5 Clock is 1/2 of sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV3                 (CRU_PB5DIV_PBDIV_DIV3_Val << CRU_PB5DIV_PBDIV_Pos)  /* (CRU_PB5DIV) Divide by 3 PB5 Clock is 1/3 of sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV16                (CRU_PB5DIV_PBDIV_DIV16_Val << CRU_PB5DIV_PBDIV_Pos) /* (CRU_PB5DIV) Divide by 16 PB5 Clock is 1/16 of sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV17                (CRU_PB5DIV_PBDIV_DIV17_Val << CRU_PB5DIV_PBDIV_Pos) /* (CRU_PB5DIV) Divide by 17 PB5 Clock is 1/17 of sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV127               (CRU_PB5DIV_PBDIV_DIV127_Val << CRU_PB5DIV_PBDIV_Pos) /* (CRU_PB5DIV) Divide by 127 PB5 Clock is 1/127 of sys_clk Position  */
#define CRU_PB5DIV_PBDIV_DIV128               (CRU_PB5DIV_PBDIV_DIV128_Val << CRU_PB5DIV_PBDIV_Pos) /* (CRU_PB5DIV) Divide by 128 PB5 Clock is 1/128 of sys_clk Position  */
#define CRU_PB5DIV_PBDIVRDY_Pos               _UINT32_(11)                                         /* (CRU_PB5DIV) PB5 Peripheral Clock Divisor Ready Position */
#define CRU_PB5DIV_PBDIVRDY_Msk               (_UINT32_(0x1) << CRU_PB5DIV_PBDIVRDY_Pos)           /* (CRU_PB5DIV) PB5 Peripheral Clock Divisor Ready Mask */
#define CRU_PB5DIV_PBDIVRDY(value)            (CRU_PB5DIV_PBDIVRDY_Msk & (_UINT32_(value) << CRU_PB5DIV_PBDIVRDY_Pos)) /* Assigment of value for PBDIVRDY in the CRU_PB5DIV register */
#define   CRU_PB5DIV_PBDIVRDY_PB5RDY_Val      _UINT32_(0x1)                                        /* (CRU_PB5DIV) Indicates the PB clock divisor logic is not switching divisors and the PB5DIV may be written.  */
#define   CRU_PB5DIV_PBDIVRDY_NOT_PB5RDY_Val  _UINT32_(0x0)                                        /* (CRU_PB5DIV) Indicates the PB clock divisor logic is currently switching values and the PB5DIV cannot be written.  */
#define CRU_PB5DIV_PBDIVRDY_PB5RDY            (CRU_PB5DIV_PBDIVRDY_PB5RDY_Val << CRU_PB5DIV_PBDIVRDY_Pos) /* (CRU_PB5DIV) Indicates the PB clock divisor logic is not switching divisors and the PB5DIV may be written. Position  */
#define CRU_PB5DIV_PBDIVRDY_NOT_PB5RDY        (CRU_PB5DIV_PBDIVRDY_NOT_PB5RDY_Val << CRU_PB5DIV_PBDIVRDY_Pos) /* (CRU_PB5DIV) Indicates the PB clock divisor logic is currently switching values and the PB5DIV cannot be written. Position  */
#define CRU_PB5DIV_PBDIVON_Pos                _UINT32_(15)                                         /* (CRU_PB5DIV) Output Enable bit Position */
#define CRU_PB5DIV_PBDIVON_Msk                (_UINT32_(0x1) << CRU_PB5DIV_PBDIVON_Pos)            /* (CRU_PB5DIV) Output Enable bit Mask */
#define CRU_PB5DIV_PBDIVON(value)             (CRU_PB5DIV_PBDIVON_Msk & (_UINT32_(value) << CRU_PB5DIV_PBDIVON_Pos)) /* Assigment of value for PBDIVON in the CRU_PB5DIV register */
#define   CRU_PB5DIV_PBDIVON_PB5ON_Val        _UINT32_(0x1)                                        /* (CRU_PB5DIV) PB5 Output clock is enabled  */
#define   CRU_PB5DIV_PBDIVON_PB5OFF_Val       _UINT32_(0x0)                                        /* (CRU_PB5DIV) PB5 Output clock is disabled  */
#define CRU_PB5DIV_PBDIVON_PB5ON              (CRU_PB5DIV_PBDIVON_PB5ON_Val << CRU_PB5DIV_PBDIVON_Pos) /* (CRU_PB5DIV) PB5 Output clock is enabled Position  */
#define CRU_PB5DIV_PBDIVON_PB5OFF             (CRU_PB5DIV_PBDIVON_PB5OFF_Val << CRU_PB5DIV_PBDIVON_Pos) /* (CRU_PB5DIV) PB5 Output clock is disabled Position  */
#define CRU_PB5DIV_Msk                        _UINT32_(0x0000887F)                                 /* (CRU_PB5DIV) Register Mask  */


/* -------- CRU_PB5DIVCLR : (CRU Offset: 0x1A4) (R/W 32)  -------- */
#define CRU_PB5DIVCLR_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB5DIVCLR)   Reset Value */

#define CRU_PB5DIVCLR_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB5DIVCLR) Register Mask  */


/* -------- CRU_PB5DIVSET : (CRU Offset: 0x1A8) (R/W 32)  -------- */
#define CRU_PB5DIVSET_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB5DIVSET)   Reset Value */

#define CRU_PB5DIVSET_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB5DIVSET) Register Mask  */


/* -------- CRU_PB5DIVINV : (CRU Offset: 0x1AC) (R/W 32)  -------- */
#define CRU_PB5DIVINV_RESETVALUE              _UINT32_(0x00)                                       /*  (CRU_PB5DIVINV)   Reset Value */

#define CRU_PB5DIVINV_Msk                     _UINT32_(0x00000000)                                 /* (CRU_PB5DIVINV) Register Mask  */


/* -------- CRU_SLEWCON : (CRU Offset: 0x1B0) (R/W 32) SLEW RATE CONTROL FOR CLOCK SWITCHING REGISTER -------- */
...
/* -------- CRU_SLEWCONCLR : (CRU Offset: 0x1B4) (R/W 32)  -------- */
...
/* -------- CRU_SLEWCONSET : (CRU Offset: 0x1B8) (R/W 32)  -------- */
...
/* -------- CRU_SLEWCONINV : (CRU Offset: 0x1BC) (R/W 32)  -------- */
...
/* -------- CRU_CLKSTAT : (CRU Offset: 0x1C0) (R/W 32) CLOCK STATUS REGISTER -------- */
...
#define CRU_CLKSTAT_EPLL2RDY_Pos              _UINT32_(5)                                          /* (CRU_CLKSTAT) Ethernet PLL2 Ready Status value Position */
#define CRU_CLKSTAT_EPLL2RDY_Msk              (_UINT32_(0x1) << CRU_CLKSTAT_EPLL2RDY_Pos)          /* (CRU_CLKSTAT) Ethernet PLL2 Ready Status value Mask */
#define CRU_CLKSTAT_EPLL2RDY(value)           (CRU_CLKSTAT_EPLL2RDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_EPLL2RDY_Pos)) /* Assigment of value for EPLL2RDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_EPLL2RDY_NOTRDY_Val     _UINT32_(0x0)                                        /* (CRU_CLKSTAT) EPLL2 is not stable and not ready  */
#define   CRU_CLKSTAT_EPLL2RDY_RDY_Val        _UINT32_(0x1)                                        /* (CRU_CLKSTAT) EPLL2 is stable and ready  */
#define CRU_CLKSTAT_EPLL2RDY_NOTRDY           (CRU_CLKSTAT_EPLL2RDY_NOTRDY_Val << CRU_CLKSTAT_EPLL2RDY_Pos) /* (CRU_CLKSTAT) EPLL2 is not stable and not ready Position  */
#define CRU_CLKSTAT_EPLL2RDY_RDY              (CRU_CLKSTAT_EPLL2RDY_RDY_Val << CRU_CLKSTAT_EPLL2RDY_Pos) /* (CRU_CLKSTAT) EPLL2 is stable and ready Position  */
#define CRU_CLKSTAT_UPLLRDY_Pos               _UINT32_(6)                                          /* (CRU_CLKSTAT) USB PLL Ready Status value Position */
#define CRU_CLKSTAT_UPLLRDY_Msk               (_UINT32_(0x1) << CRU_CLKSTAT_UPLLRDY_Pos)           /* (CRU_CLKSTAT) USB PLL Ready Status value Mask */
#define CRU_CLKSTAT_UPLLRDY(value)            (CRU_CLKSTAT_UPLLRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_UPLLRDY_Pos)) /* Assigment of value for UPLLRDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_UPLLRDY_NOTRDY_Val      _UINT32_(0x0)                                        /* (CRU_CLKSTAT) UPLL is not stable and not ready  */
#define   CRU_CLKSTAT_UPLLRDY_RDY_Val         _UINT32_(0x1)                                        /* (CRU_CLKSTAT) UPLL is stable and ready  */
#define CRU_CLKSTAT_UPLLRDY_NOTRDY            (CRU_CLKSTAT_UPLLRDY_NOTRDY_Val << CRU_CLKSTAT_UPLLRDY_Pos) /* (CRU_CLKSTAT) UPLL is not stable and not ready Position  */
#define CRU_CLKSTAT_UPLLRDY_RDY               (CRU_CLKSTAT_UPLLRDY_RDY_Val << CRU_CLKSTAT_UPLLRDY_Pos) /* (CRU_CLKSTAT) UPLL is stable and ready Position  */
#define CRU_CLKSTAT_SPLLRDY_Pos               _UINT32_(7)                                          /* (CRU_CLKSTAT) System PLL Ready Status value Position */
#define CRU_CLKSTAT_SPLLRDY_Msk               (_UINT32_(0x1) << CRU_CLKSTAT_SPLLRDY_Pos)           /* (CRU_CLKSTAT) System PLL Ready Status value Mask */
#define CRU_CLKSTAT_SPLLRDY(value)            (CRU_CLKSTAT_SPLLRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_SPLLRDY_Pos)) /* Assigment of value for SPLLRDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_SPLLRDY_NOTRDY_Val      _UINT32_(0x0)                                        /* (CRU_CLKSTAT) SPLL is not stable and not ready  */
#define   CRU_CLKSTAT_SPLLRDY_RDY_Val         _UINT32_(0x1)                                        /* (CRU_CLKSTAT) SPLL is stable and ready  */
#define CRU_CLKSTAT_SPLLRDY_NOTRDY            (CRU_CLKSTAT_SPLLRDY_NOTRDY_Val << CRU_CLKSTAT_SPLLRDY_Pos) /* (CRU_CLKSTAT) SPLL is not stable and not ready Position  */
#define CRU_CLKSTAT_SPLLRDY_RDY               (CRU_CLKSTAT_SPLLRDY_RDY_Val << CRU_CLKSTAT_SPLLRDY_Pos) /* (CRU_CLKSTAT) SPLL is stable and ready Position  */
#define CRU_CLKSTAT_EPLL1RDY_Pos              _UINT32_(8)                                          /* (CRU_CLKSTAT) Ethernet PLL1 Ready Status value Position */
#define CRU_CLKSTAT_EPLL1RDY_Msk              (_UINT32_(0x1) << CRU_CLKSTAT_EPLL1RDY_Pos)          /* (CRU_CLKSTAT) Ethernet PLL1 Ready Status value Mask */
#define CRU_CLKSTAT_EPLL1RDY(value)           (CRU_CLKSTAT_EPLL1RDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_EPLL1RDY_Pos)) /* Assigment of value for EPLL1RDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_EPLL1RDY_NOTRDY_Val     _UINT32_(0x0)                                        /* (CRU_CLKSTAT) EPLL1 is not stable and not ready  */
#define   CRU_CLKSTAT_EPLL1RDY_RDY_Val        _UINT32_(0x1)                                        /* (CRU_CLKSTAT) EPLL1 is stable and ready  */
#define CRU_CLKSTAT_EPLL1RDY_NOTRDY           (CRU_CLKSTAT_EPLL1RDY_NOTRDY_Val << CRU_CLKSTAT_EPLL1RDY_Pos) /* (CRU_CLKSTAT) EPLL1 is not stable and not ready Position  */
#define CRU_CLKSTAT_EPLL1RDY_RDY              (CRU_CLKSTAT_EPLL1RDY_RDY_Val << CRU_CLKSTAT_EPLL1RDY_Pos) /* (CRU_CLKSTAT) EPLL1 is stable and ready Position  */
#define CRU_CLKSTAT_SYSRDY_Pos                _UINT32_(9)                                          /* (CRU_CLKSTAT) System Clock Ready Status value Position */
#define CRU_CLKSTAT_SYSRDY_Msk                (_UINT32_(0x1) << CRU_CLKSTAT_SYSRDY_Pos)            /* (CRU_CLKSTAT) System Clock Ready Status value Mask */
#define CRU_CLKSTAT_SYSRDY(value)             (CRU_CLKSTAT_SYSRDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_SYSRDY_Pos)) /* Assigment of value for SYSRDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_SYSRDY_NOTRDY_Val       _UINT32_(0x0)                                        /* (CRU_CLKSTAT) System clock is not stable and not ready  */
#define   CRU_CLKSTAT_SYSRDY_RDY_Val          _UINT32_(0x1)                                        /* (CRU_CLKSTAT) System clock is stable and ready  */
#define CRU_CLKSTAT_SYSRDY_NOTRDY             (CRU_CLKSTAT_SYSRDY_NOTRDY_Val << CRU_CLKSTAT_SYSRDY_Pos) /* (CRU_CLKSTAT) System clock is not stable and not ready Position  */
#define CRU_CLKSTAT_SYSRDY_RDY                (CRU_CLKSTAT_SYSRDY_RDY_Val << CRU_CLKSTAT_SYSRDY_Pos) /* (CRU_CLKSTAT) System clock is stable and ready Position  */
#define CRU_CLKSTAT_PB1RDY_Pos                _UINT32_(10)                                         /* (CRU_CLKSTAT) PB1 Clock Ready Status value  Position */
#define CRU_CLKSTAT_PB1RDY_Msk                (_UINT32_(0x1) << CRU_CLKSTAT_PB1RDY_Pos)            /* (CRU_CLKSTAT) PB1 Clock Ready Status value  Mask */
#define CRU_CLKSTAT_PB1RDY(value)             (CRU_CLKSTAT_PB1RDY_Msk & (_UINT32_(value) << CRU_CLKSTAT_PB1RDY_Pos)) /* Assigment of value for PB1RDY in the CRU_CLKSTAT register */
#define   CRU_CLKSTAT_PB1RDY_NOTRDY_Val       _UINT32_(0x0)                                        /* (CRU_CLKSTAT) PB1 clock is not stable and not ready  */
#define   CRU_CLKSTAT_PB1RDY_RDY_Val          _UINT32_(0x1)                                        /* (CRU_CLKSTAT) PB1 clock is stable and ready  */
#define CRU_CLKSTAT_PB1RDY_NOTRDY             (CRU_CLKSTAT_PB1RDY_NOTRDY_Val << CRU_CLKSTAT_PB1RDY_Pos) /* (CRU_CLKSTAT) PB1 clock is not stable and not ready Position  */
#define CRU_CLKSTAT_PB1RDY_RDY                (CRU_CLKSTAT_PB1RDY_RDY_Val << CRU_CLKSTAT_PB1RDY_Pos) /* (CRU_CLKSTAT) PB1 clock is stable and ready Position  */
#define CRU_CLKSTAT_Msk                       _UINT32_(0x000007FF)                                 /* (CRU_CLKSTAT) Register Mask  */


/* -------- CRU_CLKSTATCLR : (CRU Offset: 0x1C4) (R/W 32)  -------- */
#define CRU_CLKSTATCLR_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKSTATCLR)   Reset Value */

#define CRU_CLKSTATCLR_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKSTATCLR) Register Mask  */


/* -------- CRU_CLKSTATSET : (CRU Offset: 0x1C8) (R/W 32)  -------- */
#define CRU_CLKSTATSET_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKSTATSET)   Reset Value */

#define CRU_CLKSTATSET_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKSTATSET) Register Mask  */


/* -------- CRU_CLKSTATINV : (CRU Offset: 0x1CC) (R/W 32)  -------- */
#define CRU_CLKSTATINV_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKSTATINV)   Reset Value */

#define CRU_CLKSTATINV_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKSTATINV) Register Mask  */


/* -------- CRU_CLKDIAG : (CRU Offset: 0x1E0) (R/W 32) USER CLK DIAGNOSTICS CONTROL REGISTER -------- */
...
#define CRU_CLKDIAG_EPLLSTOP_Pos              _UINT32_(5)                                          /* (CRU_CLKDIAG) EPLL Clock Stop Control value Position */
#define CRU_CLKDIAG_EPLLSTOP_Msk              (_UINT32_(0x1) << CRU_CLKDIAG_EPLLSTOP_Pos)          /* (CRU_CLKDIAG) EPLL Clock Stop Control value Mask */
#define CRU_CLKDIAG_EPLLSTOP(value)           (CRU_CLKDIAG_EPLLSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_EPLLSTOP_Pos)) /* Assigment of value for EPLLSTOP in the CRU_CLKDIAG register */
#define   CRU_CLKDIAG_EPLLSTOP_NORM_Val       _UINT32_(0x0)                                        /* (CRU_CLKDIAG) EPLL clock source runs as normal  */
#define   CRU_CLKDIAG_EPLLSTOP_STOP_Val       _UINT32_(0x1)                                        /* (CRU_CLKDIAG) EPLL clock source is stopped  */
#define CRU_CLKDIAG_EPLLSTOP_NORM             (CRU_CLKDIAG_EPLLSTOP_NORM_Val << CRU_CLKDIAG_EPLLSTOP_Pos) /* (CRU_CLKDIAG) EPLL clock source runs as normal Position  */
#define CRU_CLKDIAG_EPLLSTOP_STOP             (CRU_CLKDIAG_EPLLSTOP_STOP_Val << CRU_CLKDIAG_EPLLSTOP_Pos) /* (CRU_CLKDIAG) EPLL clock source is stopped Position  */
#define CRU_CLKDIAG_UPLLSTOP_Pos              _UINT32_(6)                                          /* (CRU_CLKDIAG) UPLL Clock Stop Control value Position */
#define CRU_CLKDIAG_UPLLSTOP_Msk              (_UINT32_(0x1) << CRU_CLKDIAG_UPLLSTOP_Pos)          /* (CRU_CLKDIAG) UPLL Clock Stop Control value Mask */
#define CRU_CLKDIAG_UPLLSTOP(value)           (CRU_CLKDIAG_UPLLSTOP_Msk & (_UINT32_(value) << CRU_CLKDIAG_UPLLSTOP_Pos)) /* Assigment of value for UPLLSTOP in the CRU_CLKDIAG register */
#define   CRU_CLKDIAG_UPLLSTOP_NORM_Val       _UINT32_(0x0)                                        /* (CRU_CLKDIAG) UPLL clock source runs as normal  */
#define   CRU_CLKDIAG_UPLLSTOP_STOP_Val       _UINT32_(0x1)                                        /* (CRU_CLKDIAG) UPLL clock source is stopped  */
#define CRU_CLKDIAG_UPLLSTOP_NORM             (CRU_CLKDIAG_UPLLSTOP_NORM_Val << CRU_CLKDIAG_UPLLSTOP_Pos) /* (CRU_CLKDIAG) UPLL clock source runs as normal Position  */
#define CRU_CLKDIAG_UPLLSTOP_STOP             (CRU_CLKDIAG_UPLLSTOP_STOP_Val << CRU_CLKDIAG_UPLLSTOP_Pos) /* (CRU_CLKDIAG) UPLL clock source is stopped Position  */
...
/* -------- CRU_CLKDIAGCLR : (CRU Offset: 0x1E4) (R/W 32)  -------- */
#define CRU_CLKDIAGCLR_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKDIAGCLR)   Reset Value */

#define CRU_CLKDIAGCLR_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKDIAGCLR) Register Mask  */


/* -------- CRU_CLKDIAGSET : (CRU Offset: 0x1E8) (R/W 32)  -------- */
#define CRU_CLKDIAGSET_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKDIAGSET)   Reset Value */

#define CRU_CLKDIAGSET_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKDIAGSET) Register Mask  */


/* -------- CRU_CLKDIAGINV : (CRU Offset: 0x1EC) (R/W 32)  -------- */
#define CRU_CLKDIAGINV_RESETVALUE             _UINT32_(0x00)                                       /*  (CRU_CLKDIAGINV)   Reset Value */

#define CRU_CLKDIAGINV_Msk                    _UINT32_(0x00000000)                                 /* (CRU_CLKDIAGINV) Register Mask  */
...
#define CRU_UPLLCON_REG_OFST           _UINT32_(0x30)      /* (CRU_UPLLCON) UPLL CONTROL REGISTER Offset */
#define CRU_UPLLCONCLR_REG_OFST        _UINT32_(0x34)      /* (CRU_UPLLCONCLR)  Offset */
#define CRU_UPLLCONSET_REG_OFST        _UINT32_(0x38)      /* (CRU_UPLLCONSET)  Offset */
#define CRU_UPLLCONINV_REG_OFST        _UINT32_(0x3C)      /* (CRU_UPLLCONINV)  Offset */
#define CRU_EPLLCON_REG_OFST           _UINT32_(0x40)      /* (CRU_EPLLCON) EPLL CONTROL REGISTER Offset */
#define CRU_EPLLCONCLR_REG_OFST        _UINT32_(0x44)      /* (CRU_EPLLCONCLR)  Offset */
#define CRU_EPLLCONSET_REG_OFST        _UINT32_(0x48)      /* (CRU_EPLLCONSET)  Offset */
#define CRU_EPLLCONINV_REG_OFST        _UINT32_(0x4C)      /* (CRU_EPLLCONINV)  Offset */
#define CRU_APLLCON_REG_OFST           _UINT32_(0x50)      /* (CRU_APLLCON) APLL CONTROL REGISTER Offset */
#define CRU_APLLCONCLR_REG_OFST        _UINT32_(0x54)      /* (CRU_APLLCONCLR)  Offset */
#define CRU_APLLCONSET_REG_OFST        _UINT32_(0x58)      /* (CRU_APLLCONSET)  Offset */
#define CRU_APLLCONINV_REG_OFST        _UINT32_(0x5C)      /* (CRU_APLLCONINV)  Offset */
#define CRU_REFO1CON_REG_OFST          _UINT32_(0xA0)      /* (CRU_REFO1CON) REFERENCE OSCILLATOR 1 CONTROL REGISTER Offset */
#define CRU_REFO1CONCLR_REG_OFST       _UINT32_(0xA4)      /* (CRU_REFO1CONCLR)  Offset */
#define CRU_REFO1CONSET_REG_OFST       _UINT32_(0xA8)      /* (CRU_REFO1CONSET)  Offset */
#define CRU_REFO1CONINV_REG_OFST       _UINT32_(0xAC)      /* (CRU_REFO1CONINV)  Offset */
#define CRU_REFO1TRIM_REG_OFST         _UINT32_(0xB0)      /* (CRU_REFO1TRIM) REFERENCE OSCILLATOR 1 TRIM REGISTER Offset */
#define CRU_REFO1TRIMCLR_REG_OFST      _UINT32_(0xB4)      /* (CRU_REFO1TRIMCLR)  Offset */
#define CRU_REFO1TRIMSET_REG_OFST      _UINT32_(0xB8)      /* (CRU_REFO1TRIMSET)  Offset */
#define CRU_REFO1TRIMINV_REG_OFST      _UINT32_(0xBC)      /* (CRU_REFO1TRIMINV)  Offset */
#define CRU_REFO2CON_REG_OFST          _UINT32_(0xC0)      /* (CRU_REFO2CON) REFERENCE OSCILLATOR 2 CONTROL REGISTER Offset */
#define CRU_REFO2CONCLR_REG_OFST       _UINT32_(0xC4)      /* (CRU_REFO2CONCLR)  Offset */
#define CRU_REFO2CONSET_REG_OFST       _UINT32_(0xC8)      /* (CRU_REFO2CONSET)  Offset */
#define CRU_REFO2CONINV_REG_OFST       _UINT32_(0xCC)      /* (CRU_REFO2CONINV)  Offset */
#define CRU_REFO2TRIM_REG_OFST         _UINT32_(0xD0)      /* (CRU_REFO2TRIM) REFERENCE OSCILLATOR 2 TRIM REGISTER Offset */
#define CRU_REFO2TRIMCLR_REG_OFST      _UINT32_(0xD4)      /* (CRU_REFO2TRIMCLR)  Offset */
#define CRU_REFO2TRIMSET_REG_OFST      _UINT32_(0xD8)      /* (CRU_REFO2TRIMSET)  Offset */
#define CRU_REFO2TRIMINV_REG_OFST      _UINT32_(0xDC)      /* (CRU_REFO2TRIMINV)  Offset */
#define CRU_REFO3CON_REG_OFST          _UINT32_(0xE0)      /* (CRU_REFO3CON) REFERENCE OSCILLATOR 3 CONTROL REGISTER Offset */
#define CRU_REFO3CONCLR_REG_OFST       _UINT32_(0xE4)      /* (CRU_REFO3CONCLR)  Offset */
#define CRU_REFO3CONSET_REG_OFST       _UINT32_(0xE8)      /* (CRU_REFO3CONSET)  Offset */
#define CRU_REFO3CONINV_REG_OFST       _UINT32_(0xEC)      /* (CRU_REFO3CONINV)  Offset */
#define CRU_REFO3TRIM_REG_OFST         _UINT32_(0xF0)      /* (CRU_REFO3TRIM) REFERENCE OSCILLATOR 3 TRIM REGISTER Offset */
#define CRU_REFO3TRIMCLR_REG_OFST      _UINT32_(0xF4)      /* (CRU_REFO3TRIMCLR)  Offset */
#define CRU_REFO3TRIMSET_REG_OFST      _UINT32_(0xF8)      /* (CRU_REFO3TRIMSET)  Offset */
#define CRU_REFO3TRIMINV_REG_OFST      _UINT32_(0xFC)      /* (CRU_REFO3TRIMINV)  Offset */
#define CRU_REFO4CON_REG_OFST          _UINT32_(0x100)     /* (CRU_REFO4CON) REFERENCE OSCILLATOR 4 CONTROL REGISTER Offset */
#define CRU_REFO4CONCLR_REG_OFST       _UINT32_(0x104)     /* (CRU_REFO4CONCLR)  Offset */
#define CRU_REFO4CONSET_REG_OFST       _UINT32_(0x108)     /* (CRU_REFO4CONSET)  Offset */
#define CRU_REFO4CONINV_REG_OFST       _UINT32_(0x10C)     /* (CRU_REFO4CONINV)  Offset */
#define CRU_REFO4TRIM_REG_OFST         _UINT32_(0x110)     /* (CRU_REFO4TRIM) REFERENCE OSCILLATOR 4 TRIM REGISTER Offset */
#define CRU_REFO4TRIMCLR_REG_OFST      _UINT32_(0x114)     /* (CRU_REFO4TRIMCLR)  Offset */
#define CRU_REFO4TRIMSET_REG_OFST      _UINT32_(0x118)     /* (CRU_REFO4TRIMSET)  Offset */
#define CRU_REFO4TRIMINV_REG_OFST      _UINT32_(0x11C)     /* (CRU_REFO4TRIMINV)  Offset */
#define CRU_REFO5CON_REG_OFST          _UINT32_(0x120)     /* (CRU_REFO5CON) REFERENCE OSCILLATOR 5 CONTROL REGISTER Offset */
#define CRU_REFO5CONCLR_REG_OFST       _UINT32_(0x124)     /* (CRU_REFO5CONCLR)  Offset */
#define CRU_REFO5CONSET_REG_OFST       _UINT32_(0x128)     /* (CRU_REFO5CONSET)  Offset */
#define CRU_REFO5CONINV_REG_OFST       _UINT32_(0x12C)     /* (CRU_REFO5CONINV)  Offset */
#define CRU_REFO5TRIM_REG_OFST         _UINT32_(0x130)     /* (CRU_REFO5TRIM) REFERENCE OSCILLATOR 5 TRIM REGISTER Offset */
#define CRU_REFO5TRIMCLR_REG_OFST      _UINT32_(0x134)     /* (CRU_REFO5TRIMCLR)  Offset */
#define CRU_REFO5TRIMSET_REG_OFST      _UINT32_(0x138)     /* (CRU_REFO5TRIMSET)  Offset */
#define CRU_REFO5TRIMINV_REG_OFST      _UINT32_(0x13C)     /* (CRU_REFO5TRIMINV)  Offset */
#define CRU_REFO6CON_REG_OFST          _UINT32_(0x140)     /* (CRU_REFO6CON) REFERENCE OSCILLATOR 6 CONTROL REGISTER Offset */
#define CRU_REFO6CONCLR_REG_OFST       _UINT32_(0x144)     /* (CRU_REFO6CONCLR)  Offset */
#define CRU_REFO6CONSET_REG_OFST       _UINT32_(0x148)     /* (CRU_REFO6CONSET)  Offset */
#define CRU_REFO6CONINV_REG_OFST       _UINT32_(0x14C)     /* (CRU_REFO6CONINV)  Offset */
#define CRU_REFO6TRIM_REG_OFST         _UINT32_(0x150)     /* (CRU_REFO6TRIM) REFERENCE OSCILLATOR 6 TRIM REGISTER Offset */
#define CRU_REFO6TRIMCLR_REG_OFST      _UINT32_(0x154)     /* (CRU_REFO6TRIMCLR)  Offset */
#define CRU_REFO6TRIMSET_REG_OFST      _UINT32_(0x158)     /* (CRU_REFO6TRIMSET)  Offset */
#define CRU_REFO6TRIMINV_REG_OFST      _UINT32_(0x15C)     /* (CRU_REFO6TRIMINV)  Offset */
#define CRU_PB1DIV_REG_OFST            _UINT32_(0x160)     /* (CRU_PB1DIV) PB1 CLOCK DIVISOR CONTROL REGISTER Offset */
#define CRU_PB1DIVCLR_REG_OFST         _UINT32_(0x164)     /* (CRU_PB1DIVCLR)  Offset */
#define CRU_PB1DIVSET_REG_OFST         _UINT32_(0x168)     /* (CRU_PB1DIVSET)  Offset */
#define CRU_PB1DIVINV_REG_OFST         _UINT32_(0x16C)     /* (CRU_PB1DIVINV)  Offset */
#define CRU_PB2DIV_REG_OFST            _UINT32_(0x170)     /* (CRU_PB2DIV) PB2 CLOCK DIVISOR CONTROL REGISTER Offset */
#define CRU_PB2DIVCLR_REG_OFST         _UINT32_(0x174)     /* (CRU_PB2DIVCLR)  Offset */
#define CRU_PB2DIVSET_REG_OFST         _UINT32_(0x178)     /* (CRU_PB2DIVSET)  Offset */
#define CRU_PB2DIVINV_REG_OFST         _UINT32_(0x17C)     /* (CRU_PB2DIVINV)  Offset */
#define CRU_PB3DIV_REG_OFST            _UINT32_(0x180)     /* (CRU_PB3DIV) PB3 CLOCK DIVISOR CONTROL REGISTER Offset */
#define CRU_PB3DIVCLR_REG_OFST         _UINT32_(0x184)     /* (CRU_PB3DIVCLR)  Offset */
#define CRU_PB3DIVSET_REG_OFST         _UINT32_(0x188)     /* (CRU_PB3DIVSET)  Offset */
#define CRU_PB3DIVINV_REG_OFST         _UINT32_(0x18C)     /* (CRU_PB3DIVINV)  Offset */
#define CRU_PB4DIV_REG_OFST            _UINT32_(0x190)     /* (CRU_PB4DIV) PB4 CLOCK DIVISOR CONTROL REGISTER Offset */
#define CRU_PB4DIVCLR_REG_OFST         _UINT32_(0x194)     /* (CRU_PB4DIVCLR)  Offset */
#define CRU_PB4DIVSET_REG_OFST         _UINT32_(0x198)     /* (CRU_PB4DIVSET)  Offset */
#define CRU_PB4DIVINV_REG_OFST         _UINT32_(0x19C)     /* (CRU_PB4DIVINV)  Offset */
#define CRU_PB5DIV_REG_OFST            _UINT32_(0x1A0)     /* (CRU_PB5DIV) PB5 CLOCK DIVISOR CONTROL REGISTER Offset */
#define CRU_PB5DIVCLR_REG_OFST         _UINT32_(0x1A4)     /* (CRU_PB5DIVCLR)  Offset */
#define CRU_PB5DIVSET_REG_OFST         _UINT32_(0x1A8)     /* (CRU_PB5DIVSET)  Offset */
#define CRU_PB5DIVINV_REG_OFST         _UINT32_(0x1AC)     /* (CRU_PB5DIVINV)  Offset */
#define CRU_SLEWCON_REG_OFST           _UINT32_(0x1B0)     /* (CRU_SLEWCON) SLEW RATE CONTROL FOR CLOCK SWITCHING REGISTER Offset */
#define CRU_SLEWCONCLR_REG_OFST        _UINT32_(0x1B4)     /* (CRU_SLEWCONCLR)  Offset */
#define CRU_SLEWCONSET_REG_OFST        _UINT32_(0x1B8)     /* (CRU_SLEWCONSET)  Offset */
#define CRU_SLEWCONINV_REG_OFST        _UINT32_(0x1BC)     /* (CRU_SLEWCONINV)  Offset */
#define CRU_CLKSTAT_REG_OFST           _UINT32_(0x1C0)     /* (CRU_CLKSTAT) CLOCK STATUS REGISTER Offset */
#define CRU_CLKSTATCLR_REG_OFST        _UINT32_(0x1C4)     /* (CRU_CLKSTATCLR)  Offset */
#define CRU_CLKSTATSET_REG_OFST        _UINT32_(0x1C8)     /* (CRU_CLKSTATSET)  Offset */
#define CRU_CLKSTATINV_REG_OFST        _UINT32_(0x1CC)     /* (CRU_CLKSTATINV)  Offset */
#define CRU_CLKDIAG_REG_OFST           _UINT32_(0x1E0)     /* (CRU_CLKDIAG) USER CLK DIAGNOSTICS CONTROL REGISTER Offset */
#define CRU_CLKDIAGCLR_REG_OFST        _UINT32_(0x1E4)     /* (CRU_CLKDIAGCLR)  Offset */
#define CRU_CLKDIAGSET_REG_OFST        _UINT32_(0x1E8)     /* (CRU_CLKDIAGSET)  Offset */
#define CRU_CLKDIAGINV_REG_OFST        _UINT32_(0x1EC)     /* (CRU_CLKDIAGINV)  Offset */
...
{  /*  */
  ...
  __IO  uint32_t                       CRU_UPLLCON;        /**< Offset: 0x30 (R/W  32) UPLL CONTROL REGISTER */
  __IO  uint32_t                       CRU_UPLLCONCLR;     /**< Offset: 0x34 (R/W  32)  */
  __IO  uint32_t                       CRU_UPLLCONSET;     /**< Offset: 0x38 (R/W  32)  */
  __IO  uint32_t                       CRU_UPLLCONINV;     /**< Offset: 0x3C (R/W  32)  */
  __IO  uint32_t                       CRU_EPLLCON;        /**< Offset: 0x40 (R/W  32) EPLL CONTROL REGISTER */
  __IO  uint32_t                       CRU_EPLLCONCLR;     /**< Offset: 0x44 (R/W  32)  */
  __IO  uint32_t                       CRU_EPLLCONSET;     /**< Offset: 0x48 (R/W  32)  */
  __IO  uint32_t                       CRU_EPLLCONINV;     /**< Offset: 0x4C (R/W  32)  */
  __IO  uint32_t                       CRU_APLLCON;        /**< Offset: 0x50 (R/W  32) APLL CONTROL REGISTER */
  __IO  uint32_t                       CRU_APLLCONCLR;     /**< Offset: 0x54 (R/W  32)  */
  __IO  uint32_t                       CRU_APLLCONSET;     /**< Offset: 0x58 (R/W  32)  */
  __IO  uint32_t                       CRU_APLLCONINV;     /**< Offset: 0x5C (R/W  32)  */
  __I   uint8_t                        Reserved1[0x40];
  __IO  uint32_t                       CRU_REFO1CON;       /**< Offset: 0xA0 (R/W  32) REFERENCE OSCILLATOR 1 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO1CONCLR;    /**< Offset: 0xA4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO1CONSET;    /**< Offset: 0xA8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO1CONINV;    /**< Offset: 0xAC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO1TRIM;      /**< Offset: 0xB0 (R/W  32) REFERENCE OSCILLATOR 1 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO1TRIMCLR;   /**< Offset: 0xB4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO1TRIMSET;   /**< Offset: 0xB8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO1TRIMINV;   /**< Offset: 0xBC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2CON;       /**< Offset: 0xC0 (R/W  32) REFERENCE OSCILLATOR 2 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO2CONCLR;    /**< Offset: 0xC4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2CONSET;    /**< Offset: 0xC8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2CONINV;    /**< Offset: 0xCC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2TRIM;      /**< Offset: 0xD0 (R/W  32) REFERENCE OSCILLATOR 2 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO2TRIMCLR;   /**< Offset: 0xD4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2TRIMSET;   /**< Offset: 0xD8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO2TRIMINV;   /**< Offset: 0xDC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3CON;       /**< Offset: 0xE0 (R/W  32) REFERENCE OSCILLATOR 3 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO3CONCLR;    /**< Offset: 0xE4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3CONSET;    /**< Offset: 0xE8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3CONINV;    /**< Offset: 0xEC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3TRIM;      /**< Offset: 0xF0 (R/W  32) REFERENCE OSCILLATOR 3 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO3TRIMCLR;   /**< Offset: 0xF4 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3TRIMSET;   /**< Offset: 0xF8 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO3TRIMINV;   /**< Offset: 0xFC (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4CON;       /**< Offset: 0x100 (R/W  32) REFERENCE OSCILLATOR 4 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO4CONCLR;    /**< Offset: 0x104 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4CONSET;    /**< Offset: 0x108 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4CONINV;    /**< Offset: 0x10C (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4TRIM;      /**< Offset: 0x110 (R/W  32) REFERENCE OSCILLATOR 4 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO4TRIMCLR;   /**< Offset: 0x114 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4TRIMSET;   /**< Offset: 0x118 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO4TRIMINV;   /**< Offset: 0x11C (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5CON;       /**< Offset: 0x120 (R/W  32) REFERENCE OSCILLATOR 5 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO5CONCLR;    /**< Offset: 0x124 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5CONSET;    /**< Offset: 0x128 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5CONINV;    /**< Offset: 0x12C (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5TRIM;      /**< Offset: 0x130 (R/W  32) REFERENCE OSCILLATOR 5 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO5TRIMCLR;   /**< Offset: 0x134 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5TRIMSET;   /**< Offset: 0x138 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO5TRIMINV;   /**< Offset: 0x13C (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6CON;       /**< Offset: 0x140 (R/W  32) REFERENCE OSCILLATOR 6 CONTROL REGISTER */
  __IO  uint32_t                       CRU_REFO6CONCLR;    /**< Offset: 0x144 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6CONSET;    /**< Offset: 0x148 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6CONINV;    /**< Offset: 0x14C (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6TRIM;      /**< Offset: 0x150 (R/W  32) REFERENCE OSCILLATOR 6 TRIM REGISTER */
  __IO  uint32_t                       CRU_REFO6TRIMCLR;   /**< Offset: 0x154 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6TRIMSET;   /**< Offset: 0x158 (R/W  32)  */
  __IO  uint32_t                       CRU_REFO6TRIMINV;   /**< Offset: 0x15C (R/W  32)  */
  __IO  uint32_t                       CRU_PB1DIV;         /**< Offset: 0x160 (R/W  32) PB1 CLOCK DIVISOR CONTROL REGISTER */
  __IO  uint32_t                       CRU_PB1DIVCLR;      /**< Offset: 0x164 (R/W  32)  */
  __IO  uint32_t                       CRU_PB1DIVSET;      /**< Offset: 0x168 (R/W  32)  */
  __IO  uint32_t                       CRU_PB1DIVINV;      /**< Offset: 0x16C (R/W  32)  */
  __IO  uint32_t                       CRU_PB2DIV;         /**< Offset: 0x170 (R/W  32) PB2 CLOCK DIVISOR CONTROL REGISTER */
  __IO  uint32_t                       CRU_PB2DIVCLR;      /**< Offset: 0x174 (R/W  32)  */
  __IO  uint32_t                       CRU_PB2DIVSET;      /**< Offset: 0x178 (R/W  32)  */
  __IO  uint32_t                       CRU_PB2DIVINV;      /**< Offset: 0x17C (R/W  32)  */
  __IO  uint32_t                       CRU_PB3DIV;         /**< Offset: 0x180 (R/W  32) PB3 CLOCK DIVISOR CONTROL REGISTER */
  __IO  uint32_t                       CRU_PB3DIVCLR;      /**< Offset: 0x184 (R/W  32)  */
  __IO  uint32_t                       CRU_PB3DIVSET;      /**< Offset: 0x188 (R/W  32)  */
  __IO  uint32_t                       CRU_PB3DIVINV;      /**< Offset: 0x18C (R/W  32)  */
  __IO  uint32_t                       CRU_PB4DIV;         /**< Offset: 0x190 (R/W  32) PB4 CLOCK DIVISOR CONTROL REGISTER */
  __IO  uint32_t                       CRU_PB4DIVCLR;      /**< Offset: 0x194 (R/W  32)  */
  __IO  uint32_t                       CRU_PB4DIVSET;      /**< Offset: 0x198 (R/W  32)  */
  __IO  uint32_t                       CRU_PB4DIVINV;      /**< Offset: 0x19C (R/W  32)  */
  __IO  uint32_t                       CRU_PB5DIV;         /**< Offset: 0x1A0 (R/W  32) PB5 CLOCK DIVISOR CONTROL REGISTER */
  __IO  uint32_t                       CRU_PB5DIVCLR;      /**< Offset: 0x1A4 (R/W  32)  */
  __IO  uint32_t                       CRU_PB5DIVSET;      /**< Offset: 0x1A8 (R/W  32)  */
  __IO  uint32_t                       CRU_PB5DIVINV;      /**< Offset: 0x1AC (R/W  32)  */
  __IO  uint32_t                       CRU_SLEWCON;        /**< Offset: 0x1B0 (R/W  32) SLEW RATE CONTROL FOR CLOCK SWITCHING REGISTER */
  __IO  uint32_t                       CRU_SLEWCONCLR;     /**< Offset: 0x1B4 (R/W  32)  */
  __IO  uint32_t                       CRU_SLEWCONSET;     /**< Offset: 0x1B8 (R/W  32)  */
  __IO  uint32_t                       CRU_SLEWCONINV;     /**< Offset: 0x1BC (R/W  32)  */
  __IO  uint32_t                       CRU_CLKSTAT;        /**< Offset: 0x1C0 (R/W  32) CLOCK STATUS REGISTER */
  __IO  uint32_t                       CRU_CLKSTATCLR;     /**< Offset: 0x1C4 (R/W  32)  */
  __IO  uint32_t                       CRU_CLKSTATSET;     /**< Offset: 0x1C8 (R/W  32)  */
  __IO  uint32_t                       CRU_CLKSTATINV;     /**< Offset: 0x1CC (R/W  32)  */
  __I   uint8_t                        Reserved2[0x10];
  __IO  uint32_t                       CRU_CLKDIAG;        /**< Offset: 0x1E0 (R/W  32) USER CLK DIAGNOSTICS CONTROL REGISTER */
  __IO  uint32_t                       CRU_CLKDIAGCLR;     /**< Offset: 0x1E4 (R/W  32)  */
  __IO  uint32_t                       CRU_CLKDIAGSET;     /**< Offset: 0x1E8 (R/W  32)  */
  __IO  uint32_t                       CRU_CLKDIAGINV;     /**< Offset: 0x1EC (R/W  32)  */
} cru_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _WBZ65_CRU_COMPONENT_H_ */
