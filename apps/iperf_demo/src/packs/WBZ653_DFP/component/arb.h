...
#ifndef _WBZ65_ARB_COMPONENT_H_
#define _WBZ65_ARB_COMPONENT_H_
...
#define ARB_CORE_CTRL_CFG_CDC_ADJ_VAL(value)  (ARB_CORE_CTRL_CFG_CDC_ADJ_VAL_Msk & (_UINT32_(value) << ARB_CORE_CTRL_CFG_CDC_ADJ_VAL_Pos)) /* Assigment of value for CFG_CDC_ADJ_VAL in the ARB_CORE_CTRL register */
...
#define ARB_CORE_CTRL_RESERVED_1(value)       (ARB_CORE_CTRL_RESERVED_1_Msk & (_UINT32_(value) << ARB_CORE_CTRL_RESERVED_1_Pos)) /* Assigment of value for RESERVED_1 in the ARB_CORE_CTRL register */
...
#define ARB_CORE_STATUS_NEXT_RADIO_OWNER(value) (ARB_CORE_STATUS_NEXT_RADIO_OWNER_Msk & (_UINT32_(value) << ARB_CORE_STATUS_NEXT_RADIO_OWNER_Pos)) /* Assigment of value for NEXT_RADIO_OWNER in the ARB_CORE_STATUS register */
...
#define ARB_INT_STATUS_COLLISION_PREDICTED(value) (ARB_INT_STATUS_COLLISION_PREDICTED_Msk & (_UINT32_(value) << ARB_INT_STATUS_COLLISION_PREDICTED_Pos)) /* Assigment of value for COLLISION_PREDICTED in the ARB_INT_STATUS register */
...
#define ARB_INT_STATUS_ARB_IDLE(value)        (ARB_INT_STATUS_ARB_IDLE_Msk & (_UINT32_(value) << ARB_INT_STATUS_ARB_IDLE_Pos)) /* Assigment of value for ARB_IDLE in the ARB_INT_STATUS register */
...
#define ARB_INT_MASK_COLLISION_PREDICTED_MSK(value) (ARB_INT_MASK_COLLISION_PREDICTED_MSK_Msk & (_UINT32_(value) << ARB_INT_MASK_COLLISION_PREDICTED_MSK_Pos)) /* Assigment of value for COLLISION_PREDICTED_MSK in the ARB_INT_MASK register */
...
#define ARB_INT_MASK_ARB_IDLE_MSK(value)      (ARB_INT_MASK_ARB_IDLE_MSK_Msk & (_UINT32_(value) << ARB_INT_MASK_ARB_IDLE_MSK_Pos)) /* Assigment of value for ARB_IDLE_MSK in the ARB_INT_MASK register */
