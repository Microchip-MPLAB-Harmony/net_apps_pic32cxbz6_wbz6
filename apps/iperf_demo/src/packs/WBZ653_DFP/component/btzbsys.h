...
#ifndef _WBZ65_BTZBSYS_COMPONENT_H_
#define _WBZ65_BTZBSYS_COMPONENT_H_
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel_top(value) (BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel_top_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel_top_Pos)) /* Assigment of value for subsys_dbg_bus_sel_top in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_aclb_soft_rst_n(value) (BTZBSYS_SUBSYS_CNTRL_REG0_aclb_soft_rst_n_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_aclb_soft_rst_n_Pos)) /* Assigment of value for aclb_soft_rst_n in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_aclb_pwr_rst_n(value) (BTZBSYS_SUBSYS_CNTRL_REG0_aclb_pwr_rst_n_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_aclb_pwr_rst_n_Pos)) /* Assigment of value for aclb_pwr_rst_n in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel(value) (BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_subsys_dbg_bus_sel_Pos)) /* Assigment of value for subsys_dbg_bus_sel in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_arb(value) (BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_arb_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_arb_Pos)) /* Assigment of value for disable_pclk_arb in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_zb_mac(value) (BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_zb_mac_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_zb_mac_Pos)) /* Assigment of value for disable_pclk_zb_mac in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_bt(value) (BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_bt_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_disable_pclk_bt_Pos)) /* Assigment of value for disable_pclk_bt in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_val(value) (BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_val_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_val_Pos)) /* Assigment of value for ant_div_sel_ovrd_val in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_en(value) (BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG0_ant_div_sel_ovrd_en_Pos)) /* Assigment of value for ant_div_sel_ovrd_en in the BTZBSYS_SUBSYS_CNTRL_REG0 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_disable_one_sec_counter(value) (BTZBSYS_SUBSYS_CNTRL_REG1_disable_one_sec_counter_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_disable_one_sec_counter_Pos)) /* Assigment of value for disable_one_sec_counter in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_subsys_dbg_bus_en(value) (BTZBSYS_SUBSYS_CNTRL_REG1_subsys_dbg_bus_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_subsys_dbg_bus_en_Pos)) /* Assigment of value for subsys_dbg_bus_en in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_en(value) (BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_en_Pos)) /* Assigment of value for xtal_lock_cnt_rstn_ovrd_en in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_val(value) (BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_val_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_xtal_lock_cnt_rstn_ovrd_val_Pos)) /* Assigment of value for xtal_lock_cnt_rstn_ovrd_val in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_en(value) (BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_en_Pos)) /* Assigment of value for pll_lock_flops_rstn_ovrd_en in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_val(value) (BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_val_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_pll_lock_flops_rstn_ovrd_val_Pos)) /* Assigment of value for pll_lock_flops_rstn_ovrd_val in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_die_clk_sel(value) (BTZBSYS_SUBSYS_CNTRL_REG1_die_clk_sel_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_die_clk_sel_Pos)) /* Assigment of value for die_clk_sel in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG1_disable_adc_clk_gating(value) (BTZBSYS_SUBSYS_CNTRL_REG1_disable_adc_clk_gating_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG1_disable_adc_clk_gating_Pos)) /* Assigment of value for disable_adc_clk_gating in the BTZBSYS_SUBSYS_CNTRL_REG1 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_0(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_0_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_0_Pos)) /* Assigment of value for crossbar_data_line_sel_0 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_1(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_1_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_1_Pos)) /* Assigment of value for crossbar_data_line_sel_1 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_2(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_2_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_2_Pos)) /* Assigment of value for crossbar_data_line_sel_2 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_3(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_3_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_3_Pos)) /* Assigment of value for crossbar_data_line_sel_3 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_4(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_4_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_4_Pos)) /* Assigment of value for crossbar_data_line_sel_4 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_5(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_5_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_line_sel_5_Pos)) /* Assigment of value for crossbar_data_line_sel_5 in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_invert(value) (BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_invert_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG2_crossbar_data_invert_Pos)) /* Assigment of value for crossbar_data_invert in the BTZBSYS_SUBSYS_CNTRL_REG2 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_le_2m_fpga_v1c0_mode(value) (BTZBSYS_SUBSYS_CNTRL_REG3_le_2m_fpga_v1c0_mode_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_le_2m_fpga_v1c0_mode_Pos)) /* Assigment of value for le_2m_fpga_v1c0_mode in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_subsys_pll_ready_delay(value) (BTZBSYS_SUBSYS_CNTRL_REG3_subsys_pll_ready_delay_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_subsys_pll_ready_delay_Pos)) /* Assigment of value for subsys_pll_ready_delay in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_dfe(value) (BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_dfe_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_dfe_Pos)) /* Assigment of value for disable_pclk_dfe in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_zb_mdm(value) (BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_zb_mdm_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_disable_pclk_zb_mdm_Pos)) /* Assigment of value for disable_pclk_zb_mdm in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_en(value) (BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_en_Pos)) /* Assigment of value for pll_lock_fifo_en in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_pll_auto_relock_en(value) (BTZBSYS_SUBSYS_CNTRL_REG3_pll_auto_relock_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_pll_auto_relock_en_Pos)) /* Assigment of value for pll_auto_relock_en in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_soft_reset(value) (BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_soft_reset_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_soft_reset_Pos)) /* Assigment of value for pll_lock_fifo_empty_soft_reset in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_clk_src_sel(value) (BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_clk_src_sel_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_clk_src_sel_Pos)) /* Assigment of value for pll_lock_fifo_clk_src_sel in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_rst_en(value) (BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_rst_en_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_CNTRL_REG3_pll_lock_fifo_empty_rst_en_Pos)) /* Assigment of value for pll_lock_fifo_empty_rst_en in the BTZBSYS_SUBSYS_CNTRL_REG3 register */
...
#define BTZBSYS_SUBSYS_STATUS_REG1_clk_mux_sel(value) (BTZBSYS_SUBSYS_STATUS_REG1_clk_mux_sel_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_STATUS_REG1_clk_mux_sel_Pos)) /* Assigment of value for clk_mux_sel in the BTZBSYS_SUBSYS_STATUS_REG1 register */
...
#define BTZBSYS_SUBSYS_STATUS_REG1_pll_lock_fifo_empty(value) (BTZBSYS_SUBSYS_STATUS_REG1_pll_lock_fifo_empty_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_STATUS_REG1_pll_lock_fifo_empty_Pos)) /* Assigment of value for pll_lock_fifo_empty in the BTZBSYS_SUBSYS_STATUS_REG1 register */
...
#define BTZBSYS_SUBSYS_STATUS_REG1_pllc_ready_cnt_expire_raw(value) (BTZBSYS_SUBSYS_STATUS_REG1_pllc_ready_cnt_expire_raw_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_STATUS_REG1_pllc_ready_cnt_expire_raw_Pos)) /* Assigment of value for pllc_ready_cnt_expire_raw in the BTZBSYS_SUBSYS_STATUS_REG1 register */
...
#define BTZBSYS_SUBSYS_STATUS_REG2_VERSION_NUM(value) (BTZBSYS_SUBSYS_STATUS_REG2_VERSION_NUM_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_STATUS_REG2_VERSION_NUM_Pos)) /* Assigment of value for VERSION_NUM in the BTZBSYS_SUBSYS_STATUS_REG2 register */
...
#define BTZBSYS_SUBSYS_STATUS_REG2_PART_NUM(value) (BTZBSYS_SUBSYS_STATUS_REG2_PART_NUM_Msk & (_UINT32_(value) << BTZBSYS_SUBSYS_STATUS_REG2_PART_NUM_Pos)) /* Assigment of value for PART_NUM in the BTZBSYS_SUBSYS_STATUS_REG2 register */
...
#endif /* _WBZ65_BTZBSYS_COMPONENT_H_ */
