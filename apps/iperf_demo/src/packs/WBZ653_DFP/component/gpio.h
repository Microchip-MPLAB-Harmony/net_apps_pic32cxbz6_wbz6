...
#ifndef _WBZ65_GPIO_COMPONENT_H_
#define _WBZ65_GPIO_COMPONENT_H_
...
#define GPIO_ANSEL_ANS15_Pos                  _UINT32_(15)                                         /* (GPIO_ANSEL)  Position */
#define GPIO_ANSEL_ANS15_Msk                  (_UINT32_(0x1) << GPIO_ANSEL_ANS15_Pos)              /* (GPIO_ANSEL)  Mask */
#define GPIO_ANSEL_ANS15(value)               (GPIO_ANSEL_ANS15_Msk & (_UINT32_(value) << GPIO_ANSEL_ANS15_Pos)) /* Assigment of value for ANS15 in the GPIO_ANSEL register */
#define GPIO_ANSEL_Msk                        _UINT32_(0x0000FFFF)                                 /* (GPIO_ANSEL) Register Mask  */

#define GPIO_ANSEL_ANS_Pos                    _UINT32_(0)                                          /* (GPIO_ANSEL Position)  */
#define GPIO_ANSEL_ANS_Msk                    (_UINT32_(0xFFFF) << GPIO_ANSEL_ANS_Pos)             /* (GPIO_ANSEL Mask) ANS */
...
#define GPIO_TRIS_TRIS11_Pos                  _UINT32_(11)                                         /* (GPIO_TRIS)  Position */
#define GPIO_TRIS_TRIS11_Msk                  (_UINT32_(0x1) << GPIO_TRIS_TRIS11_Pos)              /* (GPIO_TRIS)  Mask */
#define GPIO_TRIS_TRIS11(value)               (GPIO_TRIS_TRIS11_Msk & (_UINT32_(value) << GPIO_TRIS_TRIS11_Pos)) /* Assigment of value for TRIS11 in the GPIO_TRIS register */
#define GPIO_TRIS_TRIS12_Pos                  _UINT32_(12)                                         /* (GPIO_TRIS)  Position */
#define GPIO_TRIS_TRIS12_Msk                  (_UINT32_(0x1) << GPIO_TRIS_TRIS12_Pos)              /* (GPIO_TRIS)  Mask */
#define GPIO_TRIS_TRIS12(value)               (GPIO_TRIS_TRIS12_Msk & (_UINT32_(value) << GPIO_TRIS_TRIS12_Pos)) /* Assigment of value for TRIS12 in the GPIO_TRIS register */
...
#define GPIO_TRIS_TRIS15_Pos                  _UINT32_(15)                                         /* (GPIO_TRIS)  Position */
#define GPIO_TRIS_TRIS15_Msk                  (_UINT32_(0x1) << GPIO_TRIS_TRIS15_Pos)              /* (GPIO_TRIS)  Mask */
#define GPIO_TRIS_TRIS15(value)               (GPIO_TRIS_TRIS15_Msk & (_UINT32_(value) << GPIO_TRIS_TRIS15_Pos)) /* Assigment of value for TRIS15 in the GPIO_TRIS register */
#define GPIO_TRIS_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_TRIS) Register Mask  */

#define GPIO_TRIS_TRIS_Pos                    _UINT32_(0)                                          /* (GPIO_TRIS Position)  */
#define GPIO_TRIS_TRIS_Msk                    (_UINT32_(0xFFFF) << GPIO_TRIS_TRIS_Pos)             /* (GPIO_TRIS Mask) TRIS */
...
#define GPIO_PORT_R15_Pos                     _UINT32_(15)                                         /* (GPIO_PORT)  Position */
#define GPIO_PORT_R15_Msk                     (_UINT32_(0x1) << GPIO_PORT_R15_Pos)                 /* (GPIO_PORT)  Mask */
#define GPIO_PORT_R15(value)                  (GPIO_PORT_R15_Msk & (_UINT32_(value) << GPIO_PORT_R15_Pos)) /* Assigment of value for R15 in the GPIO_PORT register */
#define GPIO_PORT_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_PORT) Register Mask  */

#define GPIO_PORT_R_Pos                       _UINT32_(0)                                          /* (GPIO_PORT Position)  */
#define GPIO_PORT_R_Msk                       (_UINT32_(0xFFFF) << GPIO_PORT_R_Pos)                /* (GPIO_PORT Mask) R */
...
#define GPIO_LAT_LAT15_Pos                    _UINT32_(15)                                         /* (GPIO_LAT)  Position */
#define GPIO_LAT_LAT15_Msk                    (_UINT32_(0x1) << GPIO_LAT_LAT15_Pos)                /* (GPIO_LAT)  Mask */
#define GPIO_LAT_LAT15(value)                 (GPIO_LAT_LAT15_Msk & (_UINT32_(value) << GPIO_LAT_LAT15_Pos)) /* Assigment of value for LAT15 in the GPIO_LAT register */
#define GPIO_LAT_Msk                          _UINT32_(0x0000FFFF)                                 /* (GPIO_LAT) Register Mask  */

#define GPIO_LAT_LAT_Pos                      _UINT32_(0)                                          /* (GPIO_LAT Position)  */
#define GPIO_LAT_LAT_Msk                      (_UINT32_(0xFFFF) << GPIO_LAT_LAT_Pos)               /* (GPIO_LAT Mask) LAT */
...
#define GPIO_ODC_ODC15_Pos                    _UINT32_(15)                                         /* (GPIO_ODC)  Position */
#define GPIO_ODC_ODC15_Msk                    (_UINT32_(0x1) << GPIO_ODC_ODC15_Pos)                /* (GPIO_ODC)  Mask */
#define GPIO_ODC_ODC15(value)                 (GPIO_ODC_ODC15_Msk & (_UINT32_(value) << GPIO_ODC_ODC15_Pos)) /* Assigment of value for ODC15 in the GPIO_ODC register */
#define GPIO_ODC_Msk                          _UINT32_(0x0000FFFF)                                 /* (GPIO_ODC) Register Mask  */

#define GPIO_ODC_ODC_Pos                      _UINT32_(0)                                          /* (GPIO_ODC Position)  */
#define GPIO_ODC_ODC_Msk                      (_UINT32_(0xFFFF) << GPIO_ODC_ODC_Pos)               /* (GPIO_ODC Mask) ODC */
...
#define GPIO_CNPU_CNPU15_Pos                  _UINT32_(15)                                         /* (GPIO_CNPU)  Position */
#define GPIO_CNPU_CNPU15_Msk                  (_UINT32_(0x1) << GPIO_CNPU_CNPU15_Pos)              /* (GPIO_CNPU)  Mask */
#define GPIO_CNPU_CNPU15(value)               (GPIO_CNPU_CNPU15_Msk & (_UINT32_(value) << GPIO_CNPU_CNPU15_Pos)) /* Assigment of value for CNPU15 in the GPIO_CNPU register */
#define GPIO_CNPU_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_CNPU) Register Mask  */

#define GPIO_CNPU_CNPU_Pos                    _UINT32_(0)                                          /* (GPIO_CNPU Position)  */
#define GPIO_CNPU_CNPU_Msk                    (_UINT32_(0xFFFF) << GPIO_CNPU_CNPU_Pos)             /* (GPIO_CNPU Mask) CNPU */
...
#define GPIO_CNPD_CNPD15_Pos                  _UINT32_(15)                                         /* (GPIO_CNPD)  Position */
#define GPIO_CNPD_CNPD15_Msk                  (_UINT32_(0x1) << GPIO_CNPD_CNPD15_Pos)              /* (GPIO_CNPD)  Mask */
#define GPIO_CNPD_CNPD15(value)               (GPIO_CNPD_CNPD15_Msk & (_UINT32_(value) << GPIO_CNPD_CNPD15_Pos)) /* Assigment of value for CNPD15 in the GPIO_CNPD register */
#define GPIO_CNPD_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_CNPD) Register Mask  */

#define GPIO_CNPD_CNPD_Pos                    _UINT32_(0)                                          /* (GPIO_CNPD Position)  */
#define GPIO_CNPD_CNPD_Msk                    (_UINT32_(0xFFFF) << GPIO_CNPD_CNPD_Pos)             /* (GPIO_CNPD Mask) CNPD */
...
#define GPIO_CNCON_PORT32_Pos                 _UINT32_(10)                                         /* (GPIO_CNCON)  Position */
#define GPIO_CNCON_PORT32_Msk                 (_UINT32_(0x1) << GPIO_CNCON_PORT32_Pos)             /* (GPIO_CNCON)  Mask */
#define GPIO_CNCON_PORT32(value)              (GPIO_CNCON_PORT32_Msk & (_UINT32_(value) << GPIO_CNCON_PORT32_Pos)) /* Assigment of value for PORT32 in the GPIO_CNCON register */
#define GPIO_CNCON_CNSYTLE_Pos                _UINT32_(11)                                         /* (GPIO_CNCON)  Position */
#define GPIO_CNCON_CNSYTLE_Msk                (_UINT32_(0x1) << GPIO_CNCON_CNSYTLE_Pos)            /* (GPIO_CNCON)  Mask */
#define GPIO_CNCON_CNSYTLE(value)             (GPIO_CNCON_CNSYTLE_Msk & (_UINT32_(value) << GPIO_CNCON_CNSYTLE_Pos)) /* Assigment of value for CNSYTLE in the GPIO_CNCON register */
...
#define GPIO_CNCON_Msk                        _UINT32_(0x0000CC00)                                 /* (GPIO_CNCON) Register Mask  */

#define GPIO_CNCON_PORT_Pos                   _UINT32_(10)                                         /* (GPIO_CNCON Position)  */
#define GPIO_CNCON_PORT_Msk                   (_UINT32_(0x1) << GPIO_CNCON_PORT_Pos)               /* (GPIO_CNCON Mask) PORT */
#define GPIO_CNCON_PORT(value)                (GPIO_CNCON_PORT_Msk & (_UINT32_(value) << GPIO_CNCON_PORT_Pos)) 
...
#define GPIO_CNEN_CNIE15_Pos                  _UINT32_(15)                                         /* (GPIO_CNEN)  Position */
#define GPIO_CNEN_CNIE15_Msk                  (_UINT32_(0x1) << GPIO_CNEN_CNIE15_Pos)              /* (GPIO_CNEN)  Mask */
#define GPIO_CNEN_CNIE15(value)               (GPIO_CNEN_CNIE15_Msk & (_UINT32_(value) << GPIO_CNEN_CNIE15_Pos)) /* Assigment of value for CNIE15 in the GPIO_CNEN register */
#define GPIO_CNEN_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_CNEN) Register Mask  */

#define GPIO_CNEN_CNIE_Pos                    _UINT32_(0)                                          /* (GPIO_CNEN Position)  */
#define GPIO_CNEN_CNIE_Msk                    (_UINT32_(0xFFFF) << GPIO_CNEN_CNIE_Pos)             /* (GPIO_CNEN Mask) CNIE */
...
#define GPIO_CNSTAT_CNSTAT9_Pos               _UINT32_(9)                                          /* (GPIO_CNSTAT)  Position */
#define GPIO_CNSTAT_CNSTAT9_Msk               (_UINT32_(0x1) << GPIO_CNSTAT_CNSTAT9_Pos)           /* (GPIO_CNSTAT)  Mask */
#define GPIO_CNSTAT_CNSTAT9(value)            (GPIO_CNSTAT_CNSTAT9_Msk & (_UINT32_(value) << GPIO_CNSTAT_CNSTAT9_Pos)) /* Assigment of value for CNSTAT9 in the GPIO_CNSTAT register */
...
#define GPIO_CNSTAT_CNSTAT15_Pos              _UINT32_(15)                                         /* (GPIO_CNSTAT)  Position */
#define GPIO_CNSTAT_CNSTAT15_Msk              (_UINT32_(0x1) << GPIO_CNSTAT_CNSTAT15_Pos)          /* (GPIO_CNSTAT)  Mask */
#define GPIO_CNSTAT_CNSTAT15(value)           (GPIO_CNSTAT_CNSTAT15_Msk & (_UINT32_(value) << GPIO_CNSTAT_CNSTAT15_Pos)) /* Assigment of value for CNSTAT15 in the GPIO_CNSTAT register */
#define GPIO_CNSTAT_Msk                       _UINT32_(0x0000FFFF)                                 /* (GPIO_CNSTAT) Register Mask  */

#define GPIO_CNSTAT_CNSTAT_Pos                _UINT32_(0)                                          /* (GPIO_CNSTAT Position)  */
#define GPIO_CNSTAT_CNSTAT_Msk                (_UINT32_(0xFFFF) << GPIO_CNSTAT_CNSTAT_Pos)         /* (GPIO_CNSTAT Mask) CNSTAT */
#define GPIO_CNSTAT_CNSTAT(value)             (GPIO_CNSTAT_CNSTAT_Msk & (_UINT32_(value) << GPIO_CNSTAT_CNSTAT_Pos)) 
...
#define GPIO_CNNE_CNNE15_Pos                  _UINT32_(15)                                         /* (GPIO_CNNE)  Position */
#define GPIO_CNNE_CNNE15_Msk                  (_UINT32_(0x1) << GPIO_CNNE_CNNE15_Pos)              /* (GPIO_CNNE)  Mask */
#define GPIO_CNNE_CNNE15(value)               (GPIO_CNNE_CNNE15_Msk & (_UINT32_(value) << GPIO_CNNE_CNNE15_Pos)) /* Assigment of value for CNNE15 in the GPIO_CNNE register */
#define GPIO_CNNE_Msk                         _UINT32_(0x0000FFFF)                                 /* (GPIO_CNNE) Register Mask  */

#define GPIO_CNNE_CNNE_Pos                    _UINT32_(0)                                          /* (GPIO_CNNE Position)  */
#define GPIO_CNNE_CNNE_Msk                    (_UINT32_(0xFFFF) << GPIO_CNNE_CNNE_Pos)             /* (GPIO_CNNE Mask) CNNE */
...
#define GPIO_CNF_CNF15_Pos                    _UINT32_(15)                                         /* (GPIO_CNF)  Position */
#define GPIO_CNF_CNF15_Msk                    (_UINT32_(0x1) << GPIO_CNF_CNF15_Pos)                /* (GPIO_CNF)  Mask */
#define GPIO_CNF_CNF15(value)                 (GPIO_CNF_CNF15_Msk & (_UINT32_(value) << GPIO_CNF_CNF15_Pos)) /* Assigment of value for CNF15 in the GPIO_CNF register */
#define GPIO_CNF_Msk                          _UINT32_(0x0000FFFF)                                 /* (GPIO_CNF) Register Mask  */

#define GPIO_CNF_CNF_Pos                      _UINT32_(0)                                          /* (GPIO_CNF Position)  */
#define GPIO_CNF_CNF_Msk                      (_UINT32_(0xFFFF) << GPIO_CNF_CNF_Pos)               /* (GPIO_CNF Mask) CNF */
...
#define GPIO_SRCON0_SR015_Pos                 _UINT32_(15)                                         /* (GPIO_SRCON0)  Position */
#define GPIO_SRCON0_SR015_Msk                 (_UINT32_(0x1) << GPIO_SRCON0_SR015_Pos)             /* (GPIO_SRCON0)  Mask */
#define GPIO_SRCON0_SR015(value)              (GPIO_SRCON0_SR015_Msk & (_UINT32_(value) << GPIO_SRCON0_SR015_Pos)) /* Assigment of value for SR015 in the GPIO_SRCON0 register */
#define GPIO_SRCON0_Msk                       _UINT32_(0x0000FFFF)                                 /* (GPIO_SRCON0) Register Mask  */

#define GPIO_SRCON0_SR_Pos                    _UINT32_(0)                                          /* (GPIO_SRCON0 Position)  */
#define GPIO_SRCON0_SR_Msk                    (_UINT32_(0xFFFF) << GPIO_SRCON0_SR_Pos)             /* (GPIO_SRCON0 Mask) SR */
...
#define GPIO_SRCON1_SR115_Pos                 _UINT32_(15)                                         /* (GPIO_SRCON1)  Position */
#define GPIO_SRCON1_SR115_Msk                 (_UINT32_(0x1) << GPIO_SRCON1_SR115_Pos)             /* (GPIO_SRCON1)  Mask */
#define GPIO_SRCON1_SR115(value)              (GPIO_SRCON1_SR115_Msk & (_UINT32_(value) << GPIO_SRCON1_SR115_Pos)) /* Assigment of value for SR115 in the GPIO_SRCON1 register */
#define GPIO_SRCON1_Msk                       _UINT32_(0x0000FFFF)                                 /* (GPIO_SRCON1) Register Mask  */

#define GPIO_SRCON1_SR_Pos                    _UINT32_(0)                                          /* (GPIO_SRCON1 Position)  */
#define GPIO_SRCON1_SR_Msk                    (_UINT32_(0xFFFF) << GPIO_SRCON1_SR_Pos)             /* (GPIO_SRCON1 Mask) SR */
...
#endif /* _WBZ65_GPIO_COMPONENT_H_ */
