...
#ifndef _WBZ65_TCC_COMPONENT_H_
#define _WBZ65_TCC_COMPONENT_H_
...
#define TCC_CTRLA_FCYCLE_Pos                  _UINT32_(16)                                         /* (TCC_CTRLA) Full Cycle Enable Position */
#define TCC_CTRLA_FCYCLE_Msk                  (_UINT32_(0x1) << TCC_CTRLA_FCYCLE_Pos)              /* (TCC_CTRLA) Full Cycle Enable Mask */
#define TCC_CTRLA_FCYCLE(value)               (TCC_CTRLA_FCYCLE_Msk & (_UINT32_(value) << TCC_CTRLA_FCYCLE_Pos)) /* Assigment of value for FCYCLE in the TCC_CTRLA register */
...
#define TCC_CTRLA_CPTEN4_Pos                  _UINT32_(28)                                         /* (TCC_CTRLA) Capture Channel 4 Enable Position */
#define TCC_CTRLA_CPTEN4_Msk                  (_UINT32_(0x1) << TCC_CTRLA_CPTEN4_Pos)              /* (TCC_CTRLA) Capture Channel 4 Enable Mask */
#define TCC_CTRLA_CPTEN4(value)               (TCC_CTRLA_CPTEN4_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN4_Pos)) /* Assigment of value for CPTEN4 in the TCC_CTRLA register */
#define TCC_CTRLA_CPTEN5_Pos                  _UINT32_(29)                                         /* (TCC_CTRLA) Capture Channel 5 Enable Position */
#define TCC_CTRLA_CPTEN5_Msk                  (_UINT32_(0x1) << TCC_CTRLA_CPTEN5_Pos)              /* (TCC_CTRLA) Capture Channel 5 Enable Mask */
#define TCC_CTRLA_CPTEN5(value)               (TCC_CTRLA_CPTEN5_Msk & (_UINT32_(value) << TCC_CTRLA_CPTEN5_Pos)) /* Assigment of value for CPTEN5 in the TCC_CTRLA register */
#define TCC_CTRLA_Msk                         _UINT32_(0x3F81FF63)                                 /* (TCC_CTRLA) Register Mask  */

#define TCC_CTRLA_CPTEN_Pos                   _UINT32_(24)                                         /* (TCC_CTRLA Position) Capture Channel 5 Enable */
#define TCC_CTRLA_CPTEN_Msk                   (_UINT32_(0x3F) << TCC_CTRLA_CPTEN_Pos)              /* (TCC_CTRLA Mask) CPTEN */
...
#define TCC_DRVCTRL_Msk                       _UINT32_(0xFF3F3F3F)                                 /* (TCC_DRVCTRL) Register Mask  */

#define TCC_DRVCTRL_NRE_Pos                   _UINT32_(0)                                          /* (TCC_DRVCTRL Position) Non-Recoverable State x Output Enable */
#define TCC_DRVCTRL_NRE_Msk                   (_UINT32_(0x3F) << TCC_DRVCTRL_NRE_Pos)              /* (TCC_DRVCTRL Mask) NRE */
...
#define TCC_DRVCTRL_NRV_Msk                   (_UINT32_(0x3F) << TCC_DRVCTRL_NRV_Pos)              /* (TCC_DRVCTRL Mask) NRV */
...
#define TCC_DRVCTRL_INVEN_Msk                 (_UINT32_(0x3F) << TCC_DRVCTRL_INVEN_Pos)            /* (TCC_DRVCTRL Mask) INVEN */
...
#define TCC_INTENCLR_MC4_Pos                  _UINT32_(20)                                         /* (TCC_INTENCLR) Match or Capture Channel 4 Interrupt Enable Position */
#define TCC_INTENCLR_MC4_Msk                  (_UINT32_(0x1) << TCC_INTENCLR_MC4_Pos)              /* (TCC_INTENCLR) Match or Capture Channel 4 Interrupt Enable Mask */
#define TCC_INTENCLR_MC4(value)               (TCC_INTENCLR_MC4_Msk & (_UINT32_(value) << TCC_INTENCLR_MC4_Pos)) /* Assigment of value for MC4 in the TCC_INTENCLR register */
#define TCC_INTENCLR_MC5_Pos                  _UINT32_(21)                                         /* (TCC_INTENCLR) Match or Capture Channel 5 Interrupt Enable Position */
#define TCC_INTENCLR_MC5_Msk                  (_UINT32_(0x1) << TCC_INTENCLR_MC5_Pos)              /* (TCC_INTENCLR) Match or Capture Channel 5 Interrupt Enable Mask */
#define TCC_INTENCLR_MC5(value)               (TCC_INTENCLR_MC5_Msk & (_UINT32_(value) << TCC_INTENCLR_MC5_Pos)) /* Assigment of value for MC5 in the TCC_INTENCLR register */
#define TCC_INTENCLR_Msk                      _UINT32_(0x003FFC0F)                                 /* (TCC_INTENCLR) Register Mask  */
...
#define TCC_INTENCLR_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENCLR Position) Match or Capture Channel 5 Interrupt Enable */
#define TCC_INTENCLR_MC_Msk                   (_UINT32_(0x3F) << TCC_INTENCLR_MC_Pos)              /* (TCC_INTENCLR Mask) MC */
...
#define TCC_INTENSET_MC4_Pos                  _UINT32_(20)                                         /* (TCC_INTENSET) Match or Capture Channel 4 Interrupt Enable Position */
#define TCC_INTENSET_MC4_Msk                  (_UINT32_(0x1) << TCC_INTENSET_MC4_Pos)              /* (TCC_INTENSET) Match or Capture Channel 4 Interrupt Enable Mask */
#define TCC_INTENSET_MC4(value)               (TCC_INTENSET_MC4_Msk & (_UINT32_(value) << TCC_INTENSET_MC4_Pos)) /* Assigment of value for MC4 in the TCC_INTENSET register */
#define TCC_INTENSET_MC5_Pos                  _UINT32_(21)                                         /* (TCC_INTENSET) Match or Capture Channel 5 Interrupt Enable Position */
#define TCC_INTENSET_MC5_Msk                  (_UINT32_(0x1) << TCC_INTENSET_MC5_Pos)              /* (TCC_INTENSET) Match or Capture Channel 5 Interrupt Enable Mask */
#define TCC_INTENSET_MC5(value)               (TCC_INTENSET_MC5_Msk & (_UINT32_(value) << TCC_INTENSET_MC5_Pos)) /* Assigment of value for MC5 in the TCC_INTENSET register */
#define TCC_INTENSET_Msk                      _UINT32_(0x003FFC0F)                                 /* (TCC_INTENSET) Register Mask  */
...
#define TCC_INTENSET_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENSET Position) Match or Capture Channel 5 Interrupt Enable */
#define TCC_INTENSET_MC_Msk                   (_UINT32_(0x3F) << TCC_INTENSET_MC_Pos)              /* (TCC_INTENSET Mask) MC */
...
#define TCC_INTFLAG_MC4_Pos                   _UINT32_(20)                                         /* (TCC_INTFLAG) Match or Capture 4 Position */
#define TCC_INTFLAG_MC4_Msk                   (_UINT32_(0x1) << TCC_INTFLAG_MC4_Pos)               /* (TCC_INTFLAG) Match or Capture 4 Mask */
#define TCC_INTFLAG_MC4(value)                (TCC_INTFLAG_MC4_Msk & (_UINT32_(value) << TCC_INTFLAG_MC4_Pos)) /* Assigment of value for MC4 in the TCC_INTFLAG register */
#define TCC_INTFLAG_MC5_Pos                   _UINT32_(21)                                         /* (TCC_INTFLAG) Match or Capture 5 Position */
#define TCC_INTFLAG_MC5_Msk                   (_UINT32_(0x1) << TCC_INTFLAG_MC5_Pos)               /* (TCC_INTFLAG) Match or Capture 5 Mask */
#define TCC_INTFLAG_MC5(value)                (TCC_INTFLAG_MC5_Msk & (_UINT32_(value) << TCC_INTFLAG_MC5_Pos)) /* Assigment of value for MC5 in the TCC_INTFLAG register */
#define TCC_INTFLAG_Msk                       _UINT32_(0x003FFC0F)                                 /* (TCC_INTFLAG) Register Mask  */
...
#define TCC_INTFLAG_MC_Pos                    _UINT32_(16)                                         /* (TCC_INTFLAG Position) Match or Capture 5 */
...
#define TCC_STATUS_CCBUFV4_Pos                _UINT32_(20)                                         /* (TCC_STATUS) Compare Channel 4 Buffer Valid Position */
#define TCC_STATUS_CCBUFV4_Msk                (_UINT32_(0x1) << TCC_STATUS_CCBUFV4_Pos)            /* (TCC_STATUS) Compare Channel 4 Buffer Valid Mask */
#define TCC_STATUS_CCBUFV4(value)             (TCC_STATUS_CCBUFV4_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV4_Pos)) /* Assigment of value for CCBUFV4 in the TCC_STATUS register */
#define TCC_STATUS_CCBUFV5_Pos                _UINT32_(21)                                         /* (TCC_STATUS) Compare Channel 5 Buffer Valid Position */
#define TCC_STATUS_CCBUFV5_Msk                (_UINT32_(0x1) << TCC_STATUS_CCBUFV5_Pos)            /* (TCC_STATUS) Compare Channel 5 Buffer Valid Mask */
#define TCC_STATUS_CCBUFV5(value)             (TCC_STATUS_CCBUFV5_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV5_Pos)) /* Assigment of value for CCBUFV5 in the TCC_STATUS register */
...
#define TCC_STATUS_CMP4_Pos                   _UINT32_(28)                                         /* (TCC_STATUS) Compare Channel 4 Value Position */
#define TCC_STATUS_CMP4_Msk                   (_UINT32_(0x1) << TCC_STATUS_CMP4_Pos)               /* (TCC_STATUS) Compare Channel 4 Value Mask */
#define TCC_STATUS_CMP4(value)                (TCC_STATUS_CMP4_Msk & (_UINT32_(value) << TCC_STATUS_CMP4_Pos)) /* Assigment of value for CMP4 in the TCC_STATUS register */
#define TCC_STATUS_CMP5_Pos                   _UINT32_(29)                                         /* (TCC_STATUS) Compare Channel 5 Value Position */
#define TCC_STATUS_CMP5_Msk                   (_UINT32_(0x1) << TCC_STATUS_CMP5_Pos)               /* (TCC_STATUS) Compare Channel 5 Value Mask */
#define TCC_STATUS_CMP5(value)                (TCC_STATUS_CMP5_Msk & (_UINT32_(value) << TCC_STATUS_CMP5_Pos)) /* Assigment of value for CMP5 in the TCC_STATUS register */
#define TCC_STATUS_Msk                        _UINT32_(0x3F3FFFBF)                                 /* (TCC_STATUS) Register Mask  */
...
#define TCC_STATUS_CCBUFV_Msk                 (_UINT32_(0x3F) << TCC_STATUS_CCBUFV_Pos)            /* (TCC_STATUS Mask) CCBUFV */
#define TCC_STATUS_CCBUFV(value)              (TCC_STATUS_CCBUFV_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV_Pos)) 
#define TCC_STATUS_CMP_Pos                    _UINT32_(24)                                         /* (TCC_STATUS Position) Compare Channel 5 Value */
...
#define TCC_PATT_Msk                          _UINT16_(0x3F3F)                                     /* (TCC_PATT) Register Mask  */

#define TCC_PATT_PGE_Pos                      _UINT16_(0)                                          /* (TCC_PATT Position) Pattern Generator x Output Enable */
#define TCC_PATT_PGE_Msk                      (_UINT16_(0x3F) << TCC_PATT_PGE_Pos)                 /* (TCC_PATT Mask) PGE */
#define TCC_PATT_PGE(value)                   (TCC_PATT_PGE_Msk & (_UINT16_(value) << TCC_PATT_PGE_Pos)) 
#define TCC_PATT_PGV_Pos                      _UINT16_(8)                                          /* (TCC_PATT Position) Pattern Generator 5 Output Value */
#define TCC_PATT_PGV_Msk                      (_UINT16_(0x3F) << TCC_PATT_PGV_Pos)                 /* (TCC_PATT Mask) PGV */
...
#define TCC_WAVE_POL4_Pos                     _UINT32_(20)                                         /* (TCC_WAVE) Channel 4 Polarity Position */
#define TCC_WAVE_POL4_Msk                     (_UINT32_(0x1) << TCC_WAVE_POL4_Pos)                 /* (TCC_WAVE) Channel 4 Polarity Mask */
#define TCC_WAVE_POL4(value)                  (TCC_WAVE_POL4_Msk & (_UINT32_(value) << TCC_WAVE_POL4_Pos)) /* Assigment of value for POL4 in the TCC_WAVE register */
#define TCC_WAVE_POL5_Pos                     _UINT32_(21)                                         /* (TCC_WAVE) Channel 5 Polarity Position */
#define TCC_WAVE_POL5_Msk                     (_UINT32_(0x1) << TCC_WAVE_POL5_Pos)                 /* (TCC_WAVE) Channel 5 Polarity Mask */
#define TCC_WAVE_POL5(value)                  (TCC_WAVE_POL5_Msk & (_UINT32_(value) << TCC_WAVE_POL5_Pos)) /* Assigment of value for POL5 in the TCC_WAVE register */
