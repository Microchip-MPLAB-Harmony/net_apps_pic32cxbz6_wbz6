...
#ifndef _WBZ65_BLE_COMPONENT_H_
#define _WBZ65_BLE_COMPONENT_H_
...
#define BLE_RFPWRMGMT_xOCLK_EN_CFG(value)     (BLE_RFPWRMGMT_xOCLK_EN_CFG_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_xOCLK_EN_CFG_Pos)) /* Assigment of value for xOCLK_EN_CFG in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_BxTLEN(value)           (BLE_RFPWRMGMT_BxTLEN_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_BxTLEN_Pos)) /* Assigment of value for BxTLEN in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_4(value)       (BLE_RFPWRMGMT_RESERVED_4_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_4_Pos)) /* Assigment of value for RESERVED_4 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_3(value)       (BLE_RFPWRMGMT_RESERVED_3_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_3_Pos)) /* Assigment of value for RESERVED_3 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_BDCLK_POLARITY(value)   (BLE_RFPWRMGMT_BDCLK_POLARITY_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_BDCLK_POLARITY_Pos)) /* Assigment of value for BDCLK_POLARITY in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_BENxOANA(value)         (BLE_RFPWRMGMT_BENxOANA_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_BENxOANA_Pos)) /* Assigment of value for BENxOANA in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_KEEP_ACLB_SPI_ACCESS_ON(value) (BLE_RFPWRMGMT_KEEP_ACLB_SPI_ACCESS_ON_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_KEEP_ACLB_SPI_ACCESS_ON_Pos)) /* Assigment of value for KEEP_ACLB_SPI_ACCESS_ON in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_FW_CONTROLS_MAIN_CLK_GATING(value) (BLE_RFPWRMGMT_FW_CONTROLS_MAIN_CLK_GATING_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_FW_CONTROLS_MAIN_CLK_GATING_Pos)) /* Assigment of value for FW_CONTROLS_MAIN_CLK_GATING in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_MAIN_CLK_EN(value)      (BLE_RFPWRMGMT_MAIN_CLK_EN_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_MAIN_CLK_EN_Pos)) /* Assigment of value for MAIN_CLK_EN in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_2(value)       (BLE_RFPWRMGMT_RESERVED_2_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_2_Pos)) /* Assigment of value for RESERVED_2 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_NO_RF_IDLE(value)       (BLE_RFPWRMGMT_NO_RF_IDLE_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_NO_RF_IDLE_Pos)) /* Assigment of value for NO_RF_IDLE in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_1(value)       (BLE_RFPWRMGMT_RESERVED_1_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_1_Pos)) /* Assigment of value for RESERVED_1 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_7(value)       (BLE_RFPWRMGMT_RESERVED_7_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_7_Pos)) /* Assigment of value for RESERVED_7 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_REG_RF_READ(value)      (BLE_RFPWRMGMT_REG_RF_READ_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_REG_RF_READ_Pos)) /* Assigment of value for REG_RF_READ in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_6(value)       (BLE_RFPWRMGMT_RESERVED_6_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_6_Pos)) /* Assigment of value for RESERVED_6 in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_REG_RF_PROG(value)      (BLE_RFPWRMGMT_REG_RF_PROG_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_REG_RF_PROG_Pos)) /* Assigment of value for REG_RF_PROG in the BLE_RFPWRMGMT register */
...
#define BLE_RFPWRMGMT_RESERVED_5(value)       (BLE_RFPWRMGMT_RESERVED_5_Msk & (_UINT32_(value) << BLE_RFPWRMGMT_RESERVED_5_Pos)) /* Assigment of value for RESERVED_5 in the BLE_RFPWRMGMT register */
