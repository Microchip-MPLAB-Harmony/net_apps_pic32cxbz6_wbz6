...
#ifndef _WBZ65_TC_COMPONENT_H_
#define _WBZ65_TC_COMPONENT_H_
...
#define TC_CTRLA_DMAOS_Pos                    _UINT32_(15)                                         /* (TC_CTRLA) DMA One Shot Position */
#define TC_CTRLA_DMAOS_Msk                    (_UINT32_(0x1) << TC_CTRLA_DMAOS_Pos)                /* (TC_CTRLA) DMA One Shot Mask */
#define TC_CTRLA_DMAOS(value)                 (TC_CTRLA_DMAOS_Msk & (_UINT32_(value) << TC_CTRLA_DMAOS_Pos)) /* Assigment of value for DMAOS in the TC_CTRLA register */
...
#define TC_CTRLA_Msk                          _UINT32_(0x1B338FFF)                                 /* (TC_CTRLA) Register Mask  */
