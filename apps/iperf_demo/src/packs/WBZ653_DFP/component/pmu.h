...
#ifndef _WBZ65_PMU_COMPONENT_H_
#define _WBZ65_PMU_COMPONENT_H_
...
#define PMU_PMUCMODE_SUPFSM(value)            (PMU_PMUCMODE_SUPFSM_Msk & (_UINT32_(value) << PMU_PMUCMODE_SUPFSM_Pos)) /* Assigment of value for SUPFSM in the PMU_PMUCMODE register */
...
#define PMU_PMUCMODE_CVREG2OCTRL(value)       (PMU_PMUCMODE_CVREG2OCTRL_Msk & (_UINT32_(value) << PMU_PMUCMODE_CVREG2OCTRL_Pos)) /* Assigment of value for CVREG2OCTRL in the PMU_PMUCMODE register */
...
#define PMU_WCMCFG_SRAM1_CFG(value)           (PMU_WCMCFG_SRAM1_CFG_Msk & (_UINT32_(value) << PMU_WCMCFG_SRAM1_CFG_Pos)) /* Assigment of value for SRAM1_CFG in the PMU_WCMCFG register */
...
#define PMU_WCMCFG_SRAM2_CFG(value)           (PMU_WCMCFG_SRAM2_CFG_Msk & (_UINT32_(value) << PMU_WCMCFG_SRAM2_CFG_Pos)) /* Assigment of value for SRAM2_CFG in the PMU_WCMCFG register */
...
#define PMU_WCMSIZ_SRAM1_SIZ(value)           (PMU_WCMSIZ_SRAM1_SIZ_Msk & (_UINT32_(value) << PMU_WCMSIZ_SRAM1_SIZ_Pos)) /* Assigment of value for SRAM1_SIZ in the PMU_WCMSIZ register */
