...
#ifndef _WBZ65_RTC_COMPONENT_H_
#define _WBZ65_RTC_COMPONENT_H_
...
#define RTC_MODE0_CTRLA_BKTRST_Pos            _UINT16_(13)                                         /* (RTC_MODE0_CTRLA) BKUP Registers Reset On Tamper Enable Position */
#define RTC_MODE0_CTRLA_BKTRST_Msk            (_UINT16_(0x1) << RTC_MODE0_CTRLA_BKTRST_Pos)        /* (RTC_MODE0_CTRLA) BKUP Registers Reset On Tamper Enable Mask */
#define RTC_MODE0_CTRLA_BKTRST(value)         (RTC_MODE0_CTRLA_BKTRST_Msk & (_UINT16_(value) << RTC_MODE0_CTRLA_BKTRST_Pos)) /* Assigment of value for BKTRST in the RTC_MODE0_CTRLA register */
...
#define RTC_MODE0_CTRLA_Msk                   _UINT16_(0xEF8F)                                     /* (RTC_MODE0_CTRLA) Register Mask  */
...
#define RTC_MODE1_CTRLA_BKTRST_Pos            _UINT16_(13)                                         /* (RTC_MODE1_CTRLA) BKUP Registers Reset On Tamper Enable Position */
#define RTC_MODE1_CTRLA_BKTRST_Msk            (_UINT16_(0x1) << RTC_MODE1_CTRLA_BKTRST_Pos)        /* (RTC_MODE1_CTRLA) BKUP Registers Reset On Tamper Enable Mask */
#define RTC_MODE1_CTRLA_BKTRST(value)         (RTC_MODE1_CTRLA_BKTRST_Msk & (_UINT16_(value) << RTC_MODE1_CTRLA_BKTRST_Pos)) /* Assigment of value for BKTRST in the RTC_MODE1_CTRLA register */
...
#define RTC_MODE1_CTRLA_Msk                   _UINT16_(0xEF0F)                                     /* (RTC_MODE1_CTRLA) Register Mask  */
...
#define RTC_MODE2_CTRLA_BKTRST_Pos            _UINT16_(13)                                         /* (RTC_MODE2_CTRLA) BKUP Registers Reset On Tamper Enable Position */
#define RTC_MODE2_CTRLA_BKTRST_Msk            (_UINT16_(0x1) << RTC_MODE2_CTRLA_BKTRST_Pos)        /* (RTC_MODE2_CTRLA) BKUP Registers Reset On Tamper Enable Mask */
#define RTC_MODE2_CTRLA_BKTRST(value)         (RTC_MODE2_CTRLA_BKTRST_Msk & (_UINT16_(value) << RTC_MODE2_CTRLA_BKTRST_Pos)) /* Assigment of value for BKTRST in the RTC_MODE2_CTRLA register */
...
#define RTC_MODE2_CTRLA_Msk                   _UINT16_(0xEFCF)                                     /* (RTC_MODE2_CTRLA) Register Mask  */
...
#define RTC_MODE0_CTRLB_GP2EN_Pos             _UINT16_(1)                                          /* (RTC_MODE0_CTRLB) General Purpose 2 Enable Position */
#define RTC_MODE0_CTRLB_GP2EN_Msk             (_UINT16_(0x1) << RTC_MODE0_CTRLB_GP2EN_Pos)         /* (RTC_MODE0_CTRLB) General Purpose 2 Enable Mask */
#define RTC_MODE0_CTRLB_GP2EN(value)          (RTC_MODE0_CTRLB_GP2EN_Msk & (_UINT16_(value) << RTC_MODE0_CTRLB_GP2EN_Pos)) /* Assigment of value for GP2EN in the RTC_MODE0_CTRLB register */
...
#define RTC_MODE0_CTRLB_Msk                   _UINT16_(0x77F3)                                     /* (RTC_MODE0_CTRLB) Register Mask  */
...
#define RTC_MODE1_CTRLB_GP2EN_Pos             _UINT16_(1)                                          /* (RTC_MODE1_CTRLB) General Purpose 2 Enable Position */
#define RTC_MODE1_CTRLB_GP2EN_Msk             (_UINT16_(0x1) << RTC_MODE1_CTRLB_GP2EN_Pos)         /* (RTC_MODE1_CTRLB) General Purpose 2 Enable Mask */
#define RTC_MODE1_CTRLB_GP2EN(value)          (RTC_MODE1_CTRLB_GP2EN_Msk & (_UINT16_(value) << RTC_MODE1_CTRLB_GP2EN_Pos)) /* Assigment of value for GP2EN in the RTC_MODE1_CTRLB register */
...
#define RTC_MODE1_CTRLB_Msk                   _UINT16_(0x77F3)                                     /* (RTC_MODE1_CTRLB) Register Mask  */
...
#define RTC_MODE2_CTRLB_GP2EN_Pos             _UINT16_(1)                                          /* (RTC_MODE2_CTRLB) General Purpose 2 Enable Position */
#define RTC_MODE2_CTRLB_GP2EN_Msk             (_UINT16_(0x1) << RTC_MODE2_CTRLB_GP2EN_Pos)         /* (RTC_MODE2_CTRLB) General Purpose 2 Enable Mask */
#define RTC_MODE2_CTRLB_GP2EN(value)          (RTC_MODE2_CTRLB_GP2EN_Msk & (_UINT16_(value) << RTC_MODE2_CTRLB_GP2EN_Pos)) /* Assigment of value for GP2EN in the RTC_MODE2_CTRLB register */
...
#define RTC_MODE2_CTRLB_Msk                   _UINT16_(0x77F3)                                     /* (RTC_MODE2_CTRLB) Register Mask  */
...
#define RTC_MODE0_EVCTRL_CMPEO1_Pos           _UINT32_(9)                                          /* (RTC_MODE0_EVCTRL) Compare 1 Event Output Enable Position */
#define RTC_MODE0_EVCTRL_CMPEO1_Msk           (_UINT32_(0x1) << RTC_MODE0_EVCTRL_CMPEO1_Pos)       /* (RTC_MODE0_EVCTRL) Compare 1 Event Output Enable Mask */
#define RTC_MODE0_EVCTRL_CMPEO1(value)        (RTC_MODE0_EVCTRL_CMPEO1_Msk & (_UINT32_(value) << RTC_MODE0_EVCTRL_CMPEO1_Pos)) /* Assigment of value for CMPEO1 in the RTC_MODE0_EVCTRL register */
...
#define RTC_MODE0_EVCTRL_Msk                  _UINT32_(0x0001C3FF)                                 /* (RTC_MODE0_EVCTRL) Register Mask  */
...
#define RTC_MODE0_EVCTRL_CMPEO_Msk            (_UINT32_(0x3) << RTC_MODE0_EVCTRL_CMPEO_Pos)        /* (RTC_MODE0_EVCTRL Mask) CMPEO */
...
#define RTC_MODE1_EVCTRL_CMPEO2_Pos           _UINT32_(10)                                         /* (RTC_MODE1_EVCTRL) Compare 2 Event Output Enable Position */
#define RTC_MODE1_EVCTRL_CMPEO2_Msk           (_UINT32_(0x1) << RTC_MODE1_EVCTRL_CMPEO2_Pos)       /* (RTC_MODE1_EVCTRL) Compare 2 Event Output Enable Mask */
#define RTC_MODE1_EVCTRL_CMPEO2(value)        (RTC_MODE1_EVCTRL_CMPEO2_Msk & (_UINT32_(value) << RTC_MODE1_EVCTRL_CMPEO2_Pos)) /* Assigment of value for CMPEO2 in the RTC_MODE1_EVCTRL register */
#define RTC_MODE1_EVCTRL_CMPEO3_Pos           _UINT32_(11)                                         /* (RTC_MODE1_EVCTRL) Compare 3 Event Output Enable Position */
#define RTC_MODE1_EVCTRL_CMPEO3_Msk           (_UINT32_(0x1) << RTC_MODE1_EVCTRL_CMPEO3_Pos)       /* (RTC_MODE1_EVCTRL) Compare 3 Event Output Enable Mask */
#define RTC_MODE1_EVCTRL_CMPEO3(value)        (RTC_MODE1_EVCTRL_CMPEO3_Msk & (_UINT32_(value) << RTC_MODE1_EVCTRL_CMPEO3_Pos)) /* Assigment of value for CMPEO3 in the RTC_MODE1_EVCTRL register */
...
#define RTC_MODE1_EVCTRL_Msk                  _UINT32_(0x0001CFFF)                                 /* (RTC_MODE1_EVCTRL) Register Mask  */
...
#define RTC_MODE1_EVCTRL_CMPEO_Msk            (_UINT32_(0xF) << RTC_MODE1_EVCTRL_CMPEO_Pos)        /* (RTC_MODE1_EVCTRL Mask) CMPEO */
...
#define RTC_MODE2_EVCTRL_ALARMEO1_Pos         _UINT32_(9)                                          /* (RTC_MODE2_EVCTRL) Alarm 1 Event Output Enable Position */
#define RTC_MODE2_EVCTRL_ALARMEO1_Msk         (_UINT32_(0x1) << RTC_MODE2_EVCTRL_ALARMEO1_Pos)     /* (RTC_MODE2_EVCTRL) Alarm 1 Event Output Enable Mask */
#define RTC_MODE2_EVCTRL_ALARMEO1(value)      (RTC_MODE2_EVCTRL_ALARMEO1_Msk & (_UINT32_(value) << RTC_MODE2_EVCTRL_ALARMEO1_Pos)) /* Assigment of value for ALARMEO1 in the RTC_MODE2_EVCTRL register */
...
#define RTC_MODE2_EVCTRL_Msk                  _UINT32_(0x0001C3FF)                                 /* (RTC_MODE2_EVCTRL) Register Mask  */
...
#define RTC_MODE0_INTENCLR_CMP1_Pos           _UINT16_(9)                                          /* (RTC_MODE0_INTENCLR) Compare 1 Interrupt Enable Position */
#define RTC_MODE0_INTENCLR_CMP1_Msk           (_UINT16_(0x1) << RTC_MODE0_INTENCLR_CMP1_Pos)       /* (RTC_MODE0_INTENCLR) Compare 1 Interrupt Enable Mask */
#define RTC_MODE0_INTENCLR_CMP1(value)        (RTC_MODE0_INTENCLR_CMP1_Msk & (_UINT16_(value) << RTC_MODE0_INTENCLR_CMP1_Pos)) /* Assigment of value for CMP1 in the RTC_MODE0_INTENCLR register */
...
#define RTC_MODE0_INTENCLR_Msk                _UINT16_(0xC3FF)                                     /* (RTC_MODE0_INTENCLR) Register Mask  */
...
#define RTC_MODE0_INTENCLR_CMP_Msk            (_UINT16_(0x3) << RTC_MODE0_INTENCLR_CMP_Pos)        /* (RTC_MODE0_INTENCLR Mask) CMP */
...
#define RTC_MODE1_INTENCLR_CMP2_Pos           _UINT16_(10)                                         /* (RTC_MODE1_INTENCLR) Compare 2 Interrupt Enable Position */
#define RTC_MODE1_INTENCLR_CMP2_Msk           (_UINT16_(0x1) << RTC_MODE1_INTENCLR_CMP2_Pos)       /* (RTC_MODE1_INTENCLR) Compare 2 Interrupt Enable Mask */
#define RTC_MODE1_INTENCLR_CMP2(value)        (RTC_MODE1_INTENCLR_CMP2_Msk & (_UINT16_(value) << RTC_MODE1_INTENCLR_CMP2_Pos)) /* Assigment of value for CMP2 in the RTC_MODE1_INTENCLR register */
#define RTC_MODE1_INTENCLR_CMP3_Pos           _UINT16_(11)                                         /* (RTC_MODE1_INTENCLR) Compare 3 Interrupt Enable Position */
#define RTC_MODE1_INTENCLR_CMP3_Msk           (_UINT16_(0x1) << RTC_MODE1_INTENCLR_CMP3_Pos)       /* (RTC_MODE1_INTENCLR) Compare 3 Interrupt Enable Mask */
#define RTC_MODE1_INTENCLR_CMP3(value)        (RTC_MODE1_INTENCLR_CMP3_Msk & (_UINT16_(value) << RTC_MODE1_INTENCLR_CMP3_Pos)) /* Assigment of value for CMP3 in the RTC_MODE1_INTENCLR register */
...
#define RTC_MODE1_INTENCLR_Msk                _UINT16_(0xCFFF)                                     /* (RTC_MODE1_INTENCLR) Register Mask  */
...
#define RTC_MODE1_INTENCLR_CMP_Msk            (_UINT16_(0xF) << RTC_MODE1_INTENCLR_CMP_Pos)        /* (RTC_MODE1_INTENCLR Mask) CMP */
...
#define RTC_MODE2_INTENCLR_ALARM1_Pos         _UINT16_(9)                                          /* (RTC_MODE2_INTENCLR) Alarm 1 Interrupt Enable Position */
#define RTC_MODE2_INTENCLR_ALARM1_Msk         (_UINT16_(0x1) << RTC_MODE2_INTENCLR_ALARM1_Pos)     /* (RTC_MODE2_INTENCLR) Alarm 1 Interrupt Enable Mask */
#define RTC_MODE2_INTENCLR_ALARM1(value)      (RTC_MODE2_INTENCLR_ALARM1_Msk & (_UINT16_(value) << RTC_MODE2_INTENCLR_ALARM1_Pos)) /* Assigment of value for ALARM1 in the RTC_MODE2_INTENCLR register */
...
#define RTC_MODE2_INTENCLR_Msk                _UINT16_(0xC3FF)                                     /* (RTC_MODE2_INTENCLR) Register Mask  */
...
#define RTC_MODE2_INTENCLR_ALARM_Msk          (_UINT16_(0x3) << RTC_MODE2_INTENCLR_ALARM_Pos)      /* (RTC_MODE2_INTENCLR Mask) ALARM */
...
#define RTC_MODE0_INTENSET_CMP1_Pos           _UINT16_(9)                                          /* (RTC_MODE0_INTENSET) Compare 1 Interrupt Enable Position */
#define RTC_MODE0_INTENSET_CMP1_Msk           (_UINT16_(0x1) << RTC_MODE0_INTENSET_CMP1_Pos)       /* (RTC_MODE0_INTENSET) Compare 1 Interrupt Enable Mask */
#define RTC_MODE0_INTENSET_CMP1(value)        (RTC_MODE0_INTENSET_CMP1_Msk & (_UINT16_(value) << RTC_MODE0_INTENSET_CMP1_Pos)) /* Assigment of value for CMP1 in the RTC_MODE0_INTENSET register */
...
#define RTC_MODE0_INTENSET_Msk                _UINT16_(0xC3FF)                                     /* (RTC_MODE0_INTENSET) Register Mask  */
...
#define RTC_MODE0_INTENSET_CMP_Msk            (_UINT16_(0x3) << RTC_MODE0_INTENSET_CMP_Pos)        /* (RTC_MODE0_INTENSET Mask) CMP */
...
#define RTC_MODE1_INTENSET_CMP2_Pos           _UINT16_(10)                                         /* (RTC_MODE1_INTENSET) Compare 2 Interrupt Enable Position */
#define RTC_MODE1_INTENSET_CMP2_Msk           (_UINT16_(0x1) << RTC_MODE1_INTENSET_CMP2_Pos)       /* (RTC_MODE1_INTENSET) Compare 2 Interrupt Enable Mask */
#define RTC_MODE1_INTENSET_CMP2(value)        (RTC_MODE1_INTENSET_CMP2_Msk & (_UINT16_(value) << RTC_MODE1_INTENSET_CMP2_Pos)) /* Assigment of value for CMP2 in the RTC_MODE1_INTENSET register */
#define RTC_MODE1_INTENSET_CMP3_Pos           _UINT16_(11)                                         /* (RTC_MODE1_INTENSET) Compare 3 Interrupt Enable Position */
#define RTC_MODE1_INTENSET_CMP3_Msk           (_UINT16_(0x1) << RTC_MODE1_INTENSET_CMP3_Pos)       /* (RTC_MODE1_INTENSET) Compare 3 Interrupt Enable Mask */
#define RTC_MODE1_INTENSET_CMP3(value)        (RTC_MODE1_INTENSET_CMP3_Msk & (_UINT16_(value) << RTC_MODE1_INTENSET_CMP3_Pos)) /* Assigment of value for CMP3 in the RTC_MODE1_INTENSET register */
...
#define RTC_MODE1_INTENSET_Msk                _UINT16_(0xCFFF)                                     /* (RTC_MODE1_INTENSET) Register Mask  */
...
#define RTC_MODE1_INTENSET_CMP_Msk            (_UINT16_(0xF) << RTC_MODE1_INTENSET_CMP_Pos)        /* (RTC_MODE1_INTENSET Mask) CMP */
...
#define RTC_MODE2_INTENSET_ALARM1_Pos         _UINT16_(9)                                          /* (RTC_MODE2_INTENSET) Alarm 1 Interrupt Enable Position */
#define RTC_MODE2_INTENSET_ALARM1_Msk         (_UINT16_(0x1) << RTC_MODE2_INTENSET_ALARM1_Pos)     /* (RTC_MODE2_INTENSET) Alarm 1 Interrupt Enable Mask */
#define RTC_MODE2_INTENSET_ALARM1(value)      (RTC_MODE2_INTENSET_ALARM1_Msk & (_UINT16_(value) << RTC_MODE2_INTENSET_ALARM1_Pos)) /* Assigment of value for ALARM1 in the RTC_MODE2_INTENSET register */
...
#define RTC_MODE2_INTENSET_Msk                _UINT16_(0xC3FF)                                     /* (RTC_MODE2_INTENSET) Register Mask  */
...
#define RTC_MODE2_INTENSET_ALARM_Msk          (_UINT16_(0x3) << RTC_MODE2_INTENSET_ALARM_Pos)      /* (RTC_MODE2_INTENSET Mask) ALARM */
...
#define RTC_MODE0_INTFLAG_CMP1_Msk            (_UINT16_(0x1) << RTC_MODE0_INTFLAG_CMP1_Pos)        /* (RTC_MODE0_INTFLAG) Compare 1 Mask */
#define RTC_MODE0_INTFLAG_CMP1(value)         (RTC_MODE0_INTFLAG_CMP1_Msk & (_UINT16_(value) << RTC_MODE0_INTFLAG_CMP1_Pos)) /* Assigment of value for CMP1 in the RTC_MODE0_INTFLAG register */
...
#define RTC_MODE0_INTFLAG_Msk                 _UINT16_(0xC3FF)                                     /* (RTC_MODE0_INTFLAG) Register Mask  */
...
#define RTC_MODE0_INTFLAG_CMP_Msk             (_UINT16_(0x3) << RTC_MODE0_INTFLAG_CMP_Pos)         /* (RTC_MODE0_INTFLAG Mask) CMP */
...
#define RTC_MODE1_INTFLAG_CMP2_Pos            _UINT16_(10)                                         /* (RTC_MODE1_INTFLAG) Compare 2 Position */
#define RTC_MODE1_INTFLAG_CMP2_Msk            (_UINT16_(0x1) << RTC_MODE1_INTFLAG_CMP2_Pos)        /* (RTC_MODE1_INTFLAG) Compare 2 Mask */
#define RTC_MODE1_INTFLAG_CMP2(value)         (RTC_MODE1_INTFLAG_CMP2_Msk & (_UINT16_(value) << RTC_MODE1_INTFLAG_CMP2_Pos)) /* Assigment of value for CMP2 in the RTC_MODE1_INTFLAG register */
#define RTC_MODE1_INTFLAG_CMP3_Pos            _UINT16_(11)                                         /* (RTC_MODE1_INTFLAG) Compare 3 Position */
#define RTC_MODE1_INTFLAG_CMP3_Msk            (_UINT16_(0x1) << RTC_MODE1_INTFLAG_CMP3_Pos)        /* (RTC_MODE1_INTFLAG) Compare 3 Mask */
#define RTC_MODE1_INTFLAG_CMP3(value)         (RTC_MODE1_INTFLAG_CMP3_Msk & (_UINT16_(value) << RTC_MODE1_INTFLAG_CMP3_Pos)) /* Assigment of value for CMP3 in the RTC_MODE1_INTFLAG register */
...
#define RTC_MODE1_INTFLAG_Msk                 _UINT16_(0xCFFF)                                     /* (RTC_MODE1_INTFLAG) Register Mask  */
...
#define RTC_MODE1_INTFLAG_CMP_Msk             (_UINT16_(0xF) << RTC_MODE1_INTFLAG_CMP_Pos)         /* (RTC_MODE1_INTFLAG Mask) CMP */
...
#define RTC_MODE2_INTFLAG_ALARM1_Pos          _UINT16_(9)                                          /* (RTC_MODE2_INTFLAG) Alarm 1 Position */
#define RTC_MODE2_INTFLAG_ALARM1_Msk          (_UINT16_(0x1) << RTC_MODE2_INTFLAG_ALARM1_Pos)      /* (RTC_MODE2_INTFLAG) Alarm 1 Mask */
#define RTC_MODE2_INTFLAG_ALARM1(value)       (RTC_MODE2_INTFLAG_ALARM1_Msk & (_UINT16_(value) << RTC_MODE2_INTFLAG_ALARM1_Pos)) /* Assigment of value for ALARM1 in the RTC_MODE2_INTFLAG register */
...
#define RTC_MODE2_INTFLAG_Msk                 _UINT16_(0xC3FF)                                     /* (RTC_MODE2_INTFLAG) Register Mask  */
...
#define RTC_MODE0_SYNCBUSY_COMP1_Pos          _UINT32_(6)                                          /* (RTC_MODE0_SYNCBUSY) COMP 1 Register Busy Position */
#define RTC_MODE0_SYNCBUSY_COMP1_Msk          (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_COMP1_Pos)      /* (RTC_MODE0_SYNCBUSY) COMP 1 Register Busy Mask */
#define RTC_MODE0_SYNCBUSY_COMP1(value)       (RTC_MODE0_SYNCBUSY_COMP1_Msk & (_UINT32_(value) << RTC_MODE0_SYNCBUSY_COMP1_Pos)) /* Assigment of value for COMP1 in the RTC_MODE0_SYNCBUSY register */
...
#define RTC_MODE0_SYNCBUSY_GP2_Pos            _UINT32_(18)                                         /* (RTC_MODE0_SYNCBUSY) General Purpose 2 Register Busy Position */
#define RTC_MODE0_SYNCBUSY_GP2_Msk            (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_GP2_Pos)        /* (RTC_MODE0_SYNCBUSY) General Purpose 2 Register Busy Mask */
#define RTC_MODE0_SYNCBUSY_GP2(value)         (RTC_MODE0_SYNCBUSY_GP2_Msk & (_UINT32_(value) << RTC_MODE0_SYNCBUSY_GP2_Pos)) /* Assigment of value for GP2 in the RTC_MODE0_SYNCBUSY register */
#define RTC_MODE0_SYNCBUSY_GP3_Pos            _UINT32_(19)                                         /* (RTC_MODE0_SYNCBUSY) General Purpose 3 Register Busy Position */
#define RTC_MODE0_SYNCBUSY_GP3_Msk            (_UINT32_(0x1) << RTC_MODE0_SYNCBUSY_GP3_Pos)        /* (RTC_MODE0_SYNCBUSY) General Purpose 3 Register Busy Mask */
#define RTC_MODE0_SYNCBUSY_GP3(value)         (RTC_MODE0_SYNCBUSY_GP3_Msk & (_UINT32_(value) << RTC_MODE0_SYNCBUSY_GP3_Pos)) /* Assigment of value for GP3 in the RTC_MODE0_SYNCBUSY register */
#define RTC_MODE0_SYNCBUSY_Msk                _UINT32_(0x000F806F)                                 /* (RTC_MODE0_SYNCBUSY) Register Mask  */

#define RTC_MODE0_SYNCBUSY_COMP_Pos           _UINT32_(5)                                          /* (RTC_MODE0_SYNCBUSY Position) COMP x Register Busy */
#define RTC_MODE0_SYNCBUSY_COMP_Msk           (_UINT32_(0x3) << RTC_MODE0_SYNCBUSY_COMP_Pos)       /* (RTC_MODE0_SYNCBUSY Mask) COMP */
#define RTC_MODE0_SYNCBUSY_COMP(value)        (RTC_MODE0_SYNCBUSY_COMP_Msk & (_UINT32_(value) << RTC_MODE0_SYNCBUSY_COMP_Pos)) 
#define RTC_MODE0_SYNCBUSY_GP_Pos             _UINT32_(16)                                         /* (RTC_MODE0_SYNCBUSY Position) General Purpose 3 Register Busy */
#define RTC_MODE0_SYNCBUSY_GP_Msk             (_UINT32_(0xF) << RTC_MODE0_SYNCBUSY_GP_Pos)         /* (RTC_MODE0_SYNCBUSY Mask) GP */
...
#define RTC_MODE1_SYNCBUSY_COMP2_Pos          _UINT32_(7)                                          /* (RTC_MODE1_SYNCBUSY) COMP 2 Register Busy Position */
#define RTC_MODE1_SYNCBUSY_COMP2_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COMP2_Pos)      /* (RTC_MODE1_SYNCBUSY) COMP 2 Register Busy Mask */
#define RTC_MODE1_SYNCBUSY_COMP2(value)       (RTC_MODE1_SYNCBUSY_COMP2_Msk & (_UINT32_(value) << RTC_MODE1_SYNCBUSY_COMP2_Pos)) /* Assigment of value for COMP2 in the RTC_MODE1_SYNCBUSY register */
#define RTC_MODE1_SYNCBUSY_COMP3_Pos          _UINT32_(8)                                          /* (RTC_MODE1_SYNCBUSY) COMP 3 Register Busy Position */
#define RTC_MODE1_SYNCBUSY_COMP3_Msk          (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_COMP3_Pos)      /* (RTC_MODE1_SYNCBUSY) COMP 3 Register Busy Mask */
#define RTC_MODE1_SYNCBUSY_COMP3(value)       (RTC_MODE1_SYNCBUSY_COMP3_Msk & (_UINT32_(value) << RTC_MODE1_SYNCBUSY_COMP3_Pos)) /* Assigment of value for COMP3 in the RTC_MODE1_SYNCBUSY register */
...
#define RTC_MODE1_SYNCBUSY_GP2_Pos            _UINT32_(18)                                         /* (RTC_MODE1_SYNCBUSY) General Purpose 2 Register Busy Position */
#define RTC_MODE1_SYNCBUSY_GP2_Msk            (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_GP2_Pos)        /* (RTC_MODE1_SYNCBUSY) General Purpose 2 Register Busy Mask */
#define RTC_MODE1_SYNCBUSY_GP2(value)         (RTC_MODE1_SYNCBUSY_GP2_Msk & (_UINT32_(value) << RTC_MODE1_SYNCBUSY_GP2_Pos)) /* Assigment of value for GP2 in the RTC_MODE1_SYNCBUSY register */
#define RTC_MODE1_SYNCBUSY_GP3_Pos            _UINT32_(19)                                         /* (RTC_MODE1_SYNCBUSY) General Purpose 3 Register Busy Position */
#define RTC_MODE1_SYNCBUSY_GP3_Msk            (_UINT32_(0x1) << RTC_MODE1_SYNCBUSY_GP3_Pos)        /* (RTC_MODE1_SYNCBUSY) General Purpose 3 Register Busy Mask */
#define RTC_MODE1_SYNCBUSY_GP3(value)         (RTC_MODE1_SYNCBUSY_GP3_Msk & (_UINT32_(value) << RTC_MODE1_SYNCBUSY_GP3_Pos)) /* Assigment of value for GP3 in the RTC_MODE1_SYNCBUSY register */
#define RTC_MODE1_SYNCBUSY_Msk                _UINT32_(0x000F81FF)                                 /* (RTC_MODE1_SYNCBUSY) Register Mask  */

#define RTC_MODE1_SYNCBUSY_COMP_Pos           _UINT32_(5)                                          /* (RTC_MODE1_SYNCBUSY Position) COMP x Register Busy */
#define RTC_MODE1_SYNCBUSY_COMP_Msk           (_UINT32_(0xF) << RTC_MODE1_SYNCBUSY_COMP_Pos)       /* (RTC_MODE1_SYNCBUSY Mask) COMP */
#define RTC_MODE1_SYNCBUSY_COMP(value)        (RTC_MODE1_SYNCBUSY_COMP_Msk & (_UINT32_(value) << RTC_MODE1_SYNCBUSY_COMP_Pos)) 
#define RTC_MODE1_SYNCBUSY_GP_Pos             _UINT32_(16)                                         /* (RTC_MODE1_SYNCBUSY Position) General Purpose 3 Register Busy */
#define RTC_MODE1_SYNCBUSY_GP_Msk             (_UINT32_(0xF) << RTC_MODE1_SYNCBUSY_GP_Pos)         /* (RTC_MODE1_SYNCBUSY Mask) GP */
...
#define RTC_MODE2_SYNCBUSY_ALARM1_Pos         _UINT32_(6)                                          /* (RTC_MODE2_SYNCBUSY) ALARM 1 Register Busy Position */
#define RTC_MODE2_SYNCBUSY_ALARM1_Msk         (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_ALARM1_Pos)     /* (RTC_MODE2_SYNCBUSY) ALARM 1 Register Busy Mask */
#define RTC_MODE2_SYNCBUSY_ALARM1(value)      (RTC_MODE2_SYNCBUSY_ALARM1_Msk & (_UINT32_(value) << RTC_MODE2_SYNCBUSY_ALARM1_Pos)) /* Assigment of value for ALARM1 in the RTC_MODE2_SYNCBUSY register */
...
#define RTC_MODE2_SYNCBUSY_MASK1_Pos          _UINT32_(12)                                         /* (RTC_MODE2_SYNCBUSY) MASK 1 Register Busy Position */
#define RTC_MODE2_SYNCBUSY_MASK1_Msk          (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_MASK1_Pos)      /* (RTC_MODE2_SYNCBUSY) MASK 1 Register Busy Mask */
#define RTC_MODE2_SYNCBUSY_MASK1(value)       (RTC_MODE2_SYNCBUSY_MASK1_Msk & (_UINT32_(value) << RTC_MODE2_SYNCBUSY_MASK1_Pos)) /* Assigment of value for MASK1 in the RTC_MODE2_SYNCBUSY register */
...
#define RTC_MODE2_SYNCBUSY_GP2_Pos            _UINT32_(18)                                         /* (RTC_MODE2_SYNCBUSY) General Purpose 2 Register Busy Position */
#define RTC_MODE2_SYNCBUSY_GP2_Msk            (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_GP2_Pos)        /* (RTC_MODE2_SYNCBUSY) General Purpose 2 Register Busy Mask */
#define RTC_MODE2_SYNCBUSY_GP2(value)         (RTC_MODE2_SYNCBUSY_GP2_Msk & (_UINT32_(value) << RTC_MODE2_SYNCBUSY_GP2_Pos)) /* Assigment of value for GP2 in the RTC_MODE2_SYNCBUSY register */
#define RTC_MODE2_SYNCBUSY_GP3_Pos            _UINT32_(19)                                         /* (RTC_MODE2_SYNCBUSY) General Purpose 3 Register Busy Position */
#define RTC_MODE2_SYNCBUSY_GP3_Msk            (_UINT32_(0x1) << RTC_MODE2_SYNCBUSY_GP3_Pos)        /* (RTC_MODE2_SYNCBUSY) General Purpose 3 Register Busy Mask */
#define RTC_MODE2_SYNCBUSY_GP3(value)         (RTC_MODE2_SYNCBUSY_GP3_Msk & (_UINT32_(value) << RTC_MODE2_SYNCBUSY_GP3_Pos)) /* Assigment of value for GP3 in the RTC_MODE2_SYNCBUSY register */
#define RTC_MODE2_SYNCBUSY_Msk                _UINT32_(0x000F986F)                                 /* (RTC_MODE2_SYNCBUSY) Register Mask  */

#define RTC_MODE2_SYNCBUSY_ALARM_Pos          _UINT32_(5)                                          /* (RTC_MODE2_SYNCBUSY Position) ALARM x Register Busy */
#define RTC_MODE2_SYNCBUSY_ALARM_Msk          (_UINT32_(0x3) << RTC_MODE2_SYNCBUSY_ALARM_Pos)      /* (RTC_MODE2_SYNCBUSY Mask) ALARM */
...
#define RTC_MODE2_SYNCBUSY_MASK_Msk           (_UINT32_(0x3) << RTC_MODE2_SYNCBUSY_MASK_Pos)       /* (RTC_MODE2_SYNCBUSY Mask) MASK */
#define RTC_MODE2_SYNCBUSY_MASK(value)        (RTC_MODE2_SYNCBUSY_MASK_Msk & (_UINT32_(value) << RTC_MODE2_SYNCBUSY_MASK_Pos)) 
#define RTC_MODE2_SYNCBUSY_GP_Pos             _UINT32_(16)                                         /* (RTC_MODE2_SYNCBUSY Position) General Purpose 3 Register Busy */
...
#define   RTC_MODE2_ALARM0_HOUR_AM_Val        _UINT32_(0x0)                                        /* (RTC_MODE2_ALARM0) Morning hour  */
#define   RTC_MODE2_ALARM0_HOUR_PM_Val        _UINT32_(0x10)                                       /* (RTC_MODE2_ALARM0) Afternoon hour  */
...
#define RTC_MODE2_MASK0_RESETVALUE            _UINT8_(0x00)                                        /*  (RTC_MODE2_MASK0) MODE2_ALARM Alarm n Mask  Reset Value */
...
#define RTC_MODE2_ALARM1_RESETVALUE           _UINT32_(0x00)                                       /*  (RTC_MODE2_ALARM1) MODE2_ALARM Alarm n Value  Reset Value */

#define RTC_MODE2_ALARM1_SECOND_Pos           _UINT32_(0)                                          /* (RTC_MODE2_ALARM1) Second Position */
#define RTC_MODE2_ALARM1_SECOND_Msk           (_UINT32_(0x3F) << RTC_MODE2_ALARM1_SECOND_Pos)      /* (RTC_MODE2_ALARM1) Second Mask */
#define RTC_MODE2_ALARM1_SECOND(value)        (RTC_MODE2_ALARM1_SECOND_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_SECOND_Pos)) /* Assigment of value for SECOND in the RTC_MODE2_ALARM1 register */
#define RTC_MODE2_ALARM1_MINUTE_Pos           _UINT32_(6)                                          /* (RTC_MODE2_ALARM1) Minute Position */
#define RTC_MODE2_ALARM1_MINUTE_Msk           (_UINT32_(0x3F) << RTC_MODE2_ALARM1_MINUTE_Pos)      /* (RTC_MODE2_ALARM1) Minute Mask */
#define RTC_MODE2_ALARM1_MINUTE(value)        (RTC_MODE2_ALARM1_MINUTE_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_MINUTE_Pos)) /* Assigment of value for MINUTE in the RTC_MODE2_ALARM1 register */
#define RTC_MODE2_ALARM1_HOUR_Pos             _UINT32_(12)                                         /* (RTC_MODE2_ALARM1) Hour Position */
#define RTC_MODE2_ALARM1_HOUR_Msk             (_UINT32_(0x1F) << RTC_MODE2_ALARM1_HOUR_Pos)        /* (RTC_MODE2_ALARM1) Hour Mask */
#define RTC_MODE2_ALARM1_HOUR(value)          (RTC_MODE2_ALARM1_HOUR_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_HOUR_Pos)) /* Assigment of value for HOUR in the RTC_MODE2_ALARM1 register */
#define   RTC_MODE2_ALARM1_HOUR_AM_Val        _UINT32_(0x0)                                        /* (RTC_MODE2_ALARM1) Morning hour  */
#define   RTC_MODE2_ALARM1_HOUR_PM_Val        _UINT32_(0x10)                                       /* (RTC_MODE2_ALARM1) Afternoon hour  */
...
#define RTC_MODE2_ALARM1_DAY_Pos              _UINT32_(17)                                         /* (RTC_MODE2_ALARM1) Day Position */
#define RTC_MODE2_ALARM1_DAY_Msk              (_UINT32_(0x1F) << RTC_MODE2_ALARM1_DAY_Pos)         /* (RTC_MODE2_ALARM1) Day Mask */
#define RTC_MODE2_ALARM1_DAY(value)           (RTC_MODE2_ALARM1_DAY_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_DAY_Pos)) /* Assigment of value for DAY in the RTC_MODE2_ALARM1 register */
#define RTC_MODE2_ALARM1_MONTH_Pos            _UINT32_(22)                                         /* (RTC_MODE2_ALARM1) Month Position */
#define RTC_MODE2_ALARM1_MONTH_Msk            (_UINT32_(0xF) << RTC_MODE2_ALARM1_MONTH_Pos)        /* (RTC_MODE2_ALARM1) Month Mask */
#define RTC_MODE2_ALARM1_MONTH(value)         (RTC_MODE2_ALARM1_MONTH_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_MONTH_Pos)) /* Assigment of value for MONTH in the RTC_MODE2_ALARM1 register */
#define RTC_MODE2_ALARM1_YEAR_Pos             _UINT32_(26)                                         /* (RTC_MODE2_ALARM1) Year Position */
#define RTC_MODE2_ALARM1_YEAR_Msk             (_UINT32_(0x3F) << RTC_MODE2_ALARM1_YEAR_Pos)        /* (RTC_MODE2_ALARM1) Year Mask */
#define RTC_MODE2_ALARM1_YEAR(value)          (RTC_MODE2_ALARM1_YEAR_Msk & (_UINT32_(value) << RTC_MODE2_ALARM1_YEAR_Pos)) /* Assigment of value for YEAR in the RTC_MODE2_ALARM1 register */
#define RTC_MODE2_ALARM1_Msk                  _UINT32_(0xFFFFFFFF)                                 /* (RTC_MODE2_ALARM1) Register Mask  */


/* -------- RTC_MODE2_MASK1 : (RTC Offset: 0x2C) (R/W 8) MODE2_ALARM Alarm n Mask -------- */
#define RTC_MODE2_MASK1_RESETVALUE            _UINT8_(0x00)                                        /*  (RTC_MODE2_MASK1) MODE2_ALARM Alarm n Mask  Reset Value */

#define RTC_MODE2_MASK1_SEL_Pos               _UINT8_(0)                                           /* (RTC_MODE2_MASK1) Alarm Mask Selection Position */
#define RTC_MODE2_MASK1_SEL_Msk               (_UINT8_(0x7) << RTC_MODE2_MASK1_SEL_Pos)            /* (RTC_MODE2_MASK1) Alarm Mask Selection Mask */
#define RTC_MODE2_MASK1_SEL(value)            (RTC_MODE2_MASK1_SEL_Msk & (_UINT8_(value) << RTC_MODE2_MASK1_SEL_Pos)) /* Assigment of value for SEL in the RTC_MODE2_MASK1 register */
#define   RTC_MODE2_MASK1_SEL_OFF_Val         _UINT8_(0x0)                                         /* (RTC_MODE2_MASK1) Alarm Disabled  */
#define   RTC_MODE2_MASK1_SEL_SS_Val          _UINT8_(0x1)                                         /* (RTC_MODE2_MASK1) Match seconds only  */
#define   RTC_MODE2_MASK1_SEL_MMSS_Val        _UINT8_(0x2)                                         /* (RTC_MODE2_MASK1) Match seconds and minutes only  */
#define   RTC_MODE2_MASK1_SEL_HHMMSS_Val      _UINT8_(0x3)                                         /* (RTC_MODE2_MASK1) Match seconds, minutes, and hours only  */
#define   RTC_MODE2_MASK1_SEL_DDHHMMSS_Val    _UINT8_(0x4)                                         /* (RTC_MODE2_MASK1) Match seconds, minutes, hours, and days only  */
#define   RTC_MODE2_MASK1_SEL_MMDDHHMMSS_Val  _UINT8_(0x5)                                         /* (RTC_MODE2_MASK1) Match seconds, minutes, hours, days, and months only  */
#define   RTC_MODE2_MASK1_SEL_YYMMDDHHMMSS_Val _UINT8_(0x6)                                         /* (RTC_MODE2_MASK1) Match seconds, minutes, hours, days, months, and years  */
...
#define   RTC_TAMPCTRL_IN0ACT_WAKE_Val        _UINT32_(0x1)                                        /* (RTC_TAMPCTRL) Wake without timestamp  */
#define   RTC_TAMPCTRL_IN0ACT_CAPTURE_Val     _UINT32_(0x2)                                        /* (RTC_TAMPCTRL) Capture timestamp  */
#define   RTC_TAMPCTRL_IN0ACT_ACTL_Val        _UINT32_(0x3)                                        /* (RTC_TAMPCTRL) Compare IN0 to OUT  */
...
#define   RTC_TAMPCTRL_IN1ACT_CAPTURE_Val     _UINT32_(0x2)                                        /* (RTC_TAMPCTRL) Capture timestamp  */
#define   RTC_TAMPCTRL_IN1ACT_ACTL_Val        _UINT32_(0x3)                                        /* (RTC_TAMPCTRL) Compare IN1 to OUT  */
...
#define   RTC_TAMPCTRL_IN2ACT_WAKE_Val        _UINT32_(0x1)                                        /* (RTC_TAMPCTRL) Wake without timestamp  */
#define   RTC_TAMPCTRL_IN2ACT_CAPTURE_Val     _UINT32_(0x2)                                        /* (RTC_TAMPCTRL) Capture timestamp  */
#define   RTC_TAMPCTRL_IN2ACT_ACTL_Val        _UINT32_(0x3)                                        /* (RTC_TAMPCTRL) Compare IN2 to OUT  */
...
#define   RTC_TAMPCTRL_IN3ACT_WAKE_Val        _UINT32_(0x1)                                        /* (RTC_TAMPCTRL) Wake without timestamp  */
#define   RTC_TAMPCTRL_IN3ACT_CAPTURE_Val     _UINT32_(0x2)                                        /* (RTC_TAMPCTRL) Capture timestamp  */
#define   RTC_TAMPCTRL_IN3ACT_ACTL_Val        _UINT32_(0x3)                                        /* (RTC_TAMPCTRL) Compare IN3 to OUT  */
...
#define RTC_TAMPCTRL_Msk                      _UINT32_(0x0F0F00FF)                                 /* (RTC_TAMPCTRL) Register Mask  */

#define RTC_TAMPCTRL_TAMLVL_Pos               _UINT32_(16)                                         /* (RTC_TAMPCTRL Position) Tamper Level Select x */
#define RTC_TAMPCTRL_TAMLVL_Msk               (_UINT32_(0xF) << RTC_TAMPCTRL_TAMLVL_Pos)           /* (RTC_TAMPCTRL Mask) TAMLVL */
#define RTC_TAMPCTRL_TAMLVL(value)            (RTC_TAMPCTRL_TAMLVL_Msk & (_UINT32_(value) << RTC_TAMPCTRL_TAMLVL_Pos)) 
#define RTC_TAMPCTRL_DEBNC_Pos                _UINT32_(24)                                         /* (RTC_TAMPCTRL Position) Debouncer Enable 3 */
#define RTC_TAMPCTRL_DEBNC_Msk                (_UINT32_(0xF) << RTC_TAMPCTRL_DEBNC_Pos)            /* (RTC_TAMPCTRL Mask) DEBNC */
...
#define   RTC_MODE2_TIMESTAMP_HOUR_AM_Val     _UINT32_(0x0)                                        /* (RTC_MODE2_TIMESTAMP) AM when CLKREP in 12-hour  */
#define   RTC_MODE2_TIMESTAMP_HOUR_PM_Val     _UINT32_(0x10)                                       /* (RTC_MODE2_TIMESTAMP) PM when CLKREP in 12-hour  */
...
#define RTC_TAMPID_Msk                        _UINT32_(0x8000000F)                                 /* (RTC_TAMPID) Register Mask  */

#define RTC_TAMPID_TAMPID_Pos                 _UINT32_(0)                                          /* (RTC_TAMPID Position) Tamper Input x Detected */
#define RTC_TAMPID_TAMPID_Msk                 (_UINT32_(0xF) << RTC_TAMPID_TAMPID_Pos)             /* (RTC_TAMPID Mask) TAMPID */
...
#define RTC_BKUP_RESETVALUE                   _UINT32_(0x00)                                       /*  (RTC_BKUP) Backup  Reset Value */

#define RTC_BKUP_BKUP_Pos                     _UINT32_(0)                                          /* (RTC_BKUP) Backup Position */
#define RTC_BKUP_BKUP_Msk                     (_UINT32_(0xFFFFFFFF) << RTC_BKUP_BKUP_Pos)          /* (RTC_BKUP) Backup Mask */
#define RTC_BKUP_BKUP(value)                  (RTC_BKUP_BKUP_Msk & (_UINT32_(value) << RTC_BKUP_BKUP_Pos)) /* Assigment of value for BKUP in the RTC_BKUP register */
#define RTC_BKUP_Msk                          _UINT32_(0xFFFFFFFF)                                 /* (RTC_BKUP) Register Mask  */
...
#define RTC_BKUP_REG_OFST              _UINT32_(0x80)      /* (RTC_BKUP) Backup Offset */
#define RTC_BKUP0_REG_OFST             _UINT32_(0x80)      /* (RTC_BKUP0) Backup Offset */
...
{  /* Real-Time Counter */
  ...
  __IO  uint32_t                       RTC_BKUP[1];        /**< Offset: 0x80 (R/W  32) Backup */
