...
#ifndef _WBZ65_FUSES_COMPONENT_H_
#define _WBZ65_FUSES_COMPONENT_H_
...
#define FUSES_ALTDEVCFG1_RESETVALUE           _UINT32_(0x1400403B)                                 /*  (FUSES_ALTDEVCFG1) ALT CFGCON1 Fuses  Reset Value */
...
#define FUSES_ALTDEVCFG0_RESETVALUE           _UINT32_(0x7960000B)                                 /*  (FUSES_ALTDEVCFG0) ALT CFGCON0 Fuses  Reset Value */
...
#define FUSES_ALTFBCFG0_RESETVALUE            _UINT32_(0x02)                                       /*  (FUSES_ALTFBCFG0) ALT NVR BCFG0  Reset Value */
...
#define FUSES_FUSERID_USER_ID_Pos             _UINT32_(0)                                          /* (FUSES_FUSERID) User unique ID, readable using the SWD USER_ID instruction Position */
#define FUSES_FUSERID_USER_ID_Msk             (_UINT32_(0xFFFF) << FUSES_FUSERID_USER_ID_Pos)      /* (FUSES_FUSERID) User unique ID, readable using the SWD USER_ID instruction Mask */
...
#define FUSES_DEVCFG4_LPOSCEN_Pos             _UINT32_(30)                                         /* (FUSES_DEVCFG4) Low Power (Secondary) Oscillator Enable Position */
#define FUSES_DEVCFG4_LPOSCEN_Msk             (_UINT32_(0x1) << FUSES_DEVCFG4_LPOSCEN_Pos)         /* (FUSES_DEVCFG4) Low Power (Secondary) Oscillator Enable Mask */
#define FUSES_DEVCFG4_LPOSCEN(value)          (FUSES_DEVCFG4_LPOSCEN_Msk & (_UINT32_(value) << FUSES_DEVCFG4_LPOSCEN_Pos)) /* Assigment of value for LPOSCEN in the FUSES_DEVCFG4 register */
#define   FUSES_DEVCFG4_LPOSCEN_ON_Val        _UINT32_(0x1)                                        /* (FUSES_DEVCFG4) Enabled  */
#define   FUSES_DEVCFG4_LPOSCEN_OFF_Val       _UINT32_(0x0)                                        /* (FUSES_DEVCFG4) Disable  */
#define FUSES_DEVCFG4_LPOSCEN_ON              (FUSES_DEVCFG4_LPOSCEN_ON_Val << FUSES_DEVCFG4_LPOSCEN_Pos) /* (FUSES_DEVCFG4) Enabled Position  */
#define FUSES_DEVCFG4_LPOSCEN_OFF             (FUSES_DEVCFG4_LPOSCEN_OFF_Val << FUSES_DEVCFG4_LPOSCEN_Pos) /* (FUSES_DEVCFG4) Disable Position  */
...
#define FUSES_DEVCFG4_Msk                     _UINT32_(0xFFFFFFFF)                                 /* (FUSES_DEVCFG4) Register Mask  */
...
#define FUSES_DEVCFG1_RESETVALUE              _UINT32_(0x1400403B)                                 /*  (FUSES_DEVCFG1) USER Page CFGCON1 Fuses  Reset Value */

#define FUSES_DEVCFG1_CAN0_PIN_EN_Pos         _UINT32_(2)                                          /* (FUSES_DEVCFG1) CAN0 Pin Enable Position */
#define FUSES_DEVCFG1_CAN0_PIN_EN_Msk         (_UINT32_(0x1) << FUSES_DEVCFG1_CAN0_PIN_EN_Pos)     /* (FUSES_DEVCFG1) CAN0 Pin Enable Mask */
#define FUSES_DEVCFG1_CAN0_PIN_EN(value)      (FUSES_DEVCFG1_CAN0_PIN_EN_Msk & (_UINT32_(value) << FUSES_DEVCFG1_CAN0_PIN_EN_Pos)) /* Assigment of value for CAN0_PIN_EN in the FUSES_DEVCFG1 register */
...
#define FUSES_DEVCFG1_CCL_OE_Pos              _UINT32_(6)                                          /* (FUSES_DEVCFG1) CCL Pads (via PPS) Output Enable Position */
...
#define FUSES_DEVCFG1_QSPI_HSEN_Pos           _UINT32_(10)                                         /* (FUSES_DEVCFG1) QSPI (Direct) Enable Position */
#define FUSES_DEVCFG1_QSPI_HSEN_Msk           (_UINT32_(0x1) << FUSES_DEVCFG1_QSPI_HSEN_Pos)       /* (FUSES_DEVCFG1) QSPI (Direct) Enable Mask */
...
#define FUSES_DEVCFG1_SCOM0_HSEN_Pos          _UINT32_(11)                                         /* (FUSES_DEVCFG1) SERCOM0 Direct (High Speed) Pin Enable Position */
...
#define FUSES_DEVCFG1_SCOM1_HSEN_Pos          _UINT32_(12)                                         /* (FUSES_DEVCFG1) SERCOM1 Direct (High Speed) Pin Enable Position */
...
#define FUSES_DEVCFG1_SCOM2_HSEN_Pos          _UINT32_(13)                                         /* (FUSES_DEVCFG1) SERCOM2 Direct (High Speed) Pin Enable Position */
...
#define FUSES_DEVCFG1_USBDMFTRIM_Pos          _UINT32_(16)                                         /* (FUSES_DEVCFG1) USB DM Fall Trim fuse bits Position */
#define FUSES_DEVCFG1_USBDMFTRIM_Msk          (_UINT32_(0x3) << FUSES_DEVCFG1_USBDMFTRIM_Pos)      /* (FUSES_DEVCFG1) USB DM Fall Trim fuse bits Mask */
#define FUSES_DEVCFG1_USBDMFTRIM(value)       (FUSES_DEVCFG1_USBDMFTRIM_Msk & (_UINT32_(value) << FUSES_DEVCFG1_USBDMFTRIM_Pos)) /* Assigment of value for USBDMFTRIM in the FUSES_DEVCFG1 register */
#define   FUSES_DEVCFG1_USBDMFTRIM_DEFAULT_Val _UINT32_(0x0)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMFTRIM_SLOWER_Val _UINT32_(0x1)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMFTRIM_SLIGH_FASTER_Val _UINT32_(0x2)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMFTRIM_SLIGH_SLOWER_Val _UINT32_(0x3)                                        /* (FUSES_DEVCFG1)   */
#define FUSES_DEVCFG1_USBDMFTRIM_DEFAULT      (FUSES_DEVCFG1_USBDMFTRIM_DEFAULT_Val << FUSES_DEVCFG1_USBDMFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMFTRIM_SLOWER       (FUSES_DEVCFG1_USBDMFTRIM_SLOWER_Val << FUSES_DEVCFG1_USBDMFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMFTRIM_SLIGH_FASTER (FUSES_DEVCFG1_USBDMFTRIM_SLIGH_FASTER_Val << FUSES_DEVCFG1_USBDMFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMFTRIM_SLIGH_SLOWER (FUSES_DEVCFG1_USBDMFTRIM_SLIGH_SLOWER_Val << FUSES_DEVCFG1_USBDMFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMRTRIM_Pos          _UINT32_(18)                                         /* (FUSES_DEVCFG1) USB DM Rise Trim fuse bits Position */
#define FUSES_DEVCFG1_USBDMRTRIM_Msk          (_UINT32_(0x3) << FUSES_DEVCFG1_USBDMRTRIM_Pos)      /* (FUSES_DEVCFG1) USB DM Rise Trim fuse bits Mask */
#define FUSES_DEVCFG1_USBDMRTRIM(value)       (FUSES_DEVCFG1_USBDMRTRIM_Msk & (_UINT32_(value) << FUSES_DEVCFG1_USBDMRTRIM_Pos)) /* Assigment of value for USBDMRTRIM in the FUSES_DEVCFG1 register */
#define   FUSES_DEVCFG1_USBDMRTRIM_DEFAULT_Val _UINT32_(0x0)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMRTRIM_SLIGH_FASTER_Val _UINT32_(0x1)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMRTRIM_FASTER_Val _UINT32_(0x2)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDMRTRIM_SLOWER_Val _UINT32_(0x3)                                        /* (FUSES_DEVCFG1)   */
#define FUSES_DEVCFG1_USBDMRTRIM_DEFAULT      (FUSES_DEVCFG1_USBDMRTRIM_DEFAULT_Val << FUSES_DEVCFG1_USBDMRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMRTRIM_SLIGH_FASTER (FUSES_DEVCFG1_USBDMRTRIM_SLIGH_FASTER_Val << FUSES_DEVCFG1_USBDMRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMRTRIM_FASTER       (FUSES_DEVCFG1_USBDMRTRIM_FASTER_Val << FUSES_DEVCFG1_USBDMRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDMRTRIM_SLOWER       (FUSES_DEVCFG1_USBDMRTRIM_SLOWER_Val << FUSES_DEVCFG1_USBDMRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPFTRIM_Pos          _UINT32_(20)                                         /* (FUSES_DEVCFG1) USB DP Fall Trim fuse bits Position */
#define FUSES_DEVCFG1_USBDPFTRIM_Msk          (_UINT32_(0x3) << FUSES_DEVCFG1_USBDPFTRIM_Pos)      /* (FUSES_DEVCFG1) USB DP Fall Trim fuse bits Mask */
#define FUSES_DEVCFG1_USBDPFTRIM(value)       (FUSES_DEVCFG1_USBDPFTRIM_Msk & (_UINT32_(value) << FUSES_DEVCFG1_USBDPFTRIM_Pos)) /* Assigment of value for USBDPFTRIM in the FUSES_DEVCFG1 register */
#define   FUSES_DEVCFG1_USBDPFTRIM_DEFAULT_Val _UINT32_(0x0)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPFTRIM_SLOWER_Val _UINT32_(0x1)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPFTRIM_SLIGH_FASTER_Val _UINT32_(0x2)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPFTRIM_SLIGH_SLOWER_Val _UINT32_(0x3)                                        /* (FUSES_DEVCFG1)   */
#define FUSES_DEVCFG1_USBDPFTRIM_DEFAULT      (FUSES_DEVCFG1_USBDPFTRIM_DEFAULT_Val << FUSES_DEVCFG1_USBDPFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPFTRIM_SLOWER       (FUSES_DEVCFG1_USBDPFTRIM_SLOWER_Val << FUSES_DEVCFG1_USBDPFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPFTRIM_SLIGH_FASTER (FUSES_DEVCFG1_USBDPFTRIM_SLIGH_FASTER_Val << FUSES_DEVCFG1_USBDPFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPFTRIM_SLIGH_SLOWER (FUSES_DEVCFG1_USBDPFTRIM_SLIGH_SLOWER_Val << FUSES_DEVCFG1_USBDPFTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPRTRIM_Pos          _UINT32_(22)                                         /* (FUSES_DEVCFG1) USB DP Rise Trim fuse bits Position */
#define FUSES_DEVCFG1_USBDPRTRIM_Msk          (_UINT32_(0x3) << FUSES_DEVCFG1_USBDPRTRIM_Pos)      /* (FUSES_DEVCFG1) USB DP Rise Trim fuse bits Mask */
#define FUSES_DEVCFG1_USBDPRTRIM(value)       (FUSES_DEVCFG1_USBDPRTRIM_Msk & (_UINT32_(value) << FUSES_DEVCFG1_USBDPRTRIM_Pos)) /* Assigment of value for USBDPRTRIM in the FUSES_DEVCFG1 register */
#define   FUSES_DEVCFG1_USBDPRTRIM_DEFAULT_Val _UINT32_(0x0)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPRTRIM_SLIGH_FASTER_Val _UINT32_(0x1)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPRTRIM_FASTER_Val _UINT32_(0x2)                                        /* (FUSES_DEVCFG1)   */
#define   FUSES_DEVCFG1_USBDPRTRIM_SLOWER_Val _UINT32_(0x3)                                        /* (FUSES_DEVCFG1)   */
#define FUSES_DEVCFG1_USBDPRTRIM_DEFAULT      (FUSES_DEVCFG1_USBDPRTRIM_DEFAULT_Val << FUSES_DEVCFG1_USBDPRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPRTRIM_SLIGH_FASTER (FUSES_DEVCFG1_USBDPRTRIM_SLIGH_FASTER_Val << FUSES_DEVCFG1_USBDPRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPRTRIM_FASTER       (FUSES_DEVCFG1_USBDPRTRIM_FASTER_Val << FUSES_DEVCFG1_USBDPRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
#define FUSES_DEVCFG1_USBDPRTRIM_SLOWER       (FUSES_DEVCFG1_USBDPRTRIM_SLOWER_Val << FUSES_DEVCFG1_USBDPRTRIM_Pos) /* (FUSES_DEVCFG1)  Position  */
...
#define FUSES_DEVCFG1_CAN1_PIN_EN_Pos         _UINT32_(31)                                         /* (FUSES_DEVCFG1) CAN1 Pin Enable Position */
#define FUSES_DEVCFG1_CAN1_PIN_EN_Msk         (_UINT32_(0x1) << FUSES_DEVCFG1_CAN1_PIN_EN_Pos)     /* (FUSES_DEVCFG1) CAN1 Pin Enable Mask */
#define FUSES_DEVCFG1_CAN1_PIN_EN(value)      (FUSES_DEVCFG1_CAN1_PIN_EN_Msk & (_UINT32_(value) << FUSES_DEVCFG1_CAN1_PIN_EN_Pos)) /* Assigment of value for CAN1_PIN_EN in the FUSES_DEVCFG1 register */
#define FUSES_DEVCFG1_Msk                     _UINT32_(0xFFFFFFE4)                                 /* (FUSES_DEVCFG1) Register Mask  */


/* -------- FUSES_DEVCFG0 : (FUSES Offset: 0x118) (R/W 32) USER Page CFGCON0 Fuses -------- */
#define FUSES_DEVCFG0_RESETVALUE              _UINT32_(0x7960000B)                                 /*  (FUSES_DEVCFG0) USER Page CFGCON0 Fuses  Reset Value */
...
#define FUSES_DEVCFG0_USBSSEN_Pos             _UINT32_(17)                                         /* (FUSES_DEVCFG0) USB Suspend Sleep Enable Position */
#define FUSES_DEVCFG0_USBSSEN_Msk             (_UINT32_(0x1) << FUSES_DEVCFG0_USBSSEN_Pos)         /* (FUSES_DEVCFG0) USB Suspend Sleep Enable Mask */
#define FUSES_DEVCFG0_USBSSEN(value)          (FUSES_DEVCFG0_USBSSEN_Msk & (_UINT32_(value) << FUSES_DEVCFG0_USBSSEN_Pos)) /* Assigment of value for USBSSEN in the FUSES_DEVCFG0 register */
#define FUSES_DEVCFG0_EPLLHWMD_Pos            _UINT32_(18)                                         /* (FUSES_DEVCFG0) EWPLL HW Control Mode for PWDN and RESET Position */
#define FUSES_DEVCFG0_EPLLHWMD_Msk            (_UINT32_(0x1) << FUSES_DEVCFG0_EPLLHWMD_Pos)        /* (FUSES_DEVCFG0) EWPLL HW Control Mode for PWDN and RESET Mask */
#define FUSES_DEVCFG0_EPLLHWMD(value)         (FUSES_DEVCFG0_EPLLHWMD_Msk & (_UINT32_(value) << FUSES_DEVCFG0_EPLLHWMD_Pos)) /* Assigment of value for EPLLHWMD in the FUSES_DEVCFG0 register */
#define   FUSES_DEVCFG0_EPLLHWMD_OFF_Val      _UINT32_(0x0)                                        /* (FUSES_DEVCFG0)   */
#define   FUSES_DEVCFG0_EPLLHWMD_ON_Val       _UINT32_(0x1)                                        /* (FUSES_DEVCFG0)   */
#define FUSES_DEVCFG0_EPLLHWMD_OFF            (FUSES_DEVCFG0_EPLLHWMD_OFF_Val << FUSES_DEVCFG0_EPLLHWMD_Pos) /* (FUSES_DEVCFG0)  Position  */
#define FUSES_DEVCFG0_EPLLHWMD_ON             (FUSES_DEVCFG0_EPLLHWMD_ON_Val << FUSES_DEVCFG0_EPLLHWMD_Pos) /* (FUSES_DEVCFG0)  Position  */
#define FUSES_DEVCFG0_UPLLHWMD_Pos            _UINT32_(19)                                         /* (FUSES_DEVCFG0) UWPLL HW Control Mode for PWDN and RESET Position */
#define FUSES_DEVCFG0_UPLLHWMD_Msk            (_UINT32_(0x1) << FUSES_DEVCFG0_UPLLHWMD_Pos)        /* (FUSES_DEVCFG0) UWPLL HW Control Mode for PWDN and RESET Mask */
#define FUSES_DEVCFG0_UPLLHWMD(value)         (FUSES_DEVCFG0_UPLLHWMD_Msk & (_UINT32_(value) << FUSES_DEVCFG0_UPLLHWMD_Pos)) /* Assigment of value for UPLLHWMD in the FUSES_DEVCFG0 register */
#define   FUSES_DEVCFG0_UPLLHWMD_OFF_Val      _UINT32_(0x0)                                        /* (FUSES_DEVCFG0)   */
#define   FUSES_DEVCFG0_UPLLHWMD_ON_Val       _UINT32_(0x1)                                        /* (FUSES_DEVCFG0)   */
#define FUSES_DEVCFG0_UPLLHWMD_OFF            (FUSES_DEVCFG0_UPLLHWMD_OFF_Val << FUSES_DEVCFG0_UPLLHWMD_Pos) /* (FUSES_DEVCFG0)  Position  */
#define FUSES_DEVCFG0_UPLLHWMD_ON             (FUSES_DEVCFG0_UPLLHWMD_ON_Val << FUSES_DEVCFG0_UPLLHWMD_Pos) /* (FUSES_DEVCFG0)  Position  */
...
#define FUSES_DEVCFG0_USBIDIO_Pos             _UINT32_(21)                                         /* (FUSES_DEVCFG0) USB USBID Selection bit Position */
#define FUSES_DEVCFG0_USBIDIO_Msk             (_UINT32_(0x1) << FUSES_DEVCFG0_USBIDIO_Pos)         /* (FUSES_DEVCFG0) USB USBID Selection bit Mask */
#define FUSES_DEVCFG0_USBIDIO(value)          (FUSES_DEVCFG0_USBIDIO_Msk & (_UINT32_(value) << FUSES_DEVCFG0_USBIDIO_Pos)) /* Assigment of value for USBIDIO in the FUSES_DEVCFG0 register */
#define FUSES_DEVCFG0_VBUSONIO_Pos            _UINT32_(22)                                         /* (FUSES_DEVCFG0) USB VBUS_ON Selection bit Position */
#define FUSES_DEVCFG0_VBUSONIO_Msk            (_UINT32_(0x1) << FUSES_DEVCFG0_VBUSONIO_Pos)        /* (FUSES_DEVCFG0) USB VBUS_ON Selection bit Mask */
#define FUSES_DEVCFG0_VBUSONIO(value)         (FUSES_DEVCFG0_VBUSONIO_Msk & (_UINT32_(value) << FUSES_DEVCFG0_VBUSONIO_Pos)) /* Assigment of value for VBUSONIO in the FUSES_DEVCFG0 register */
#define FUSES_DEVCFG0_SMBUS3EN2_Pos           _UINT32_(23)                                         /* (FUSES_DEVCFG0) SMBus3 Enable for SERCOM2 Position */
#define FUSES_DEVCFG0_SMBUS3EN2_Msk           (_UINT32_(0x1) << FUSES_DEVCFG0_SMBUS3EN2_Pos)       /* (FUSES_DEVCFG0) SMBus3 Enable for SERCOM2 Mask */
#define FUSES_DEVCFG0_SMBUS3EN2(value)        (FUSES_DEVCFG0_SMBUS3EN2_Msk & (_UINT32_(value) << FUSES_DEVCFG0_SMBUS3EN2_Pos)) /* Assigment of value for SMBUS3EN2 in the FUSES_DEVCFG0 register */
...
#define FUSES_DEVCFG0_CMEN_Pos                _UINT32_(27)                                         /* (FUSES_DEVCFG0) SPA/DPA Countermeasures Enable Position */
#define FUSES_DEVCFG0_CMEN_Msk                (_UINT32_(0x1) << FUSES_DEVCFG0_CMEN_Pos)            /* (FUSES_DEVCFG0) SPA/DPA Countermeasures Enable Mask */
#define FUSES_DEVCFG0_CMEN(value)             (FUSES_DEVCFG0_CMEN_Msk & (_UINT32_(value) << FUSES_DEVCFG0_CMEN_Pos)) /* Assigment of value for CMEN in the FUSES_DEVCFG0 register */
...
#define FUSES_DEVCFG0_Msk                     _UINT32_(0x7FFE0396)                                 /* (FUSES_DEVCFG0) Register Mask  */

#define FUSES_DEVCFG0_SMBUS3EN_Pos            _UINT32_(23)                                         /* (FUSES_DEVCFG0 Position) SMBus3 Enable for SERCOM2 */
#define FUSES_DEVCFG0_SMBUS3EN_Msk            (_UINT32_(0x1) << FUSES_DEVCFG0_SMBUS3EN_Pos)        /* (FUSES_DEVCFG0 Mask) SMBUS3EN */
#define FUSES_DEVCFG0_SMBUS3EN(value)         (FUSES_DEVCFG0_SMBUS3EN_Msk & (_UINT32_(value) << FUSES_DEVCFG0_SMBUS3EN_Pos)) 
...
} fuses_devicecfg_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _WBZ65_FUSES_COMPONENT_H_ */
