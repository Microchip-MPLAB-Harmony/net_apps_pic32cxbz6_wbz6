...
#ifndef _WBZ65_DSU_COMPONENT_H_
#define _WBZ65_DSU_COMPONENT_H_
...
#define DSU_DID_RESETVALUE                    _UINT32_(0x1A800)                                    /*  (DSU_DID) Device Identification  Reset Value */
...
#define DSU_DID_DIE_Pos                       _UINT32_(8)                                          /* (DSU_DID) Die Number Position */
#define DSU_DID_DIE_Msk                       (_UINT32_(0xFF) << DSU_DID_DIE_Pos)                  /* (DSU_DID) Die Number Mask */
...
#define DSU_DID_REVISION_Pos                  _UINT32_(28)                                         /* (DSU_DID) Revision Number Position */
...
/* -------- DSU_UUID : (DSU Offset: 0x38) ( R/ 32) Unique Identifier n -------- */
#define DSU_UUID_RESETVALUE                   _UINT32_(0x00)                                       /*  (DSU_UUID) Unique Identifier n  Reset Value */

#define DSU_UUID_UUID_Pos                     _UINT32_(0)                                          /* (DSU_UUID) UUID Position */
#define DSU_UUID_UUID_Msk                     (_UINT32_(0xFFFFFFFF) << DSU_UUID_UUID_Pos)          /* (DSU_UUID) UUID Mask */
#define DSU_UUID_UUID(value)                  (DSU_UUID_UUID_Msk & (_UINT32_(value) << DSU_UUID_UUID_Pos)) /* Assigment of value for UUID in the DSU_UUID register */
#define DSU_UUID_Msk                          _UINT32_(0xFFFFFFFF)                                 /* (DSU_UUID) Register Mask  */


/* -------- DSU_SECCFG : (DSU Offset: 0x48) ( R/ 32) Secure Config -------- */
#define DSU_SECCFG_RESETVALUE                 _UINT32_(0x00)                                       /*  (DSU_SECCFG) Secure Config  Reset Value */

#define DSU_SECCFG_SECCFG_Pos                 _UINT32_(0)                                          /* (DSU_SECCFG) Secure Config Position */
#define DSU_SECCFG_SECCFG_Msk                 (_UINT32_(0xFFFFFFFF) << DSU_SECCFG_SECCFG_Pos)      /* (DSU_SECCFG) Secure Config Mask */
#define DSU_SECCFG_SECCFG(value)              (DSU_SECCFG_SECCFG_Msk & (_UINT32_(value) << DSU_SECCFG_SECCFG_Pos)) /* Assigment of value for SECCFG in the DSU_SECCFG register */
#define DSU_SECCFG_Msk                        _UINT32_(0xFFFFFFFF)                                 /* (DSU_SECCFG) Register Mask  */


/* -------- DSU_CTR_STAT : (DSU Offset: 0x4C) ( R/ 32) RoT Rollback counter -------- */
#define DSU_CTR_STAT_RESETVALUE               _UINT32_(0x00)                                       /*  (DSU_CTR_STAT) RoT Rollback counter  Reset Value */

#define DSU_CTR_STAT_ROLLBACK_CTR_Pos         _UINT32_(0)                                          /* (DSU_CTR_STAT) Rollback counter Position */
#define DSU_CTR_STAT_ROLLBACK_CTR_Msk         (_UINT32_(0xFF) << DSU_CTR_STAT_ROLLBACK_CTR_Pos)    /* (DSU_CTR_STAT) Rollback counter Mask */
#define DSU_CTR_STAT_ROLLBACK_CTR(value)      (DSU_CTR_STAT_ROLLBACK_CTR_Msk & (_UINT32_(value) << DSU_CTR_STAT_ROLLBACK_CTR_Pos)) /* Assigment of value for ROLLBACK_CTR in the DSU_CTR_STAT register */
#define DSU_CTR_STAT_Msk                      _UINT32_(0x000000FF)                                 /* (DSU_CTR_STAT) Register Mask  */


/* -------- DSU_BOOT_STAT : (DSU Offset: 0x50) ( R/ 32) RoT Boot Status -------- */
#define DSU_BOOT_STAT_RESETVALUE              _UINT32_(0x00)                                       /*  (DSU_BOOT_STAT) RoT Boot Status  Reset Value */

#define DSU_BOOT_STAT_BOOT_STATUS_Pos         _UINT32_(0)                                          /* (DSU_BOOT_STAT) Boot Status Position */
#define DSU_BOOT_STAT_BOOT_STATUS_Msk         (_UINT32_(0xFF) << DSU_BOOT_STAT_BOOT_STATUS_Pos)    /* (DSU_BOOT_STAT) Boot Status Mask */
#define DSU_BOOT_STAT_BOOT_STATUS(value)      (DSU_BOOT_STAT_BOOT_STATUS_Msk & (_UINT32_(value) << DSU_BOOT_STAT_BOOT_STATUS_Pos)) /* Assigment of value for BOOT_STATUS in the DSU_BOOT_STAT register */
#define DSU_BOOT_STAT_Msk                     _UINT32_(0x000000FF)                                 /* (DSU_BOOT_STAT) Register Mask  */


/* -------- DSU_BOOT_KEY : (DSU Offset: 0x54) ( R/ 32) Secure Boot Key n -------- */
#define DSU_BOOT_KEY_RESETVALUE               _UINT32_(0x00)                                       /*  (DSU_BOOT_KEY) Secure Boot Key n  Reset Value */

#define DSU_BOOT_KEY_BOOT_KEY_Pos             _UINT32_(0)                                          /* (DSU_BOOT_KEY) Secure Boot Key Position */
#define DSU_BOOT_KEY_BOOT_KEY_Msk             (_UINT32_(0xFFFFFFFF) << DSU_BOOT_KEY_BOOT_KEY_Pos)  /* (DSU_BOOT_KEY) Secure Boot Key Mask */
#define DSU_BOOT_KEY_BOOT_KEY(value)          (DSU_BOOT_KEY_BOOT_KEY_Msk & (_UINT32_(value) << DSU_BOOT_KEY_BOOT_KEY_Pos)) /* Assigment of value for BOOT_KEY in the DSU_BOOT_KEY register */
#define DSU_BOOT_KEY_Msk                      _UINT32_(0xFFFFFFFF)                                 /* (DSU_BOOT_KEY) Register Mask  */
...
#define DSU_PID1_RESETVALUE                   _UINT32_(0x9C)                                       /*  (DSU_PID1) Peripheral Identification 1  Reset Value */
...
#define DSU_PID2_RESETVALUE                   _UINT32_(0x0A)                                       /*  (DSU_PID2) Peripheral Identification 2  Reset Value */
...
#define DSU_UUID_REG_OFST              _UINT32_(0x38)      /* (DSU_UUID) Unique Identifier n Offset */
#define DSU_UUID0_REG_OFST             _UINT32_(0x38)      /* (DSU_UUID0) Unique Identifier n Offset */
#define DSU_UUID1_REG_OFST             _UINT32_(0x3C)      /* (DSU_UUID1) Unique Identifier n Offset */
#define DSU_UUID2_REG_OFST             _UINT32_(0x40)      /* (DSU_UUID2) Unique Identifier n Offset */
#define DSU_UUID3_REG_OFST             _UINT32_(0x44)      /* (DSU_UUID3) Unique Identifier n Offset */
#define DSU_SECCFG_REG_OFST            _UINT32_(0x48)      /* (DSU_SECCFG) Secure Config Offset */
#define DSU_CTR_STAT_REG_OFST          _UINT32_(0x4C)      /* (DSU_CTR_STAT) RoT Rollback counter Offset */
#define DSU_BOOT_STAT_REG_OFST         _UINT32_(0x50)      /* (DSU_BOOT_STAT) RoT Boot Status Offset */
#define DSU_BOOT_KEY_REG_OFST          _UINT32_(0x54)      /* (DSU_BOOT_KEY) Secure Boot Key n Offset */
#define DSU_BOOT_KEY0_REG_OFST         _UINT32_(0x54)      /* (DSU_BOOT_KEY0) Secure Boot Key n Offset */
#define DSU_BOOT_KEY1_REG_OFST         _UINT32_(0x58)      /* (DSU_BOOT_KEY1) Secure Boot Key n Offset */
#define DSU_BOOT_KEY2_REG_OFST         _UINT32_(0x5C)      /* (DSU_BOOT_KEY2) Secure Boot Key n Offset */
#define DSU_BOOT_KEY3_REG_OFST         _UINT32_(0x60)      /* (DSU_BOOT_KEY3) Secure Boot Key n Offset */
#define DSU_BOOT_KEY4_REG_OFST         _UINT32_(0x64)      /* (DSU_BOOT_KEY4) Secure Boot Key n Offset */
#define DSU_BOOT_KEY5_REG_OFST         _UINT32_(0x68)      /* (DSU_BOOT_KEY5) Secure Boot Key n Offset */
#define DSU_BOOT_KEY6_REG_OFST         _UINT32_(0x6C)      /* (DSU_BOOT_KEY6) Secure Boot Key n Offset */
#define DSU_BOOT_KEY7_REG_OFST         _UINT32_(0x70)      /* (DSU_BOOT_KEY7) Secure Boot Key n Offset */
#define DSU_BOOT_KEY8_REG_OFST         _UINT32_(0x74)      /* (DSU_BOOT_KEY8) Secure Boot Key n Offset */
#define DSU_BOOT_KEY9_REG_OFST         _UINT32_(0x78)      /* (DSU_BOOT_KEY9) Secure Boot Key n Offset */
#define DSU_BOOT_KEY10_REG_OFST        _UINT32_(0x7C)      /* (DSU_BOOT_KEY10) Secure Boot Key n Offset */
#define DSU_BOOT_KEY11_REG_OFST        _UINT32_(0x80)      /* (DSU_BOOT_KEY11) Secure Boot Key n Offset */
...
{  /* Device Service Unit */
  ...
  __I   uint32_t                       DSU_UUID[4];        /**< Offset: 0x38 (R/   32) Unique Identifier n */
  __I   uint32_t                       DSU_SECCFG;         /**< Offset: 0x48 (R/   32) Secure Config */
  __I   uint32_t                       DSU_CTR_STAT;       /**< Offset: 0x4C (R/   32) RoT Rollback counter */
  __I   uint32_t                       DSU_BOOT_STAT;      /**< Offset: 0x50 (R/   32) RoT Boot Status */
  __I   uint32_t                       DSU_BOOT_KEY[12];   /**< Offset: 0x54 (R/   32) Secure Boot Key n */
  __I   uint8_t                        Reserved3[0xF7C];
