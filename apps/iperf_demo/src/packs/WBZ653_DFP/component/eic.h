...
#ifndef _WBZ65_EIC_COMPONENT_H_
#define _WBZ65_EIC_COMPONENT_H_
...
#define   EIC_CTRLA_CKSEL_32KHZ_LPCLK_Val     _UINT8_(0x1)                                         /* (EIC_CTRLA) Clocked by LPCLK  */
#define EIC_CTRLA_CKSEL_CLK_GCLK              (EIC_CTRLA_CKSEL_CLK_GCLK_Val << EIC_CTRLA_CKSEL_Pos) /* (EIC_CTRLA) Clocked by GCLK Position  */
#define EIC_CTRLA_CKSEL_32KHZ_LPCLK           (EIC_CTRLA_CKSEL_32KHZ_LPCLK_Val << EIC_CTRLA_CKSEL_Pos) /* (EIC_CTRLA) Clocked by LPCLK Position  */
...
#define EIC_EVCTRL_EXTINTEO_Msk               (_UINT32_(0xF) << EIC_EVCTRL_EXTINTEO_Pos)           /* (EIC_EVCTRL) External Interrupt Event Output Enable Mask */
...
#define EIC_EVCTRL_Msk                        _UINT32_(0x0000000F)                                 /* (EIC_EVCTRL) Register Mask  */
...
#define EIC_INTENCLR_EXTINT_Msk               (_UINT32_(0xF) << EIC_INTENCLR_EXTINT_Pos)           /* (EIC_INTENCLR) External Interrupt Enable Mask */
...
#define EIC_INTENCLR_Msk                      _UINT32_(0x0000000F)                                 /* (EIC_INTENCLR) Register Mask  */
...
#define EIC_INTENSET_EXTINT_Msk               (_UINT32_(0xF) << EIC_INTENSET_EXTINT_Pos)           /* (EIC_INTENSET) External Interrupt Enable Mask */
...
#define EIC_INTENSET_Msk                      _UINT32_(0x0000000F)                                 /* (EIC_INTENSET) Register Mask  */
...
#define EIC_INTFLAG_EXTINT_Msk                (_UINT32_(0xF) << EIC_INTFLAG_EXTINT_Pos)            /* (EIC_INTFLAG) External Interrupt Mask */
...
#define EIC_INTFLAG_Msk                       _UINT32_(0x0000000F)                                 /* (EIC_INTFLAG) Register Mask  */
...
#define EIC_ASYNCH_ASYNCH_Msk                 (_UINT32_(0xF) << EIC_ASYNCH_ASYNCH_Pos)             /* (EIC_ASYNCH) Asynchronous Edge Detection Mode Mask */
...
#define EIC_ASYNCH_Msk                        _UINT32_(0x0000000F)                                 /* (EIC_ASYNCH) Register Mask  */
...
#define EIC_CONFIG_Msk                        _UINT32_(0x0000FFFF)                                 /* (EIC_CONFIG) Register Mask  */
...
#define EIC_DEBOUNCEN_DEBOUNCEN_Msk           (_UINT32_(0xF) << EIC_DEBOUNCEN_DEBOUNCEN_Pos)       /* (EIC_DEBOUNCEN) Debouncer Enable Mask */
...
#define EIC_DEBOUNCEN_Msk                     _UINT32_(0x0000000F)                                 /* (EIC_DEBOUNCEN) Register Mask  */
...
#define EIC_DPRESCALER_Msk                    _UINT32_(0x0001000F)                                 /* (EIC_DPRESCALER) Register Mask  */

#define EIC_DPRESCALER_STATES_Pos             _UINT32_(3)                                          /* (EIC_DPRESCALER Position) Debouncer number of states */
#define EIC_DPRESCALER_STATES_Msk             (_UINT32_(0x1) << EIC_DPRESCALER_STATES_Pos)         /* (EIC_DPRESCALER Mask) STATES */
#define EIC_DPRESCALER_STATES(value)          (EIC_DPRESCALER_STATES_Msk & (_UINT32_(value) << EIC_DPRESCALER_STATES_Pos)) 
...
#define EIC_PINSTATE_PINSTATE_Msk             (_UINT32_(0xF) << EIC_PINSTATE_PINSTATE_Pos)         /* (EIC_PINSTATE) Pin State Mask */
...
#define EIC_PINSTATE_Msk                      _UINT32_(0x0000000F)                                 /* (EIC_PINSTATE) Register Mask  */
