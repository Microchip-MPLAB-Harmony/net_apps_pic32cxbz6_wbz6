...
#ifndef _WBZ65_CAN_COMPONENT_H_
#define _WBZ65_CAN_COMPONENT_H_

/* ************************************************************************** */
/*   SOFTWARE API DEFINITION FOR CAN                                          */
/* ************************************************************************** */

/* -------- CAN_RXBE_0 : (CAN Offset: 0x00) (R/W 32) Rx Buffer and FIFO Element 0 -------- */
#define CAN_RXBE_0_RESETVALUE                 _UINT32_(0x00)                                       /*  (CAN_RXBE_0) Rx Buffer and FIFO Element 0  Reset Value */
...
/* -------- CAN_RXBE_1 : (CAN Offset: 0x04) (R/W 32) Rx Buffer and FIFO Element 1 -------- */
#define CAN_RXBE_1_RESETVALUE                 _UINT32_(0x00)                                       /*  (CAN_RXBE_1) Rx Buffer and FIFO Element 1  Reset Value */
...
#define CAN_RXBE_1_BRS_Pos                    _UINT32_(20)                                         /* (CAN_RXBE_1) Bit Rate Search Position */
#define CAN_RXBE_1_BRS_Msk                    (_UINT32_(0x1) << CAN_RXBE_1_BRS_Pos)                /* (CAN_RXBE_1) Bit Rate Search Mask */
...
/* -------- CAN_RXBE_DATA : (CAN Offset: 0x08) (R/W 32) Rx Buffer and FIFO Element Data -------- */
#define CAN_RXBE_DATA_RESETVALUE              _UINT32_(0x00)                                       /*  (CAN_RXBE_DATA) Rx Buffer and FIFO Element Data  Reset Value */
...
#define CAN_SIDFE_0_RESETVALUE                _UINT32_(0x00)                                       /*  (CAN_SIDFE_0) Standard Message ID Filter Element  Reset Value */
...
#define CAN_TXBE_1_DLC_Pos                    _UINT32_(16)                                         /* (CAN_TXBE_1) Identifier Position */
#define CAN_TXBE_1_DLC_Msk                    (_UINT32_(0xF) << CAN_TXBE_1_DLC_Pos)                /* (CAN_TXBE_1) Identifier Mask */
...
#define CAN_TXBE_1_BRS_Pos                    _UINT32_(20)                                         /* (CAN_TXBE_1) Bit Rate Search Position */
#define CAN_TXBE_1_BRS_Msk                    (_UINT32_(0x1) << CAN_TXBE_1_BRS_Pos)                /* (CAN_TXBE_1) Bit Rate Search Mask */
...
#define CAN_TXEFE_0_XTD_Pos                   _UINT32_(30)                                         /* (CAN_TXEFE_0) Extended Indentifier Position */
#define CAN_TXEFE_0_XTD_Msk                   (_UINT32_(0x1) << CAN_TXEFE_0_XTD_Pos)               /* (CAN_TXEFE_0) Extended Indentifier Mask */
...
#define CAN_TXEFE_1_BRS_Pos                   _UINT32_(20)                                         /* (CAN_TXEFE_1) Bit Rate Search Position */
#define CAN_TXEFE_1_BRS_Msk                   (_UINT32_(0x1) << CAN_TXEFE_1_BRS_Pos)               /* (CAN_TXEFE_1) Bit Rate Search Mask */
...
#define CAN_CREL_RESETVALUE                   _UINT32_(0x32300000)                                 /*  (CAN_CREL) Core Release  Reset Value */
...
#define CAN_MRCFG_RESETVALUE                  _UINT32_(0x00)                                       /*  (CAN_MRCFG) Message RAM Configuration  Reset Value */

#define CAN_MRCFG_OFFSET_Pos                  _UINT32_(16)                                         /* (CAN_MRCFG) Base address offset Position */
#define CAN_MRCFG_OFFSET_Msk                  (_UINT32_(0xFF) << CAN_MRCFG_OFFSET_Pos)             /* (CAN_MRCFG) Base address offset Mask */
#define CAN_MRCFG_OFFSET(value)               (CAN_MRCFG_OFFSET_Msk & (_UINT32_(value) << CAN_MRCFG_OFFSET_Pos)) /* Assigment of value for OFFSET in the CAN_MRCFG register */
#define CAN_MRCFG_Msk                         _UINT32_(0x00FF0000)                                 /* (CAN_MRCFG) Register Mask  */
...
/* -------- CAN_ERROR : (CAN Offset: 0x100) (R/W 32) Error Interrupt Flag -------- */
#define CAN_ERROR_RESETVALUE                  _UINT32_(0x00)                                       /*  (CAN_ERROR) Error Interrupt Flag  Reset Value */

#define CAN_ERROR_BERR_Pos                    _UINT32_(0)                                          /* (CAN_ERROR) AHB Bus Error Detection Position */
#define CAN_ERROR_BERR_Msk                    (_UINT32_(0x1) << CAN_ERROR_BERR_Pos)                /* (CAN_ERROR) AHB Bus Error Detection Mask */
#define CAN_ERROR_BERR(value)                 (CAN_ERROR_BERR_Msk & (_UINT32_(value) << CAN_ERROR_BERR_Pos)) /* Assigment of value for BERR in the CAN_ERROR register */
#define CAN_ERROR_Msk                         _UINT32_(0x00000001)                                 /* (CAN_ERROR) Register Mask  */


/** \brief CAN register offsets definitions */
#define CAN_RXBE_0_REG_OFST            _UINT32_(0x00)      /* (CAN_RXBE_0) Rx Buffer and FIFO Element 0 Offset */
#define CAN_RXBE_1_REG_OFST            _UINT32_(0x04)      /* (CAN_RXBE_1) Rx Buffer and FIFO Element 1 Offset */
#define CAN_RXBE_DATA_REG_OFST         _UINT32_(0x08)      /* (CAN_RXBE_DATA) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA0_REG_OFST        _UINT32_(0x08)      /* (CAN_RXBE_DATA0) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA1_REG_OFST        _UINT32_(0x0C)      /* (CAN_RXBE_DATA1) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA2_REG_OFST        _UINT32_(0x10)      /* (CAN_RXBE_DATA2) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA3_REG_OFST        _UINT32_(0x14)      /* (CAN_RXBE_DATA3) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA4_REG_OFST        _UINT32_(0x18)      /* (CAN_RXBE_DATA4) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA5_REG_OFST        _UINT32_(0x1C)      /* (CAN_RXBE_DATA5) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA6_REG_OFST        _UINT32_(0x20)      /* (CAN_RXBE_DATA6) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA7_REG_OFST        _UINT32_(0x24)      /* (CAN_RXBE_DATA7) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA8_REG_OFST        _UINT32_(0x28)      /* (CAN_RXBE_DATA8) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA9_REG_OFST        _UINT32_(0x2C)      /* (CAN_RXBE_DATA9) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA10_REG_OFST       _UINT32_(0x30)      /* (CAN_RXBE_DATA10) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA11_REG_OFST       _UINT32_(0x34)      /* (CAN_RXBE_DATA11) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA12_REG_OFST       _UINT32_(0x38)      /* (CAN_RXBE_DATA12) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA13_REG_OFST       _UINT32_(0x3C)      /* (CAN_RXBE_DATA13) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA14_REG_OFST       _UINT32_(0x40)      /* (CAN_RXBE_DATA14) Rx Buffer and FIFO Element Data Offset */
#define CAN_RXBE_DATA15_REG_OFST       _UINT32_(0x44)      /* (CAN_RXBE_DATA15) Rx Buffer and FIFO Element Data Offset */
...
#define CAN_SIDFE_0_REG_OFST           _UINT32_(0x00)      /* (CAN_SIDFE_0) Standard Message ID Filter Element Offset */
...
#define CAN_ERROR_REG_OFST             _UINT32_(0x100)     /* (CAN_ERROR) Error Interrupt Flag Offset */

#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
/** \brief CAN_RXBE register API structure */
typedef struct
{  /* Rx Buffer Element */
  __IO  uint32_t                       CAN_RXBE_0;         /**< Offset: 0x00 (R/W  32) Rx Buffer and FIFO Element 0 */
  __IO  uint32_t                       CAN_RXBE_1;         /**< Offset: 0x04 (R/W  32) Rx Buffer and FIFO Element 1 */
  __IO  uint32_t                       CAN_RXBE_DATA[16];  /**< Offset: 0x08 (R/W  32) Rx Buffer and FIFO Element Data */
...
{  /* Standard Message ID Filter Element */
  __IO  uint32_t                       CAN_SIDFE_0;        /**< Offset: 0x00 (R/W  32) Standard Message ID Filter Element */
...
{  /* Control Area Network */
  ...
  __IO  uint32_t                       CAN_ERROR;          /**< Offset: 0x100 (R/W  32) Error Interrupt Flag */
} can_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _WBZ65_CAN_COMPONENT_H_ */
