...
#ifndef _WBZ65_SERCOM_COMPONENT_H_
#define _WBZ65_SERCOM_COMPONENT_H_
...
#define SERCOM_I2CS_STATUS_Msk                _UINT16_(0x0ADF)                                     /* (SERCOM_I2CS_STATUS) Register Mask  */
...
#define SERCOM_I2CM_SYNCBUSY_LENGTH(value)    (SERCOM_I2CM_SYNCBUSY_LENGTH_Msk & (_UINT32_(value) << SERCOM_I2CM_SYNCBUSY_LENGTH_Pos)) /* Assigment of value for LENGTH in the SERCOM_I2CM_SYNCBUSY register */
...
#define SERCOM_I2CS_ADDR_Msk                  _UINT32_(0x07FE07FF)                                 /* (SERCOM_I2CS_ADDR) Register Mask  */
...
#define SERCOM_I2CM_DATA_DATA_Msk             (_UINT32_(0xFF) << SERCOM_I2CM_DATA_DATA_Pos)        /* (SERCOM_I2CM_DATA) Data Value Mask */
...
#define SERCOM_I2CM_DATA_Msk                  _UINT32_(0x000000FF)                                 /* (SERCOM_I2CM_DATA) Register Mask  */
...
#endif /* _WBZ65_SERCOM_COMPONENT_H_ */
