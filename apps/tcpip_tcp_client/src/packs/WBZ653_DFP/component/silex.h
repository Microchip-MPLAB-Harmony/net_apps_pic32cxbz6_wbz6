...
#ifndef _WBZ65_SILEX_COMPONENT_H_
#define _WBZ65_SILEX_COMPONENT_H_
...
#define SILEX_DMA_FETCH_ADDR_LSB_FETCH_ADDR_LSB(value) (SILEX_DMA_FETCH_ADDR_LSB_FETCH_ADDR_LSB_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_ADDR_LSB_FETCH_ADDR_LSB_Pos)) /* Assigment of value for FETCH_ADDR_LSB in the SILEX_DMA_FETCH_ADDR_LSB register */
...
#define SILEX_DMA_FETCH_ADDR_MSB_FETCH_ADDR_MSB(value) (SILEX_DMA_FETCH_ADDR_MSB_FETCH_ADDR_MSB_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_ADDR_MSB_FETCH_ADDR_MSB_Pos)) /* Assigment of value for FETCH_ADDR_MSB in the SILEX_DMA_FETCH_ADDR_MSB register */
...
#define SILEX_DMA_FETCH_LEN_FETCH_LEN(value)  (SILEX_DMA_FETCH_LEN_FETCH_LEN_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_LEN_FETCH_LEN_Pos)) /* Assigment of value for FETCH_LEN in the SILEX_DMA_FETCH_LEN register */
...
#define SILEX_DMA_FETCH_LEN_FETCH_CSTADDR(value) (SILEX_DMA_FETCH_LEN_FETCH_CSTADDR_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_LEN_FETCH_CSTADDR_Pos)) /* Assigment of value for FETCH_CSTADDR in the SILEX_DMA_FETCH_LEN register */
...
#define SILEX_DMA_FETCH_LEN_FETCH_REALIGN(value) (SILEX_DMA_FETCH_LEN_FETCH_REALIGN_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_LEN_FETCH_REALIGN_Pos)) /* Assigment of value for FETCH_REALIGN in the SILEX_DMA_FETCH_LEN register */
...
#define SILEX_DMA_FETCH_LEN_FETCH_ZPADDING(value) (SILEX_DMA_FETCH_LEN_FETCH_ZPADDING_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_LEN_FETCH_ZPADDING_Pos)) /* Assigment of value for FETCH_ZPADDING in the SILEX_DMA_FETCH_LEN register */
...
#define SILEX_DMA_FETCH_TAG_FETCH_TAG(value)  (SILEX_DMA_FETCH_TAG_FETCH_TAG_Msk & (_UINT32_(value) << SILEX_DMA_FETCH_TAG_FETCH_TAG_Pos)) /* Assigment of value for FETCH_TAG in the SILEX_DMA_FETCH_TAG register */
...
#define SILEX_DMA_PUSH_ADDR_LSB_PUSH_ADDR_LSB(value) (SILEX_DMA_PUSH_ADDR_LSB_PUSH_ADDR_LSB_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_ADDR_LSB_PUSH_ADDR_LSB_Pos)) /* Assigment of value for PUSH_ADDR_LSB in the SILEX_DMA_PUSH_ADDR_LSB register */
...
#define SILEX_DMA_PUSH_ADDR_MSB_PUSH_ADDR_MSB(value) (SILEX_DMA_PUSH_ADDR_MSB_PUSH_ADDR_MSB_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_ADDR_MSB_PUSH_ADDR_MSB_Pos)) /* Assigment of value for PUSH_ADDR_MSB in the SILEX_DMA_PUSH_ADDR_MSB register */
...
#define SILEX_DMA_PUSH_LEN_PUSH_LEN(value)    (SILEX_DMA_PUSH_LEN_PUSH_LEN_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_LEN_PUSH_LEN_Pos)) /* Assigment of value for PUSH_LEN in the SILEX_DMA_PUSH_LEN register */
...
#define SILEX_DMA_PUSH_LEN_PUSH_CSTADDR(value) (SILEX_DMA_PUSH_LEN_PUSH_CSTADDR_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_LEN_PUSH_CSTADDR_Pos)) /* Assigment of value for PUSH_CSTADDR in the SILEX_DMA_PUSH_LEN register */
...
#define SILEX_DMA_PUSH_LEN_PUSH_REALIGN(value) (SILEX_DMA_PUSH_LEN_PUSH_REALIGN_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_LEN_PUSH_REALIGN_Pos)) /* Assigment of value for PUSH_REALIGN in the SILEX_DMA_PUSH_LEN register */
...
#define SILEX_DMA_PUSH_LEN_PUSH_DISCARD(value) (SILEX_DMA_PUSH_LEN_PUSH_DISCARD_Msk & (_UINT32_(value) << SILEX_DMA_PUSH_LEN_PUSH_DISCARD_Pos)) /* Assigment of value for PUSH_DISCARD in the SILEX_DMA_PUSH_LEN register */
...
#define SILEX_DMA_INT_EN_INT_EN(value)        (SILEX_DMA_INT_EN_INT_EN_Msk & (_UINT32_(value) << SILEX_DMA_INT_EN_INT_EN_Pos)) /* Assigment of value for INT_EN in the SILEX_DMA_INT_EN register */
...
#define SILEX_DMA_INT_ENSET_INT_ENSET(value)  (SILEX_DMA_INT_ENSET_INT_ENSET_Msk & (_UINT32_(value) << SILEX_DMA_INT_ENSET_INT_ENSET_Pos)) /* Assigment of value for INT_ENSET in the SILEX_DMA_INT_ENSET register */
...
#define SILEX_DMA_INT_ENCLR_INT_ENCLR(value)  (SILEX_DMA_INT_ENCLR_INT_ENCLR_Msk & (_UINT32_(value) << SILEX_DMA_INT_ENCLR_INT_ENCLR_Pos)) /* Assigment of value for INT_ENCLR in the SILEX_DMA_INT_ENCLR register */
...
#define SILEX_DMA_INT_STATRAW_INT_STATRAW(value) (SILEX_DMA_INT_STATRAW_INT_STATRAW_Msk & (_UINT32_(value) << SILEX_DMA_INT_STATRAW_INT_STATRAW_Pos)) /* Assigment of value for INT_STATRAW in the SILEX_DMA_INT_STATRAW register */
...
#define SILEX_DMA_INT_STAT_INT_STAT(value)    (SILEX_DMA_INT_STAT_INT_STAT_Msk & (_UINT32_(value) << SILEX_DMA_INT_STAT_INT_STAT_Pos)) /* Assigment of value for INT_STAT in the SILEX_DMA_INT_STAT register */
...
#define SILEX_DMA_INT_STATCLR_INT_STATCLR(value) (SILEX_DMA_INT_STATCLR_INT_STATCLR_Msk & (_UINT32_(value) << SILEX_DMA_INT_STATCLR_INT_STATCLR_Pos)) /* Assigment of value for INT_STATCLR in the SILEX_DMA_INT_STATCLR register */
...
#define SILEX_DMA_CONFIG_FETCH_CTRL_INDIRECT(value) (SILEX_DMA_CONFIG_FETCH_CTRL_INDIRECT_Msk & (_UINT32_(value) << SILEX_DMA_CONFIG_FETCH_CTRL_INDIRECT_Pos)) /* Assigment of value for FETCH_CTRL_INDIRECT in the SILEX_DMA_CONFIG register */
...
#define SILEX_DMA_CONFIG_PUSH_CTRL_INDIRECT(value) (SILEX_DMA_CONFIG_PUSH_CTRL_INDIRECT_Msk & (_UINT32_(value) << SILEX_DMA_CONFIG_PUSH_CTRL_INDIRECT_Pos)) /* Assigment of value for PUSH_CTRL_INDIRECT in the SILEX_DMA_CONFIG register */
...
#define SILEX_DMA_CONFIG_FETCH_STOP(value)    (SILEX_DMA_CONFIG_FETCH_STOP_Msk & (_UINT32_(value) << SILEX_DMA_CONFIG_FETCH_STOP_Pos)) /* Assigment of value for FETCH_STOP in the SILEX_DMA_CONFIG register */
...
#define SILEX_DMA_CONFIG_PUSH_STOP(value)     (SILEX_DMA_CONFIG_PUSH_STOP_Msk & (_UINT32_(value) << SILEX_DMA_CONFIG_PUSH_STOP_Pos)) /* Assigment of value for PUSH_STOP in the SILEX_DMA_CONFIG register */
...
#define SILEX_DMA_CONFIG_SOFT_RST(value)      (SILEX_DMA_CONFIG_SOFT_RST_Msk & (_UINT32_(value) << SILEX_DMA_CONFIG_SOFT_RST_Pos)) /* Assigment of value for SOFT_RST in the SILEX_DMA_CONFIG register */
...
#define SILEX_DMA_START_START_FETCH(value)    (SILEX_DMA_START_START_FETCH_Msk & (_UINT32_(value) << SILEX_DMA_START_START_FETCH_Pos)) /* Assigment of value for START_FETCH in the SILEX_DMA_START register */
...
#define SILEX_DMA_START_START_PUSH(value)     (SILEX_DMA_START_START_PUSH_Msk & (_UINT32_(value) << SILEX_DMA_START_START_PUSH_Pos)) /* Assigment of value for START_PUSH in the SILEX_DMA_START register */
...
#define SILEX_DMA_STATUS_FETCH_BUSY(value)    (SILEX_DMA_STATUS_FETCH_BUSY_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_FETCH_BUSY_Pos)) /* Assigment of value for FETCH_BUSY in the SILEX_DMA_STATUS register */
...
#define SILEX_DMA_STATUS_PUSH_BUSY(value)     (SILEX_DMA_STATUS_PUSH_BUSY_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_PUSH_BUSY_Pos)) /* Assigment of value for PUSH_BUSY in the SILEX_DMA_STATUS register */
...
#define SILEX_DMA_STATUS_FETCH_NOT_EMPTY(value) (SILEX_DMA_STATUS_FETCH_NOT_EMPTY_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_FETCH_NOT_EMPTY_Pos)) /* Assigment of value for FETCH_NOT_EMPTY in the SILEX_DMA_STATUS register */
...
#define SILEX_DMA_STATUS_PUSH_WAITINGFIFO(value) (SILEX_DMA_STATUS_PUSH_WAITINGFIFO_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_PUSH_WAITINGFIFO_Pos)) /* Assigment of value for PUSH_WAITINGFIFO in the SILEX_DMA_STATUS register */
...
#define SILEX_DMA_STATUS_SOFT_RST_BUSY(value) (SILEX_DMA_STATUS_SOFT_RST_BUSY_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_SOFT_RST_BUSY_Pos)) /* Assigment of value for SOFT_RST_BUSY in the SILEX_DMA_STATUS register */
...
#define SILEX_DMA_STATUS_PUSH_NBDATA(value)   (SILEX_DMA_STATUS_PUSH_NBDATA_Msk & (_UINT32_(value) << SILEX_DMA_STATUS_PUSH_NBDATA_Pos)) /* Assigment of value for PUSH_NBDATA in the SILEX_DMA_STATUS register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA411_AES_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA411_AES_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA411_AES_INCLUDED_Pos)) /* Assigment of value for BA411_AES_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED_Pos)) /* Assigment of value for BA415_HP_AES_GCM_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED_Pos)) /* Assigment of value for BA416_HP_AES_XTS_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA412_DES_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA412_DES_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA412_DES_INCLUDED_Pos)) /* Assigment of value for BA412_DES_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA413_HASH_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA413_HASH_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA413_HASH_INCLUDED_Pos)) /* Assigment of value for BA413_HASH_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA417_CHACHAPOLY_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA417_CHACHAPOLY_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA417_CHACHAPOLY_INCLUDED_Pos)) /* Assigment of value for BA417_CHACHAPOLY_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA418_SHA3_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA418_SHA3_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA418_SHA3_INCLUDED_Pos)) /* Assigment of value for BA418_SHA3_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA421_ZUC_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA421_ZUC_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA421_ZUC_INCLUDED_Pos)) /* Assigment of value for BA421_ZUC_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA419_SM4_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA419_SM4_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA419_SM4_INCLUDED_Pos)) /* Assigment of value for BA419_SM4_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA414EP_PKE_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA414EP_PKE_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA414EP_PKE_INCLUDED_Pos)) /* Assigment of value for BA414EP_PKE_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED_Pos)) /* Assigment of value for BA431_NDRNG_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA420_HP_CHACHAPOLY_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA420_HP_CHACHAPOLY_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA420_HP_CHACHAPOLY_INCLUDED_Pos)) /* Assigment of value for BA420_HP_CHACHAPOLY_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA423_SNOW3G_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA423_SNOW3G_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA423_SNOW3G_INCLUDED_Pos)) /* Assigment of value for BA423_SNOW3G_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED(value) (SILEX_HWCONF_INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED_Msk & (_UINT32_(value) << SILEX_HWCONF_INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED_Pos)) /* Assigment of value for BA422_KASUMI_INCLUDED in the SILEX_HWCONF_INCL_IPS_HW_CFG register */
...
#define SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MODE(value) (SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MODE_Msk & (_UINT32_(value) << SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MODE_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_MODE in the SILEX_HWCONF_BA411E_AES_HW_CFG_1 register */
...
#define SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS(value) (SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS_Msk & (_UINT32_(value) << SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_CS in the SILEX_HWCONF_BA411E_AES_HW_CFG_1 register */
...
#define SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MASKING(value) (SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MASKING_Msk & (_UINT32_(value) << SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_MASKING_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_MASKING in the SILEX_HWCONF_BA411E_AES_HW_CFG_1 register */
...
#define SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_KEYSIZE(value) (SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_KEYSIZE_Msk & (_UINT32_(value) << SILEX_HWCONF_BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_KEYSIZE_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_KEYSIZE in the SILEX_HWCONF_BA411E_AES_HW_CFG_1 register */
...
#define SILEX_HWCONF_BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2(value) (SILEX_HWCONF_BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_Msk & (_UINT32_(value) << SILEX_HWCONF_BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_2 in the SILEX_HWCONF_BA411E_AES_HW_CFG_2 register */
...
#define SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_MASK(value) (SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_MASK_Msk & (_UINT32_(value) << SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_MASK_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_MASK in the SILEX_HWCONF_BA413_HASH_HW_CFG register */
...
#define SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PASSING(value) (SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PASSING_Msk & (_UINT32_(value) << SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PASSING_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_PASSING in the SILEX_HWCONF_BA413_HASH_HW_CFG register */
...
#define SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_HMAC(value) (SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_HMAC_Msk & (_UINT32_(value) << SILEX_HWCONF_BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_HMAC_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_HMAC in the SILEX_HWCONF_BA413_HASH_HW_CFG register */
...
#define SILEX_HWCONF_BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG(value) (SILEX_HWCONF_BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG_Msk & (_UINT32_(value) << SILEX_HWCONF_BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG_Pos)) /* Assigment of value for BA418_SHA3_HW_CFG in the SILEX_HWCONF_BA418_SHA3_HW_CFG register */
...
#define SILEX_HWCONF_BA419_SM4_HW_CFG_BA419_SM4_HW_CFG(value) (SILEX_HWCONF_BA419_SM4_HW_CFG_BA419_SM4_HW_CFG_Msk & (_UINT32_(value) << SILEX_HWCONF_BA419_SM4_HW_CFG_BA419_SM4_HW_CFG_Pos)) /* Assigment of value for BA419_SM4_HW_CFG in the SILEX_HWCONF_BA419_SM4_HW_CFG register */
...
#define SILEX_HWCONF_BA424_ARIA_HW_CFG_BA424_ARIA_HW_CFG(value) (SILEX_HWCONF_BA424_ARIA_HW_CFG_BA424_ARIA_HW_CFG_Msk & (_UINT32_(value) << SILEX_HWCONF_BA424_ARIA_HW_CFG_BA424_ARIA_HW_CFG_Pos)) /* Assigment of value for BA424_ARIA_HW_CFG in the SILEX_HWCONF_BA424_ARIA_HW_CFG register */
...
#define SILEX_RNG_CONTROL_CONTROL_ENABLE(value) (SILEX_RNG_CONTROL_CONTROL_ENABLE_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_ENABLE_Pos)) /* Assigment of value for ENABLE in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_LFSREN(value) (SILEX_RNG_CONTROL_CONTROL_LFSREN_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_LFSREN_Pos)) /* Assigment of value for LFSREN in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_TESTEN(value) (SILEX_RNG_CONTROL_CONTROL_TESTEN_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_TESTEN_Pos)) /* Assigment of value for TESTEN in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_CONDBYPASS(value) (SILEX_RNG_CONTROL_CONTROL_CONDBYPASS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_CONDBYPASS_Pos)) /* Assigment of value for CONDBYPASS in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_INTENREP(value) (SILEX_RNG_CONTROL_CONTROL_INTENREP_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_INTENREP_Pos)) /* Assigment of value for INTENREP in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_INTENPROP(value) (SILEX_RNG_CONTROL_CONTROL_INTENPROP_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_INTENPROP_Pos)) /* Assigment of value for INTENPROP in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_INTENFULL(value) (SILEX_RNG_CONTROL_CONTROL_INTENFULL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_INTENFULL_Pos)) /* Assigment of value for INTENFULL in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_SOFTRST(value) (SILEX_RNG_CONTROL_CONTROL_SOFTRST_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_SOFTRST_Pos)) /* Assigment of value for SOFTRST in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_INTENPRE(value) (SILEX_RNG_CONTROL_CONTROL_INTENPRE_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_INTENPRE_Pos)) /* Assigment of value for INTENPRE in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_INTENALM(value) (SILEX_RNG_CONTROL_CONTROL_INTENALM_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_INTENALM_Pos)) /* Assigment of value for INTENALM in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_FORCEACTIVEROS(value) (SILEX_RNG_CONTROL_CONTROL_FORCEACTIVEROS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_FORCEACTIVEROS_Pos)) /* Assigment of value for FORCEACTIVEROS in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_HEALTHTESTBYPASS(value) (SILEX_RNG_CONTROL_CONTROL_HEALTHTESTBYPASS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_HEALTHTESTBYPASS_Pos)) /* Assigment of value for HEALTHTESTBYPASS in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_AIS31BYPASS(value) (SILEX_RNG_CONTROL_CONTROL_AIS31BYPASS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_AIS31BYPASS_Pos)) /* Assigment of value for AIS31BYPASS in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_HEALTHTESTSEL(value) (SILEX_RNG_CONTROL_CONTROL_HEALTHTESTSEL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_HEALTHTESTSEL_Pos)) /* Assigment of value for HEALTHTESTSEL in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_AIS31TESTSEL(value) (SILEX_RNG_CONTROL_CONTROL_AIS31TESTSEL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_AIS31TESTSEL_Pos)) /* Assigment of value for AIS31TESTSEL in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_NB128BITBLOCKS(value) (SILEX_RNG_CONTROL_CONTROL_NB128BITBLOCKS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_NB128BITBLOCKS_Pos)) /* Assigment of value for NB128BITBLOCKS in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_CONTROL_FIFOWRITESTARTUP(value) (SILEX_RNG_CONTROL_CONTROL_FIFOWRITESTARTUP_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CONTROL_FIFOWRITESTARTUP_Pos)) /* Assigment of value for FIFOWRITESTARTUP in the SILEX_RNG_CONTROL_CONTROL register */
...
#define SILEX_RNG_CONTROL_FIFOLEVEL_FIFOLEVEL(value) (SILEX_RNG_CONTROL_FIFOLEVEL_FIFOLEVEL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_FIFOLEVEL_FIFOLEVEL_Pos)) /* Assigment of value for FIFOLEVEL in the SILEX_RNG_CONTROL_FIFOLEVEL register */
...
#define SILEX_RNG_CONTROL_FIFOTHRESHOLD_FIFOTHRESHOLD(value) (SILEX_RNG_CONTROL_FIFOTHRESHOLD_FIFOTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_FIFOTHRESHOLD_FIFOTHRESHOLD_Pos)) /* Assigment of value for FIFOTHRESHOLD in the SILEX_RNG_CONTROL_FIFOTHRESHOLD register */
...
#define SILEX_RNG_CONTROL_FIFODEPTH_FIFODEPTH(value) (SILEX_RNG_CONTROL_FIFODEPTH_FIFODEPTH_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_FIFODEPTH_FIFODEPTH_Pos)) /* Assigment of value for FIFODEPTH in the SILEX_RNG_CONTROL_FIFODEPTH register */
...
#define SILEX_RNG_CONTROL_KEY0_KEY0(value)    (SILEX_RNG_CONTROL_KEY0_KEY0_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_KEY0_KEY0_Pos)) /* Assigment of value for KEY0 in the SILEX_RNG_CONTROL_KEY0 register */
...
#define SILEX_RNG_CONTROL_KEY1_KEY1(value)    (SILEX_RNG_CONTROL_KEY1_KEY1_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_KEY1_KEY1_Pos)) /* Assigment of value for KEY1 in the SILEX_RNG_CONTROL_KEY1 register */
...
#define SILEX_RNG_CONTROL_KEY2_KEY2(value)    (SILEX_RNG_CONTROL_KEY2_KEY2_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_KEY2_KEY2_Pos)) /* Assigment of value for KEY2 in the SILEX_RNG_CONTROL_KEY2 register */
...
#define SILEX_RNG_CONTROL_KEY3_KEY3(value)    (SILEX_RNG_CONTROL_KEY3_KEY3_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_KEY3_KEY3_Pos)) /* Assigment of value for KEY3 in the SILEX_RNG_CONTROL_KEY3 register */
...
#define SILEX_RNG_CONTROL_TESTDATA_TESTDATA(value) (SILEX_RNG_CONTROL_TESTDATA_TESTDATA_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_TESTDATA_TESTDATA_Pos)) /* Assigment of value for TESTDATA in the SILEX_RNG_CONTROL_TESTDATA register */
...
#define SILEX_RNG_CONTROL_REPEATTHRESHOLD_REPEATTHRESHOLD(value) (SILEX_RNG_CONTROL_REPEATTHRESHOLD_REPEATTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_REPEATTHRESHOLD_REPEATTHRESHOLD_Pos)) /* Assigment of value for REPEATTHRESHOLD in the SILEX_RNG_CONTROL_REPEATTHRESHOLD register */
...
#define SILEX_RNG_CONTROL_PROPTHRESHOLD_PROPTHRESHOLD(value) (SILEX_RNG_CONTROL_PROPTHRESHOLD_PROPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_PROPTHRESHOLD_PROPTHRESHOLD_Pos)) /* Assigment of value for PROPTHRESHOLD in the SILEX_RNG_CONTROL_PROPTHRESHOLD register */
...
#define SILEX_RNG_CONTROL_STATUS_TESTDATABUSY(value) (SILEX_RNG_CONTROL_STATUS_TESTDATABUSY_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_TESTDATABUSY_Pos)) /* Assigment of value for TESTDATABUSY in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_STATE(value) (SILEX_RNG_CONTROL_STATUS_STATE_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_STATE_Pos)) /* Assigment of value for STATE in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_REPFAIL(value) (SILEX_RNG_CONTROL_STATUS_REPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_REPFAIL_Pos)) /* Assigment of value for REPFAIL in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_PROPFAIL(value) (SILEX_RNG_CONTROL_STATUS_PROPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_PROPFAIL_Pos)) /* Assigment of value for PROPFAIL in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_FULLINT(value) (SILEX_RNG_CONTROL_STATUS_FULLINT_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_FULLINT_Pos)) /* Assigment of value for FULLINT in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_PREINT(value) (SILEX_RNG_CONTROL_STATUS_PREINT_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_PREINT_Pos)) /* Assigment of value for PREINT in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_ALMINT(value) (SILEX_RNG_CONTROL_STATUS_ALMINT_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_ALMINT_Pos)) /* Assigment of value for ALMINT in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_STARTUPFAIL(value) (SILEX_RNG_CONTROL_STATUS_STARTUPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_STARTUPFAIL_Pos)) /* Assigment of value for STARTUPFAIL in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_STATUS_FIFOACCFAIL(value) (SILEX_RNG_CONTROL_STATUS_FIFOACCFAIL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_STATUS_FIFOACCFAIL_Pos)) /* Assigment of value for FIFOACCFAIL in the SILEX_RNG_CONTROL_STATUS register */
...
#define SILEX_RNG_CONTROL_INITWAITVAL_INITWAITVAL(value) (SILEX_RNG_CONTROL_INITWAITVAL_INITWAITVAL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_INITWAITVAL_INITWAITVAL_Pos)) /* Assigment of value for INITWAITVAL in the SILEX_RNG_CONTROL_INITWAITVAL register */
...
#define SILEX_RNG_CONTROL_DISABLEOSC0_DISABLEOSC0(value) (SILEX_RNG_CONTROL_DISABLEOSC0_DISABLEOSC0_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_DISABLEOSC0_DISABLEOSC0_Pos)) /* Assigment of value for DISABLEOSC0 in the SILEX_RNG_CONTROL_DISABLEOSC0 register */
...
#define SILEX_RNG_CONTROL_DISABLEOSC1_DISABLEOSC1(value) (SILEX_RNG_CONTROL_DISABLEOSC1_DISABLEOSC1_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_DISABLEOSC1_DISABLEOSC1_Pos)) /* Assigment of value for DISABLEOSC1 in the SILEX_RNG_CONTROL_DISABLEOSC1 register */
...
#define SILEX_RNG_CONTROL_SWOFFTMRVAL_SWOFFTMRVAL(value) (SILEX_RNG_CONTROL_SWOFFTMRVAL_SWOFFTMRVAL_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_SWOFFTMRVAL_SWOFFTMRVAL_Pos)) /* Assigment of value for SWOFFTMRVAL in the SILEX_RNG_CONTROL_SWOFFTMRVAL register */
...
#define SILEX_RNG_CONTROL_CLKDIV_CLKDIV(value) (SILEX_RNG_CONTROL_CLKDIV_CLKDIV_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_CLKDIV_CLKDIV_Pos)) /* Assigment of value for CLKDIV in the SILEX_RNG_CONTROL_CLKDIV register */
...
#define SILEX_RNG_CONTROL_AIS31CONF0_STARTUPTHRESHOLD(value) (SILEX_RNG_CONTROL_AIS31CONF0_STARTUPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF0_STARTUPTHRESHOLD_Pos)) /* Assigment of value for STARTUPTHRESHOLD in the SILEX_RNG_CONTROL_AIS31CONF0 register */
...
#define SILEX_RNG_CONTROL_AIS31CONF0_ONLINETHRESHOLD(value) (SILEX_RNG_CONTROL_AIS31CONF0_ONLINETHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF0_ONLINETHRESHOLD_Pos)) /* Assigment of value for ONLINETHRESHOLD in the SILEX_RNG_CONTROL_AIS31CONF0 register */
...
#define SILEX_RNG_CONTROL_AIS31CONF1_ONLINEREPTHRESHOLD(value) (SILEX_RNG_CONTROL_AIS31CONF1_ONLINEREPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF1_ONLINEREPTHRESHOLD_Pos)) /* Assigment of value for ONLINEREPTHRESHOLD in the SILEX_RNG_CONTROL_AIS31CONF1 register */
...
#define SILEX_RNG_CONTROL_AIS31CONF1_HEXPECTEDVALUE(value) (SILEX_RNG_CONTROL_AIS31CONF1_HEXPECTEDVALUE_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF1_HEXPECTEDVALUE_Pos)) /* Assigment of value for HEXPECTEDVALUE in the SILEX_RNG_CONTROL_AIS31CONF1 register */
...
#define SILEX_RNG_CONTROL_AIS31CONF2_HMIN(value) (SILEX_RNG_CONTROL_AIS31CONF2_HMIN_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF2_HMIN_Pos)) /* Assigment of value for HMIN in the SILEX_RNG_CONTROL_AIS31CONF2 register */
...
#define SILEX_RNG_CONTROL_AIS31CONF2_HMAX(value) (SILEX_RNG_CONTROL_AIS31CONF2_HMAX_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31CONF2_HMAX_Pos)) /* Assigment of value for HMAX in the SILEX_RNG_CONTROL_AIS31CONF2 register */
...
#define SILEX_RNG_CONTROL_AIS31STATUS_NUMPRELIMALARMS(value) (SILEX_RNG_CONTROL_AIS31STATUS_NUMPRELIMALARMS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31STATUS_NUMPRELIMALARMS_Pos)) /* Assigment of value for NUMPRELIMALARMS in the SILEX_RNG_CONTROL_AIS31STATUS register */
...
#define SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMRNG(value) (SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMRNG_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMRNG_Pos)) /* Assigment of value for PRELIMNOISEALARMRNG in the SILEX_RNG_CONTROL_AIS31STATUS register */
...
#define SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMREP(value) (SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMREP_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_AIS31STATUS_PRELIMNOISEALARMREP_Pos)) /* Assigment of value for PRELIMNOISEALARMREP in the SILEX_RNG_CONTROL_AIS31STATUS register */
...
#define SILEX_RNG_CONTROL_HWCONFIG_NUMBOFRINGS(value) (SILEX_RNG_CONTROL_HWCONFIG_NUMBOFRINGS_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_HWCONFIG_NUMBOFRINGS_Pos)) /* Assigment of value for NUMBOFRINGS in the SILEX_RNG_CONTROL_HWCONFIG register */
...
#define SILEX_RNG_CONTROL_HWCONFIG_AIS31(value) (SILEX_RNG_CONTROL_HWCONFIG_AIS31_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_HWCONFIG_AIS31_Pos)) /* Assigment of value for AIS31 in the SILEX_RNG_CONTROL_HWCONFIG register */
...
#define SILEX_RNG_CONTROL_HWCONFIG_AIS31Full(value) (SILEX_RNG_CONTROL_HWCONFIG_AIS31Full_Msk & (_UINT32_(value) << SILEX_RNG_CONTROL_HWCONFIG_AIS31Full_Pos)) /* Assigment of value for AIS31Full in the SILEX_RNG_CONTROL_HWCONFIG register */
...
#define SILEX_PK_POINTERS_OPPTRA(value)       (SILEX_PK_POINTERS_OPPTRA_Msk & (_UINT32_(value) << SILEX_PK_POINTERS_OPPTRA_Pos)) /* Assigment of value for OPPTRA in the SILEX_PK_POINTERS register */
...
#define SILEX_PK_POINTERS_OPPTRB(value)       (SILEX_PK_POINTERS_OPPTRB_Msk & (_UINT32_(value) << SILEX_PK_POINTERS_OPPTRB_Pos)) /* Assigment of value for OPPTRB in the SILEX_PK_POINTERS register */
...
#define SILEX_PK_POINTERS_OPPTRC(value)       (SILEX_PK_POINTERS_OPPTRC_Msk & (_UINT32_(value) << SILEX_PK_POINTERS_OPPTRC_Pos)) /* Assigment of value for OPPTRC in the SILEX_PK_POINTERS register */
...
#define SILEX_PK_POINTERS_OPPTRN(value)       (SILEX_PK_POINTERS_OPPTRN_Msk & (_UINT32_(value) << SILEX_PK_POINTERS_OPPTRN_Pos)) /* Assigment of value for OPPTRN in the SILEX_PK_POINTERS register */
...
#define SILEX_PK_COMMAND_OPEADDR(value)       (SILEX_PK_COMMAND_OPEADDR_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_OPEADDR_Pos)) /* Assigment of value for OPEADDR in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_FIELDF(value)        (SILEX_PK_COMMAND_FIELDF_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_FIELDF_Pos)) /* Assigment of value for FIELDF in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_OPBYTESM1(value)     (SILEX_PK_COMMAND_OPBYTESM1_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_OPBYTESM1_Pos)) /* Assigment of value for OPBYTESM1 in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_RANDMOD(value)       (SILEX_PK_COMMAND_RANDMOD_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_RANDMOD_Pos)) /* Assigment of value for RANDMOD in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_SELCURVE(value)      (SILEX_PK_COMMAND_SELCURVE_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_SELCURVE_Pos)) /* Assigment of value for SELCURVE in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_RANDKE(value)        (SILEX_PK_COMMAND_RANDKE_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_RANDKE_Pos)) /* Assigment of value for RANDKE in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_RANDPROJ(value)      (SILEX_PK_COMMAND_RANDPROJ_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_RANDPROJ_Pos)) /* Assigment of value for RANDPROJ in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_EDWARDS(value)       (SILEX_PK_COMMAND_EDWARDS_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_EDWARDS_Pos)) /* Assigment of value for EDWARDS in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_SWAPBYTES(value)     (SILEX_PK_COMMAND_SWAPBYTES_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_SWAPBYTES_Pos)) /* Assigment of value for SWAPBYTES in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_FLAGA(value)         (SILEX_PK_COMMAND_FLAGA_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_FLAGA_Pos)) /* Assigment of value for FLAGA in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_FLAGB(value)         (SILEX_PK_COMMAND_FLAGB_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_FLAGB_Pos)) /* Assigment of value for FLAGB in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_COMMAND_CALCR2(value)        (SILEX_PK_COMMAND_CALCR2_Msk & (_UINT32_(value) << SILEX_PK_COMMAND_CALCR2_Pos)) /* Assigment of value for CALCR2 in the SILEX_PK_COMMAND register */
...
#define SILEX_PK_CONTROL_START(value)         (SILEX_PK_CONTROL_START_Msk & (_UINT32_(value) << SILEX_PK_CONTROL_START_Pos)) /* Assigment of value for START in the SILEX_PK_CONTROL register */
...
#define SILEX_PK_CONTROL_CLEARIRQ(value)      (SILEX_PK_CONTROL_CLEARIRQ_Msk & (_UINT32_(value) << SILEX_PK_CONTROL_CLEARIRQ_Pos)) /* Assigment of value for CLEARIRQ in the SILEX_PK_CONTROL register */
...
#define SILEX_PK_STATUS_ERRORFLAGS(value)     (SILEX_PK_STATUS_ERRORFLAGS_Msk & (_UINT32_(value) << SILEX_PK_STATUS_ERRORFLAGS_Pos)) /* Assigment of value for ERRORFLAGS in the SILEX_PK_STATUS register */
...
#define SILEX_PK_STATUS_PK_BUSY(value)        (SILEX_PK_STATUS_PK_BUSY_Msk & (_UINT32_(value) << SILEX_PK_STATUS_PK_BUSY_Pos)) /* Assigment of value for PK_BUSY in the SILEX_PK_STATUS register */
...
#define SILEX_PK_STATUS_INTRPTSTATUS(value)   (SILEX_PK_STATUS_INTRPTSTATUS_Msk & (_UINT32_(value) << SILEX_PK_STATUS_INTRPTSTATUS_Pos)) /* Assigment of value for INTRPTSTATUS in the SILEX_PK_STATUS register */
...
#define SILEX_PK_STATUS_FAILPTR(value)        (SILEX_PK_STATUS_FAILPTR_Msk & (_UINT32_(value) << SILEX_PK_STATUS_FAILPTR_Pos)) /* Assigment of value for FAILPTR in the SILEX_PK_STATUS register */
...
#define SILEX_PK_TIMER_TIMER(value)           (SILEX_PK_TIMER_TIMER_Msk & (_UINT32_(value) << SILEX_PK_TIMER_TIMER_Pos)) /* Assigment of value for TIMER in the SILEX_PK_TIMER register */
...
#define SILEX_PK_HWCONFIG_MAXOPSIZE(value)    (SILEX_PK_HWCONFIG_MAXOPSIZE_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_MAXOPSIZE_Pos)) /* Assigment of value for MAXOPSIZE in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_NBMULT(value)       (SILEX_PK_HWCONFIG_NBMULT_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_NBMULT_Pos)) /* Assigment of value for NBMULT in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_PRIMEFIELD(value)   (SILEX_PK_HWCONFIG_PRIMEFIELD_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_PRIMEFIELD_Pos)) /* Assigment of value for PRIMEFIELD in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_BINARYFIELD(value)  (SILEX_PK_HWCONFIG_BINARYFIELD_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_BINARYFIELD_Pos)) /* Assigment of value for BINARYFIELD in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_P256(value)         (SILEX_PK_HWCONFIG_P256_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_P256_Pos)) /* Assigment of value for P256 in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_P384(value)         (SILEX_PK_HWCONFIG_P384_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_P384_Pos)) /* Assigment of value for P384 in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_P521(value)         (SILEX_PK_HWCONFIG_P521_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_P521_Pos)) /* Assigment of value for P521 in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_P192(value)         (SILEX_PK_HWCONFIG_P192_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_P192_Pos)) /* Assigment of value for P192 in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_X25519(value)       (SILEX_PK_HWCONFIG_X25519_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_X25519_Pos)) /* Assigment of value for X25519 in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_AHBMASTER(value)    (SILEX_PK_HWCONFIG_AHBMASTER_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_AHBMASTER_Pos)) /* Assigment of value for AHBMASTER in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_DISABLESMX(value)   (SILEX_PK_HWCONFIG_DISABLESMX_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_DISABLESMX_Pos)) /* Assigment of value for DISABLESMX in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_DISABLECLRMEM(value) (SILEX_PK_HWCONFIG_DISABLECLRMEM_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_DISABLECLRMEM_Pos)) /* Assigment of value for DISABLECLRMEM in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_HWCONFIG_DISABLECM(value)    (SILEX_PK_HWCONFIG_DISABLECM_Msk & (_UINT32_(value) << SILEX_PK_HWCONFIG_DISABLECM_Pos)) /* Assigment of value for DISABLECM in the SILEX_PK_HWCONFIG register */
...
#define SILEX_PK_OPSIZE_OPSIZE(value)         (SILEX_PK_OPSIZE_OPSIZE_Msk & (_UINT32_(value) << SILEX_PK_OPSIZE_OPSIZE_Pos)) /* Assigment of value for OPSIZE in the SILEX_PK_OPSIZE register */
...
#define SILEX_PK_MEMOFFSET_MEMOFFSET(value)   (SILEX_PK_MEMOFFSET_MEMOFFSET_Msk & (_UINT32_(value) << SILEX_PK_MEMOFFSET_MEMOFFSET_Pos)) /* Assigment of value for MEMOFFSET in the SILEX_PK_MEMOFFSET register */
...
#define SILEX_PK_MICROCODEOFFSET_MICROCODEOFFSET(value) (SILEX_PK_MICROCODEOFFSET_MICROCODEOFFSET_Msk & (_UINT32_(value) << SILEX_PK_MICROCODEOFFSET_MICROCODEOFFSET_Pos)) /* Assigment of value for MICROCODEOFFSET in the SILEX_PK_MICROCODEOFFSET register */
...
#define SILEX_RNG_DATA_CONTROL_ENABLE(value)  (SILEX_RNG_DATA_CONTROL_ENABLE_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_ENABLE_Pos)) /* Assigment of value for ENABLE in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_LFSREN(value)  (SILEX_RNG_DATA_CONTROL_LFSREN_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_LFSREN_Pos)) /* Assigment of value for LFSREN in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_TESTEN(value)  (SILEX_RNG_DATA_CONTROL_TESTEN_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_TESTEN_Pos)) /* Assigment of value for TESTEN in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_CONDBYPASS(value) (SILEX_RNG_DATA_CONTROL_CONDBYPASS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_CONDBYPASS_Pos)) /* Assigment of value for CONDBYPASS in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_INTENREP(value) (SILEX_RNG_DATA_CONTROL_INTENREP_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_INTENREP_Pos)) /* Assigment of value for INTENREP in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_INTENPROP(value) (SILEX_RNG_DATA_CONTROL_INTENPROP_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_INTENPROP_Pos)) /* Assigment of value for INTENPROP in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_INTENFULL(value) (SILEX_RNG_DATA_CONTROL_INTENFULL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_INTENFULL_Pos)) /* Assigment of value for INTENFULL in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_SOFTRST(value) (SILEX_RNG_DATA_CONTROL_SOFTRST_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_SOFTRST_Pos)) /* Assigment of value for SOFTRST in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_INTENPRE(value) (SILEX_RNG_DATA_CONTROL_INTENPRE_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_INTENPRE_Pos)) /* Assigment of value for INTENPRE in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_INTENALM(value) (SILEX_RNG_DATA_CONTROL_INTENALM_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_INTENALM_Pos)) /* Assigment of value for INTENALM in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_FORCEACTIVEROS(value) (SILEX_RNG_DATA_CONTROL_FORCEACTIVEROS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_FORCEACTIVEROS_Pos)) /* Assigment of value for FORCEACTIVEROS in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_HEALTHTESTBYPASS(value) (SILEX_RNG_DATA_CONTROL_HEALTHTESTBYPASS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_HEALTHTESTBYPASS_Pos)) /* Assigment of value for HEALTHTESTBYPASS in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_AIS31BYPASS(value) (SILEX_RNG_DATA_CONTROL_AIS31BYPASS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_AIS31BYPASS_Pos)) /* Assigment of value for AIS31BYPASS in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_HEALTHTESTSEL(value) (SILEX_RNG_DATA_CONTROL_HEALTHTESTSEL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_HEALTHTESTSEL_Pos)) /* Assigment of value for HEALTHTESTSEL in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_AIS31TESTSEL(value) (SILEX_RNG_DATA_CONTROL_AIS31TESTSEL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_AIS31TESTSEL_Pos)) /* Assigment of value for AIS31TESTSEL in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_NB128BITBLOCKS(value) (SILEX_RNG_DATA_CONTROL_NB128BITBLOCKS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_NB128BITBLOCKS_Pos)) /* Assigment of value for NB128BITBLOCKS in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_CONTROL_FIFOWRITESTARTUP(value) (SILEX_RNG_DATA_CONTROL_FIFOWRITESTARTUP_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CONTROL_FIFOWRITESTARTUP_Pos)) /* Assigment of value for FIFOWRITESTARTUP in the SILEX_RNG_DATA_CONTROL register */
...
#define SILEX_RNG_DATA_FIFOLEVEL_FIFOLEVEL(value) (SILEX_RNG_DATA_FIFOLEVEL_FIFOLEVEL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_FIFOLEVEL_FIFOLEVEL_Pos)) /* Assigment of value for FIFOLEVEL in the SILEX_RNG_DATA_FIFOLEVEL register */
...
#define SILEX_RNG_DATA_FIFOTHRESHOLD_FIFOTHRESHOLD(value) (SILEX_RNG_DATA_FIFOTHRESHOLD_FIFOTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_FIFOTHRESHOLD_FIFOTHRESHOLD_Pos)) /* Assigment of value for FIFOTHRESHOLD in the SILEX_RNG_DATA_FIFOTHRESHOLD register */
...
#define SILEX_RNG_DATA_FIFODEPTH_FIFODEPTH(value) (SILEX_RNG_DATA_FIFODEPTH_FIFODEPTH_Msk & (_UINT32_(value) << SILEX_RNG_DATA_FIFODEPTH_FIFODEPTH_Pos)) /* Assigment of value for FIFODEPTH in the SILEX_RNG_DATA_FIFODEPTH register */
...
#define SILEX_RNG_DATA_KEY0_KEY0(value)       (SILEX_RNG_DATA_KEY0_KEY0_Msk & (_UINT32_(value) << SILEX_RNG_DATA_KEY0_KEY0_Pos)) /* Assigment of value for KEY0 in the SILEX_RNG_DATA_KEY0 register */
...
#define SILEX_RNG_DATA_KEY1_KEY1(value)       (SILEX_RNG_DATA_KEY1_KEY1_Msk & (_UINT32_(value) << SILEX_RNG_DATA_KEY1_KEY1_Pos)) /* Assigment of value for KEY1 in the SILEX_RNG_DATA_KEY1 register */
...
#define SILEX_RNG_DATA_KEY2_KEY2(value)       (SILEX_RNG_DATA_KEY2_KEY2_Msk & (_UINT32_(value) << SILEX_RNG_DATA_KEY2_KEY2_Pos)) /* Assigment of value for KEY2 in the SILEX_RNG_DATA_KEY2 register */
...
#define SILEX_RNG_DATA_KEY3_KEY3(value)       (SILEX_RNG_DATA_KEY3_KEY3_Msk & (_UINT32_(value) << SILEX_RNG_DATA_KEY3_KEY3_Pos)) /* Assigment of value for KEY3 in the SILEX_RNG_DATA_KEY3 register */
...
#define SILEX_RNG_DATA_TESTDATA_TESTDATA(value) (SILEX_RNG_DATA_TESTDATA_TESTDATA_Msk & (_UINT32_(value) << SILEX_RNG_DATA_TESTDATA_TESTDATA_Pos)) /* Assigment of value for TESTDATA in the SILEX_RNG_DATA_TESTDATA register */
...
#define SILEX_RNG_DATA_REPEATTHRESHOLD_REPEATTHRESHOLD(value) (SILEX_RNG_DATA_REPEATTHRESHOLD_REPEATTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_REPEATTHRESHOLD_REPEATTHRESHOLD_Pos)) /* Assigment of value for REPEATTHRESHOLD in the SILEX_RNG_DATA_REPEATTHRESHOLD register */
...
#define SILEX_RNG_DATA_PROPTHRESHOLD_PROPTHRESHOLD(value) (SILEX_RNG_DATA_PROPTHRESHOLD_PROPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_PROPTHRESHOLD_PROPTHRESHOLD_Pos)) /* Assigment of value for PROPTHRESHOLD in the SILEX_RNG_DATA_PROPTHRESHOLD register */
...
#define SILEX_RNG_DATA_STATUS_TESTDATABUSY(value) (SILEX_RNG_DATA_STATUS_TESTDATABUSY_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_TESTDATABUSY_Pos)) /* Assigment of value for TESTDATABUSY in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_STATE(value)    (SILEX_RNG_DATA_STATUS_STATE_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_STATE_Pos)) /* Assigment of value for STATE in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_REPFAIL(value)  (SILEX_RNG_DATA_STATUS_REPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_REPFAIL_Pos)) /* Assigment of value for REPFAIL in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_PROPFAIL(value) (SILEX_RNG_DATA_STATUS_PROPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_PROPFAIL_Pos)) /* Assigment of value for PROPFAIL in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_FULLINT(value)  (SILEX_RNG_DATA_STATUS_FULLINT_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_FULLINT_Pos)) /* Assigment of value for FULLINT in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_PREINT(value)   (SILEX_RNG_DATA_STATUS_PREINT_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_PREINT_Pos)) /* Assigment of value for PREINT in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_ALMINT(value)   (SILEX_RNG_DATA_STATUS_ALMINT_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_ALMINT_Pos)) /* Assigment of value for ALMINT in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_STARTUPFAIL(value) (SILEX_RNG_DATA_STATUS_STARTUPFAIL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_STARTUPFAIL_Pos)) /* Assigment of value for STARTUPFAIL in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_STATUS_FIFOACCFAIL(value) (SILEX_RNG_DATA_STATUS_FIFOACCFAIL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_STATUS_FIFOACCFAIL_Pos)) /* Assigment of value for FIFOACCFAIL in the SILEX_RNG_DATA_STATUS register */
...
#define SILEX_RNG_DATA_INITWAITVAL_INITWAITVAL(value) (SILEX_RNG_DATA_INITWAITVAL_INITWAITVAL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_INITWAITVAL_INITWAITVAL_Pos)) /* Assigment of value for INITWAITVAL in the SILEX_RNG_DATA_INITWAITVAL register */
...
#define SILEX_RNG_DATA_DISABLEOSC0_DISABLEOSC0(value) (SILEX_RNG_DATA_DISABLEOSC0_DISABLEOSC0_Msk & (_UINT32_(value) << SILEX_RNG_DATA_DISABLEOSC0_DISABLEOSC0_Pos)) /* Assigment of value for DISABLEOSC0 in the SILEX_RNG_DATA_DISABLEOSC0 register */
...
#define SILEX_RNG_DATA_DISABLEOSC1_DISABLEOSC1(value) (SILEX_RNG_DATA_DISABLEOSC1_DISABLEOSC1_Msk & (_UINT32_(value) << SILEX_RNG_DATA_DISABLEOSC1_DISABLEOSC1_Pos)) /* Assigment of value for DISABLEOSC1 in the SILEX_RNG_DATA_DISABLEOSC1 register */
...
#define SILEX_RNG_DATA_SWOFFTMRVAL_SWOFFTMRVAL(value) (SILEX_RNG_DATA_SWOFFTMRVAL_SWOFFTMRVAL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_SWOFFTMRVAL_SWOFFTMRVAL_Pos)) /* Assigment of value for SWOFFTMRVAL in the SILEX_RNG_DATA_SWOFFTMRVAL register */
...
#define SILEX_RNG_DATA_CLKDIV_CLKDIV(value)   (SILEX_RNG_DATA_CLKDIV_CLKDIV_Msk & (_UINT32_(value) << SILEX_RNG_DATA_CLKDIV_CLKDIV_Pos)) /* Assigment of value for CLKDIV in the SILEX_RNG_DATA_CLKDIV register */
...
#define SILEX_RNG_DATA_AIS31CONF0_STARTUPTHRESHOLD(value) (SILEX_RNG_DATA_AIS31CONF0_STARTUPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF0_STARTUPTHRESHOLD_Pos)) /* Assigment of value for STARTUPTHRESHOLD in the SILEX_RNG_DATA_AIS31CONF0 register */
...
#define SILEX_RNG_DATA_AIS31CONF0_ONLINETHRESHOLD(value) (SILEX_RNG_DATA_AIS31CONF0_ONLINETHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF0_ONLINETHRESHOLD_Pos)) /* Assigment of value for ONLINETHRESHOLD in the SILEX_RNG_DATA_AIS31CONF0 register */
...
#define SILEX_RNG_DATA_AIS31CONF1_ONLINEREPTHRESHOLD(value) (SILEX_RNG_DATA_AIS31CONF1_ONLINEREPTHRESHOLD_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF1_ONLINEREPTHRESHOLD_Pos)) /* Assigment of value for ONLINEREPTHRESHOLD in the SILEX_RNG_DATA_AIS31CONF1 register */
...
#define SILEX_RNG_DATA_AIS31CONF1_HEXPECTEDVALUE(value) (SILEX_RNG_DATA_AIS31CONF1_HEXPECTEDVALUE_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF1_HEXPECTEDVALUE_Pos)) /* Assigment of value for HEXPECTEDVALUE in the SILEX_RNG_DATA_AIS31CONF1 register */
...
#define SILEX_RNG_DATA_AIS31CONF2_HMIN(value) (SILEX_RNG_DATA_AIS31CONF2_HMIN_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF2_HMIN_Pos)) /* Assigment of value for HMIN in the SILEX_RNG_DATA_AIS31CONF2 register */
...
#define SILEX_RNG_DATA_AIS31CONF2_HMAX(value) (SILEX_RNG_DATA_AIS31CONF2_HMAX_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31CONF2_HMAX_Pos)) /* Assigment of value for HMAX in the SILEX_RNG_DATA_AIS31CONF2 register */
...
#define SILEX_RNG_DATA_AIS31STATUS_NUMPRELIMALARMS(value) (SILEX_RNG_DATA_AIS31STATUS_NUMPRELIMALARMS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31STATUS_NUMPRELIMALARMS_Pos)) /* Assigment of value for NUMPRELIMALARMS in the SILEX_RNG_DATA_AIS31STATUS register */
...
#define SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMRNG(value) (SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMRNG_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMRNG_Pos)) /* Assigment of value for PRELIMNOISEALARMRNG in the SILEX_RNG_DATA_AIS31STATUS register */
...
#define SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMREP(value) (SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMREP_Msk & (_UINT32_(value) << SILEX_RNG_DATA_AIS31STATUS_PRELIMNOISEALARMREP_Pos)) /* Assigment of value for PRELIMNOISEALARMREP in the SILEX_RNG_DATA_AIS31STATUS register */
...
#define SILEX_RNG_DATA_HWCONFIG_NUMBOFRINGS(value) (SILEX_RNG_DATA_HWCONFIG_NUMBOFRINGS_Msk & (_UINT32_(value) << SILEX_RNG_DATA_HWCONFIG_NUMBOFRINGS_Pos)) /* Assigment of value for NUMBOFRINGS in the SILEX_RNG_DATA_HWCONFIG register */
...
#define SILEX_RNG_DATA_HWCONFIG_AIS31(value)  (SILEX_RNG_DATA_HWCONFIG_AIS31_Msk & (_UINT32_(value) << SILEX_RNG_DATA_HWCONFIG_AIS31_Pos)) /* Assigment of value for AIS31 in the SILEX_RNG_DATA_HWCONFIG register */
...
#define SILEX_RNG_DATA_HWCONFIG_AIS31FULL(value) (SILEX_RNG_DATA_HWCONFIG_AIS31FULL_Msk & (_UINT32_(value) << SILEX_RNG_DATA_HWCONFIG_AIS31FULL_Pos)) /* Assigment of value for AIS31FULL in the SILEX_RNG_DATA_HWCONFIG register */
...
#endif /* _WBZ65_SILEX_COMPONENT_H_ */
