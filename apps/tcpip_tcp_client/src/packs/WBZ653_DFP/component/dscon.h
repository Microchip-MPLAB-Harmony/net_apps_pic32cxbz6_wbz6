...
#ifndef _WBZ65_DSCON_COMPONENT_H_
#define _WBZ65_DSCON_COMPONENT_H_
...
#define DSCON_DSWSRC_ICD(value)               (DSCON_DSWSRC_ICD_Msk & (_UINT32_(value) << DSCON_DSWSRC_ICD_Pos)) /* Assigment of value for ICD in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_MCLR(value)              (DSCON_DSWSRC_MCLR_Msk & (_UINT32_(value) << DSCON_DSWSRC_MCLR_Pos)) /* Assigment of value for MCLR in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_RTCC(value)              (DSCON_DSWSRC_RTCC_Msk & (_UINT32_(value) << DSCON_DSWSRC_RTCC_Pos)) /* Assigment of value for RTCC in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_DSWDT(value)             (DSCON_DSWSRC_DSWDT_Msk & (_UINT32_(value) << DSCON_DSWSRC_DSWDT_Pos)) /* Assigment of value for DSWDT in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_EXT(value)               (DSCON_DSWSRC_EXT_Msk & (_UINT32_(value) << DSCON_DSWSRC_EXT_Pos)) /* Assigment of value for EXT in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_FAULT(value)             (DSCON_DSWSRC_FAULT_Msk & (_UINT32_(value) << DSCON_DSWSRC_FAULT_Pos)) /* Assigment of value for FAULT in the DSCON_DSWSRC register */
...
#define DSCON_DSWSRC_INT0(value)              (DSCON_DSWSRC_INT0_Msk & (_UINT32_(value) << DSCON_DSWSRC_INT0_Pos)) /* Assigment of value for INT0 in the DSCON_DSWSRC register */
...
#endif /* _WBZ65_DSCON_COMPONENT_H_ */
